(function () {
	...
	chrome.runtime.onMessage.addListener(function(message, sender, sendResponse) {
		...
		else if (message && message.action === "SetUninstallUrl")
		{
			chrome.runtime.setUninstallURL(message.payload);
			window.localStorage.setItem('NMP_PPAPI_EXTENSION_UNINSTALL_URL', message.payload);
		}
	...
	var storedUninstallUrl = window.localStorage.getItem('NMP_PPAPI_EXTENSION_UNINSTALL_URL');
	if(storedUninstallUrl) {
		chrome.runtime.setUninstallURL(storedUninstallUrl);
	};
