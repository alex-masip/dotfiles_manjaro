...
$jscomp.polyfillUnisolated=function(a,b){var d=$jscomp.global;a=a.split(".");for(var c=0;c<a.length-1;c++){var e=a[c];if(!(e in d))return;d=d[e]}a=a[a.length-1];c=d[a];b=b(c);b!=c&&null!=b&&$jscomp.defineProperty(d,a,{configurable:!0,writable:!0,value:b})};
$jscomp.polyfillIsolated=function(a,b,d){var c=a.split(".");a=1===c.length;var e=c[0];e=!a&&e in $jscomp.polyfills?$jscomp.polyfills:$jscomp.global;for(var f=0;f<c.length-1;f++){var g=c[f];if(!(g in e))return;e=e[g]}c=c[c.length-1];d=$jscomp.IS_SYMBOL_NATIVE&&"es6"===d?e[c]:null;b=b(d);null!=b&&(a?$jscomp.defineProperty($jscomp.polyfills,c,{configurable:!0,writable:!0,value:b}):b!==d&&($jscomp.propertyToPolyfillSymbol[c]=$jscomp.IS_SYMBOL_NATIVE?$jscomp.global.Symbol(c):$jscomp.POLYFILL_PREFIX+c,
...
$jscomp.polyfill("Array.prototype.keys",function(a){return a?a:a=function(){return $jscomp.iteratorFromArray(this,function(b){return b})}},"es6","es3");$jscomp.makeIterator=function(a){var b="undefined"!=typeof Symbol&&Symbol.iterator&&a[Symbol.iterator];return b?b.call(a):$jscomp.arrayIterator(a)};
$jscomp.polyfill("Promise",function(a){function b(){this.batch_=null}function d(h){return h instanceof f?h:new f(function(l){l(h)})}if(a&&(!($jscomp.FORCE_POLYFILL_PROMISE||$jscomp.FORCE_POLYFILL_PROMISE_WHEN_NO_UNHANDLED_REJECTION&&"undefined"===typeof $jscomp.global.PromiseRejectionEvent)||!$jscomp.global.Promise||-1===$jscomp.global.Promise.toString().indexOf("[native code]")))return a;b.prototype.asyncExecute=function(h){if(null==this.batch_){this.batch_=[];var l=this;this.asyncExecuteFunction(function(){l.executeBatch_()})}this.batch_.push(h)};
var c=$jscomp.global.setTimeout;b.prototype.asyncExecuteFunction=function(h){c(h,0)};b.prototype.executeBatch_=function(){for(;this.batch_&&this.batch_.length;){var h=this.batch_;this.batch_=[];for(var l=0;l<h.length;++l){var n=h[l];h[l]=null;try{n()}catch(v){this.asyncThrow_(v)}}}this.batch_=null};b.prototype.asyncThrow_=function(h){this.asyncExecuteFunction(function(){throw h;})};var e={PENDING:0,FULFILLED:1,REJECTED:2},f=function(h){this.state_=e.PENDING;this.result_=void 0;this.onSettledCallbacks_=
[];this.isRejectionHandled_=!1;var l=this.createResolveAndReject_();try{h(l.resolve,l.reject)}catch(n){l.reject(n)}};f.prototype.createResolveAndReject_=function(){function h(v){return function(m){n||(n=!0,v.call(l,m))}}var l=this,n=!1;return{resolve:h(this.resolveTo_),reject:h(this.reject_)}};f.prototype.resolveTo_=function(h){if(h===this)this.reject_(new TypeError("A Promise cannot resolve to itself"));else if(h instanceof f)this.settleSameAsPromise_(h);else{a:switch(typeof h){case "object":var l=
...
", "+l+"): Promise already settled in state"+this.state_);this.state_=h;this.result_=l;this.state_===e.REJECTED&&this.scheduleUnhandledRejectionCheck_();this.executeOnSettledCallbacks_()};f.prototype.scheduleUnhandledRejectionCheck_=function(){var h=this;c(function(){if(h.notifyUnhandledRejection_()){var l=$jscomp.global.console;"undefined"!==typeof l&&l.error(h.result_)}},1)};f.prototype.notifyUnhandledRejection_=function(){if(this.isRejectionHandled_)return!1;var h=$jscomp.global.CustomEvent,l=
...
this.onSettledCallbacks_=null}};var g=new b;f.prototype.settleSameAsPromise_=function(h){var l=this.createResolveAndReject_();h.callWhenSettled_(l.resolve,l.reject)};f.prototype.settleSameAsThenable_=function(h,l){var n=this.createResolveAndReject_();try{h.call(l,n.resolve,n.reject)}catch(v){n.reject(v)}};f.prototype.then=function(h,l){function n(r,x){return"function"==typeof r?function(y){try{v(r(y))}catch(k){m(k)}}:x}var v,m,q=new f(function(r,x){v=r;m=x});this.callWhenSettled_(n(h,v),n(l,m));return q};
f.prototype.catch=function(h){return this.then(void 0,h)};f.prototype.callWhenSettled_=function(h,l){function n(){switch(v.state_){case e.FULFILLED:h(v.result_);break;case e.REJECTED:l(v.result_);break;default:throw Error("Unexpected state: "+v.state_);}}var v=this;null==this.onSettledCallbacks_?g.asyncExecute(n):this.onSettledCallbacks_.push(n);this.isRejectionHandled_=!0};f.resolve=d;f.reject=function(h){return new f(function(l,n){n(h)})};f.race=function(h){return new f(function(l,n){for(var v=
$jscomp.makeIterator(h),m=v.next();!m.done;m=v.next())d(m.value).callWhenSettled_(l,n)})};f.all=function(h){var l=$jscomp.makeIterator(h),n=l.next();return n.done?d([]):new f(function(v,m){function q(y){return function(k){r[y]=k;x--;0==x&&v(r)}}var r=[],x=0;do r.push(void 0),x++,d(n.value).callWhenSettled_(q(r.length-1),m),n=l.next();while(!n.done)})};return f},"es6","es3");
...
goog.TRUSTED_SITE=!0;goog.DISALLOW_TEST_ONLY_CODE=!goog.DEBUG;goog.ENABLE_CHROME_APP_SAFE_SCRIPT_LOADING=!1;goog.provide=function(a){if(goog.isInModuleLoader_())throw Error("goog.provide cannot be used within a module.");goog.constructNamespace_(a)};goog.constructNamespace_=function(a,b,d){goog.exportPath_(a,b,d)};goog.getScriptNonce=function(a){if(a&&a!=goog.global)return goog.getScriptNonce_(a.document);null===goog.cspNonce_&&(goog.cspNonce_=goog.getScriptNonce_(goog.global.document));return goog.cspNonce_};
goog.NONCE_PATTERN_=/^[\w+/_-]+[=]{0,2}$/;goog.cspNonce_=null;goog.getScriptNonce_=function(a){return(a=a.querySelector&&a.querySelector("script[nonce]"))&&(a=a.nonce||a.getAttribute("nonce"))&&goog.NONCE_PATTERN_.test(a)?a:""};goog.VALID_MODULE_RE_=/^[a-zA-Z_$][a-zA-Z0-9._$]*$/;
...
goog.setTestOnly=function(a){if(goog.DISALLOW_TEST_ONLY_CODE)throw a=a||"",Error("Importing test-only code into non-debug environment"+(a?": "+a:"."));};goog.forwardDeclare=function(){};goog.getObjectByName=function(a,b){a=a.split(".");b=b||goog.global;for(var d=0;d<a.length;d++)if(b=b[a[d]],null==b)return null;return b};goog.addDependency=function(){};goog.useStrictRequires=!1;goog.ENABLE_DEBUG_LOADER=!0;goog.logToConsole_=function(a){goog.global.console&&goog.global.console.error(a)};
goog.require=function(){};goog.requireType=function(){return{}};goog.basePath="";goog.nullFunction=function(){};goog.abstractMethod=function(){throw Error("unimplemented abstract method");};goog.addSingletonGetter=function(a){a.instance_=void 0;a.getInstance=function(){if(a.instance_)return a.instance_;goog.DEBUG&&(goog.instantiatedSingletons_[goog.instantiatedSingletons_.length]=a);return a.instance_=new a}};goog.instantiatedSingletons_=[];goog.LOAD_MODULE_USING_EVAL=!0;
goog.SEAL_MODULE_EXPORTS=goog.DEBUG;goog.loadedModules_={};goog.DEPENDENCIES_ENABLED=!1;goog.TRANSPILE="detect";goog.ASSUME_ES_MODULES_TRANSPILED=!1;goog.TRANSPILE_TO_LANGUAGE="";goog.TRANSPILER="transpile.js";goog.hasBadLetScoping=null;goog.useSafari10Workaround=function(){if(null==goog.hasBadLetScoping){try{var a=!eval('"use strict";let x = 1; function f() { return typeof x; };f() == "number";')}catch(b){a=!1}goog.hasBadLetScoping=a}return goog.hasBadLetScoping};
goog.workaroundSafari10EvalBug=function(a){return"(function(){"+a+"\n;})();\n"};
goog.loadModule=function(a){var b=goog.moduleLoaderState_;try{goog.moduleLoaderState_={moduleName:"",declareLegacyNamespace:!1,type:goog.ModuleType.GOOG};var d={},c=d;if("function"===typeof a)c=a.call(void 0,c);else if("string"===typeof a)goog.useSafari10Workaround()&&(a=goog.workaroundSafari10EvalBug(a)),c=goog.loadModuleFromSource_.call(void 0,c,a);else throw Error("Invalid module definition");var e=goog.moduleLoaderState_.moduleName;if("string"===typeof e&&e){goog.moduleLoaderState_.declareLegacyNamespace?
(a=d!==c,goog.constructNamespace_(e,c,a)):goog.SEAL_MODULE_EXPORTS&&Object.seal&&"object"==typeof c&&null!=c&&Object.seal(c);var f={exports:c,type:goog.ModuleType.GOOG,moduleId:goog.moduleLoaderState_.moduleName};goog.loadedModules_[e]=f}else throw Error('Invalid module name "'+e+'"');}finally{goog.moduleLoaderState_=b}};goog.loadModuleFromSource_=function(a,b){eval(b);return a};
...
goog.global.$gwtExport.$jscomp.transpile;c=goog.global.$jscomp;e=c.transpile}}if(!e){var h=" requires transpilation but no transpiler was found.";h+=' Please add "//javascript/closure:transpiler" as a data dependency to ensure it is included.';e=c.transpile=function(l,n){goog.logToConsole_(n+h);return l}}return e(a,b,d)};goog.typeOf=function(a){var b=typeof a;return"object"!=b?b:a?Array.isArray(a)?"array":b:"null"};
...
goog.removeUid=function(a){null!==a&&"removeAttribute"in a&&a.removeAttribute(goog.UID_PROPERTY_);try{delete a[goog.UID_PROPERTY_]}catch(b){}};goog.UID_PROPERTY_="closure_uid_"+(1E9*Math.random()>>>0);goog.uidCounter_=0;goog.cloneObject=function(a){var b=goog.typeOf(a);if("object"==b||"array"==b){if("function"===typeof a.clone)return a.clone();b="array"==b?[]:{};for(var d in a)b[d]=goog.cloneObject(a[d]);return b}return a};goog.bindNative_=function(a,b,d){return a.call.apply(a.bind,arguments)};
goog.bindJs_=function(a,b,d){if(!a)throw Error();if(2<arguments.length){var c=Array.prototype.slice.call(arguments,2);return function(){var e=Array.prototype.slice.call(arguments);Array.prototype.unshift.apply(e,c);return a.apply(b,e)}}return function(){return a.apply(b,arguments)}};goog.bind=function(a,b,d){Function.prototype.bind&&-1!=Function.prototype.bind.toString().indexOf("native code")?goog.bind=goog.bindNative_:goog.bind=goog.bindJs_;return goog.bind.apply(null,arguments)};
...
function ColorUtilFactory(){function a(e){var f="#"===e[0]?e.substr(1):e;e=f.length/3;var g=f.substr(0,e),h=f.substr(e,e);f=f.substr(2*e);1===e&&(g+=g,h+=h,f+=f);return"rgba("+parseInt(g,16)+","+parseInt(h,16)+","+parseInt(f,16)+",0.1)"}function b(e){e=(e=e.match(/^rgba?[\s+]?\([\s+]?(\d+)[\s+]?,[\s+]?(\d+)[\s+]?,[\s+]?(\d+)[\s+]?/i))&&4===e.length?"#"+("0"+parseInt(e[1],10).toString(16)).slice(-2)+("0"+parseInt(e[2],10).toString(16)).slice(-2)+("0"+parseInt(e[3],10).toString(16)).slice(-2):"";return e.toUpperCase()}
...
function MdConstantFactory(){function a(l){var n=e+"-"+l;n=b(n);var v=n.charAt(0).toLowerCase()+n.substring(1);return angular.isDefined(c.style[l])?l:angular.isDefined(c.style[n])?n:angular.isDefined(c.style[v])?v:l}function b(l){return l.replace(g,function(n,v,m,q){return q?m.toUpperCase():m})}function d(l){var n,v=/^(Moz|webkit|ms)(?=[A-Z])/;for(n in l.style)if(l=v.exec(n))return l[0]}var c=document.createElement("div"),e=d(c),f=/webkit/i.test(e),g=/([:\-_]+(.))/g,h={isInputKey:function(l){return 31<=
l.keyCode&&90>=l.keyCode},isNumPadKey:function(l){return 3===l.location&&97<=l.keyCode&&105>=l.keyCode},isMetaKey:function(l){return 91<=l.keyCode&&93>=l.keyCode},isFnLockKey:function(l){return 112<=l.keyCode&&145>=l.keyCode},isNavigationKey:function(l){var n=h.KEY_CODE;n=[n.SPACE,n.ENTER,n.UP_ARROW,n.DOWN_ARROW];return-1!=n.indexOf(l.keyCode)},hasModifierKey:function(l){return l.ctrlKey||l.metaKey||l.altKey},ELEMENT_MAX_PIXELS:1533917,BEFORE_NG_ARIA:210,KEY_CODE:{COMMA:188,SEMICOLON:186,ENTER:13,
...
function MdIterator(a,b){function d(){return[].concat(p)}function c(){return p.length}function e(t){return p.length&&-1<t&&t<p.length}function f(t){return t?e(m(t)+1):!1}function g(t){return t?e(m(t)-1):!1}function h(t){return e(t)?p[t]:null}function l(t,H){return p.filter(function(A){return A[t]===H})}function n(t,H){if(!t)return-1;angular.isNumber(H)||(H=p.length);p.splice(H,0,t);return m(t)}function v(t){q(t)&&p.splice(m(t),1)}function m(t){return p.indexOf(t)}function q(t){return t&&-1<m(t)}function r(){return p.length?
p[0]:null}function x(){return p.length?p[p.length-1]:null}function y(t,H,A,w){A=A||k;for(H=m(H);;){if(!e(H))return null;H+=t?-1:1;var B=null;e(H)?B=p[H]:b&&(B=t?x():r(),H=m(B));if(null===B||H===w)return null;if(A(B))return B;angular.isUndefined(w)&&(w=H)}}var k=function(){return!0};a&&!angular.isArray(a)&&(a=Array.prototype.slice.call(a));b=!!b;var p=a||[];return{items:d,count:c,inRange:e,contains:q,indexOf:m,itemAt:h,findBy:l,add:n,remove:v,first:r,last:x,next:angular.bind(null,y,!1),previous:angular.bind(null,
...
function mdMediaFactory(a,b,d){function c(r){var x=n[r];angular.isUndefined(x)&&(x=r,x=a.MEDIA[x]||("("!==x.charAt(0)?"("+x+")":x),x=n[r]=x);r=m[x];angular.isUndefined(r)&&((r=v[x])||(r=v[x]=d.matchMedia(x)),r.addListener(e),r=m[r.media]=!!r.matches);return r}function e(r){b.$evalAsync(function(){m[r.media]=!!r.matches})}function f(r){return v[r]}function g(r,x){for(var y=0;y<a.MEDIA_PRIORITY.length;y++){var k=a.MEDIA_PRIORITY[y];if(v[n[k]].matches&&(k=l(r,x+"-"+k),r[k]))return r[k]}return r[l(r,
x)]}function h(r,x,y){var k=[];r.forEach(function(p){var t=l(x,p);angular.isDefined(x[t])&&k.push(x.$observe(t,angular.bind(void 0,y,null)));for(var H in a.MEDIA)t=l(x,p+"-"+H),angular.isDefined(x[t])&&k.push(x.$observe(t,angular.bind(void 0,y,H)))});return function(){k.forEach(function(p){p()})}}function l(r,x){return q[x]||(q[x]=r.$normalize(x))}var n={},v={},m={},q={};c.getResponsiveAttribute=g;c.getQuery=f;c.watchResponsiveAttributes=h;return c}
...
function MdPrefixer(a,b){function d(l){l=angular.isArray(l)?l:[l];l.forEach(function(n){h.forEach(function(v){l.push(v+"-"+n)})});return l}function c(l){l=angular.isArray(l)?l:[l];return d(l).map(function(n){return"["+n+"]"}).join(",")}function e(l,n){l=g(l);if(!l)return!1;n=d(n);for(var v=0;v<n.length;v++)if(l.hasAttribute(n[v]))return!0;return!1}function f(l,n){(l=g(l))&&d(n).forEach(function(v){l.removeAttribute(v)})}function g(l){l=l[0]||l;if(l.nodeType)return l}var h=["data","x"];return a?b?
...
z.style.cssText||"",G=w.style.cssText||"",N=y.getViewportTop();y.disableScrollAround._viewPortTop=N;var C=w.clientWidth,F=w.scrollHeight>w.clientHeight+1,O=0<z.scrollTop?z:w;F&&angular.element(w).css({position:"fixed",width:"100%",top:-N+"px"});w.clientWidth<C&&(w.style.overflow="hidden");return function(){w.style.cssText=G;z.style.cssText=D;O.scrollTop=N}}t=t||{};y.disableScrollAround._count=Math.max(0,y.disableScrollAround._count||0);y.disableScrollAround._count++;if(y.disableScrollAround._restoreScroll)return y.disableScrollAround._restoreScroll;
var w=a[0].body,B=A(),u=H(p,t);return y.disableScrollAround._restoreScroll=function(){0>=--y.disableScrollAround._count&&(delete y.disableScrollAround._viewPortTop,B(),u(),delete y.disableScrollAround._restoreScroll)}},enableScrolling:function(){var k=this.disableScrollAround._restoreScroll;k&&k()},floatingScrollbars:function(){if(void 0===this.floatingScrollbars.cached){var k=angular.element("<div><div></div></div>").css({width:"100%","z-index":-1,position:"absolute",height:"35px","overflow-y":"scroll"});
...
G||D.callback()});z&&c.$digest()}var A=y.nextTick,w=A.timeout,B=A.queue||[];B.push({scope:t,callback:k});null==p&&(p=!0);A.digest=A.digest||p;A.queue=B;return w||(A.timeout=b(H,0,!1))},processTemplate:function(k){return r?k:k&&angular.isString(k)?k.replace(/\{\{/g,m).replace(/}}/g,q):k},getParentWithPointerEvents:function(k){for(k=k.parent();x(k,"pointer-events","none");)k=k.parent();return k},getNearestContentElement:function(k){for(k=k.parent()[0];k&&k!==h[0]&&k!==document.body&&"MD-CONTENT"!==
k.nodeName.toUpperCase();)k=k.parentNode;return k},checkStickySupport:function(){var k=angular.element("<div>");a[0].body.appendChild(k[0]);for(var p=["sticky","-webkit-sticky"],t=0;t<p.length;++t)if(k.css({position:p[t],top:0,"z-index":2}),k.css("position")==p[t]){var H=p[t];break}k.remove();return H},parseAttributeBoolean:function(k,p){return""===k||!!k&&(!1===p||"false"!==k&&"0"!==k)},hasComputedStyle:x,isParentFormSubmitted:function(k){return(k=(k=y.getClosest(k,"form"))?angular.element(k).controller("form"):
null)?k.$submitted:!1},animateScrollTo:function(k,p,t){function H(){var z=t||1E3;var D=y.now()-u;D>z?z=A+w:(z=(D/=z)*D,D*=z,z=A+w*(-2*D+3*z));k.scrollTop=z;(B?z<p:z>p)&&n(H)}var A=k.scrollTop,w=p-A,B=A<p,u=y.now();n(H)},uniq:function(k){if(k)return k.filter(function(p,t,H){return H.indexOf(p)===t})},getInnerHTML:function(k){var p=new XMLSerializer;return Array.prototype.map.call(k.childNodes,function(t){return p.serializeToString(t)}).join("")},getOuterHTML:function(k){var p=new XMLSerializer;return p.serializeToString(k)},
...
function MdAriaService(a,b,d,c){function e(q,r,x){var y=angular.element(q)[0]||q,k;if(k=y){if(!(k=y.hasAttribute(r)&&0!==y.getAttribute(r).length)){var p=y;k=r;var t=p.hasChildNodes(),H=!1;if(t)for(p=p.childNodes,t=0;t<p.length;t++){var A=p[t];1===A.nodeType&&A.hasAttribute(k)&&(A=A.currentStyle?A.currentStyle:d.getComputedStyle(A),(A="none"===A.display)||(H=!0))}k=H}k=!k}k&&(x=angular.isString(x)?x.trim():"",x.length?q.attr(r,x):m&&b.warn('ARIA: Attribute "',r,'", required for accessibility, is missing on node:',
y))}function f(q,r,x){a(function(){e(q,r,x())})}function g(q,r){var x=l(q)||"",y=-1<x.indexOf(c.startSymbol());y?f(q,r,function(){return l(q)}):e(q,r,x)}function h(q,r){var x=l(q),y=-1<x.indexOf(c.startSymbol());y||x||e(q,r,x)}function l(q){q=q[0]||q;for(var r=document.createTreeWalker(q,NodeFilter.SHOW_TEXT,null,!1),x="",y;y=r.nextNode();){var k;a:{for(k=y;k.parentNode&&(k=k.parentNode)!==q;)if(k.getAttribute&&"true"===k.getAttribute("aria-hidden")){k=!0;break a}k=void 0}k||(x+=y.textContent)}return x.trim()||
""}function n(q){q=angular.element(q)[0]||q;return q.hasAttribute?q.hasAttribute("aria-label")||q.hasAttribute("aria-labelledby")||q.hasAttribute("aria-describedby"):!1}function v(q,r){function x(y){if(!n(y))return!1;if(y.hasAttribute("role"))switch(y.getAttribute("role").toLowerCase()){case "command":case "definition":case "directory":case "grid":case "list":case "listitem":case "log":case "marquee":case "menu":case "menubar":case "note":case "presentation":case "separator":case "scrollbar":case "status":case "tablist":return!1}switch(y.tagName.toLowerCase()){case "abbr":case "acronym":case "address":case "applet":case "audio":case "b":case "bdi":case "bdo":case "big":case "blockquote":case "br":case "canvas":case "caption":case "center":case "cite":case "code":case "col":case "data":case "dd":case "del":case "dfn":case "dir":case "div":case "dl":case "em":case "embed":case "fieldset":case "figcaption":case "font":case "h1":case "h2":case "h3":case "h4":case "h5":case "h6":case "hgroup":case "html":case "i":case "ins":case "isindex":case "kbd":case "keygen":case "label":case "legend":case "li":case "map":case "mark":case "menu":case "object":case "ol":case "output":case "pre":case "presentation":case "q":case "rt":case "ruby":case "samp":case "small":case "source":case "span":case "status":case "strike":case "strong":case "sub":case "sup":case "svg":case "tbody":case "td":case "th":case "thead":case "time":case "tr":case "track":case "tt":case "ul":case "var":return!1}return!0}
r=r||1;q=angular.element(q)[0]||q;if(!q.parentNode)return!1;if(x(q.parentNode))return!0;r--;return r?v(q.parentNode,r):!1}var m=this.showWarnings;return{expect:e,expectAsync:f,expectWithText:g,expectWithoutText:h,getText:l,hasAriaLabel:n,parentHasAriaLabel:v}}angular.module("material.core").provider("$mdCompiler",MdCompilerProvider);MdCompilerProvider.$inject=["$compileProvider"];
...
function(c){var e=this._fetchContentElement(c);return this.$q.resolve({element:e.element,cleanup:e.restore,locals:{},link:function(){return e.element}})};b.prototype._compileTemplate=function(c){var e=this,f=c.templateUrl,g=c.template||"",h=angular.extend({},c.resolve),l=angular.extend({},c.locals),n=c.transformTemplate||angular.identity;angular.forEach(h,function(v,m){angular.isString(v)?h[m]=e.$injector.get(v):h[m]=e.$injector.invoke(v)});angular.extend(h,l);h.$$ngTemplate=f?this.$templateRequest(f):
this.$q.when(g);return this.$q.all(h).then(function(v){var m=n(v.$$ngTemplate,c);m=c.element||angular.element("<div>").html(m.trim()).contents();return e._compileElement(v,m,c)})};b.prototype._compileElement=function(c,e,f){function g(v){c.$scope=v;if(f.controller){var m=angular.extend({},c,{$element:e});m=h._createController(f,m,c);e.data("$ngControllerController",m);e.children().data("$ngControllerController",m);n.controller=m}return l(v)}var h=this,l=this.$compile(e),n={element:e,cleanup:e.remove.bind(e),
locals:c,link:g};return n};b.prototype._createController=function(c,e,f){var g;(g=d?"function"===typeof a.preAssignBindingsEnabled?a.preAssignBindingsEnabled():1===angular.version.major&&6>angular.version.minor?!0:!1:!0)?(g=this.$controller(c.controller,e,!0),c.bindToController&&angular.extend(g.instance,f),g=g()):(g=this.$controller(c.controller,e),c.bindToController&&angular.extend(g,f));c.controllerAs&&(e.$scope[c.controllerAs]=g);angular.isFunction(g.$onInit)&&g.$onInit();return g};b.prototype._fetchContentElement=
...
function MdGesture(a,b,d,c){function e(m){return function(q,r){r.distance<this.state.options.maxDistance&&this.dispatchEvent(q,m,r)}}function f(m,q,r){var x=HANDLERS[q.replace(/^\$md./,"")];if(!x)throw Error("Failed to register element with handler "+q+". Available handlers: "+Object.keys(HANDLERS).join(", "));return x.registerElement(m,r)}function g(m,q){var r=new a(m);angular.extend(r,q);HANDLERS[m]=r;return v}function h(){for(var m=document.createElement("div"),q=" webkit Moz MS ms o".split(" "),
r=0;r<q.length;r++){var x=q[r];x=x?x+"TouchAction":"touchAction";if(angular.isDefined(m.style[x]))return x}}var l=h(),n="undefined"!==typeof window.jQuery&&angular.element===window.jQuery,v={handler:g,register:f,isAndroid:c.isAndroid,isIos:c.isIos,isHijackingClicks:(c.isIos||c.isAndroid)&&!n&&!forceSkipClickHijack};v.isHijackingClicks&&(v.handler("click",{options:{maxDistance:maxClickDistance},onEnd:e("click")}),v.handler("focus",{options:{maxDistance:maxClickDistance},onEnd:function(m,q){q.distance<
this.state.options.maxDistance&&canFocus(m.target)&&(this.dispatchEvent(m,"focus",q),m.target.focus())}}),v.handler("mouseup",{options:{maxDistance:maxClickDistance},onEnd:e("mouseup")}),v.handler("mousedown",{onStart:function(m){this.dispatchEvent(m,"mousedown")}}));return v.handler("press",{onStart:function(m){this.dispatchEvent(m,"$md.pressdown")},onEnd:function(m){this.dispatchEvent(m,"$md.pressup")}}).handler("hold",{options:{maxDistance:6,delay:500},onCancel:function(){d.cancel(this.state.timeout)},
onStart:function(m,q){if(!this.state.registeredParent)return this.cancel();this.state.pos={x:q.x,y:q.y};this.state.timeout=d(angular.bind(this,function(){this.dispatchEvent(m,"$md.hold");this.cancel()}),this.state.options.delay,!1)},onMove:function(m,q){l||"touchmove"!==m.type||m.preventDefault();m=this.state.pos.x-q.x;q=this.state.pos.y-q.y;Math.sqrt(m*m+q*q)>this.options.maxDistance&&this.cancel()},onEnd:function(){this.onCancel()}}).handler("drag",{options:{minDistance:6,horizontal:!0,cancelMultiplier:1.5},
onSetup:function(m,q){l&&(this.oldTouchAction=m[0].style[l],m[0].style[l]=q.horizontal?"pan-y":"pan-x")},onCleanup:function(m){this.oldTouchAction&&(m[0].style[l]=this.oldTouchAction)},onStart:function(){this.state.registeredParent||this.cancel()},onMove:function(m,q){l||"touchmove"!==m.type||m.preventDefault();if(this.state.dragPointer)this.dispatchDragMove(m);else{if(this.state.options.horizontal){var r=Math.abs(q.distanceX)>this.state.options.minDistance;q=Math.abs(q.distanceY)>this.state.options.minDistance*
this.state.options.cancelMultiplier}else r=Math.abs(q.distanceY)>this.state.options.minDistance,q=Math.abs(q.distanceX)>this.state.options.minDistance*this.state.options.cancelMultiplier;r?(this.state.dragPointer=makeStartPointer(m),updatePointerState(m,this.state.dragPointer),this.dispatchEvent(m,"$md.dragstart",this.state.dragPointer)):q&&this.cancel()}},dispatchDragMove:b.throttle(function(m){this.state.isRunning&&(updatePointerState(m,this.state.dragPointer),this.dispatchEvent(m,"$md.drag",this.state.dragPointer))}),
onEnd:function(m){this.state.dragPointer&&(updatePointerState(m,this.state.dragPointer),this.dispatchEvent(m,"$md.dragend",this.state.dragPointer))}}).handler("swipe",{options:{minVelocity:.65,minDistance:10},onEnd:function(m,q){Math.abs(q.velocityX)>this.state.options.minVelocity&&Math.abs(q.distanceX)>this.state.options.minDistance?(q="left"==q.directionX?"$md.swipeleft":"$md.swiperight",this.dispatchEvent(m,q)):Math.abs(q.velocityY)>this.state.options.minVelocity&&Math.abs(q.distanceY)>this.state.options.minDistance&&
(q="up"==q.directionY?"$md.swipeup":"$md.swipedown",this.dispatchEvent(m,q))}})}function GestureHandler(a){this.name=a;this.state={}}
function MdGestureHandler(){function a(c,e,f){f=f||pointer;e=new angular.element.Event(e);e.$material=!0;e.pointer=f;e.srcEvent=c;angular.extend(e,{clientX:f.x,clientY:f.y,screenX:f.x,screenY:f.y,pageX:f.x,pageY:f.y,ctrlKey:c.ctrlKey,altKey:c.altKey,shiftKey:c.shiftKey,metaKey:c.metaKey});angular.element(f.target).trigger(e)}function b(c,e,f){f=f||pointer;if("click"===e||"mouseup"===e||"mousedown"===e)if("function"===typeof window.MouseEvent)var g=new MouseEvent(e,{bubbles:!0,cancelable:!0,screenX:Number(c.screenX),
screenY:Number(c.screenY),clientX:Number(f.x),clientY:Number(f.y),ctrlKey:c.ctrlKey,altKey:c.altKey,shiftKey:c.shiftKey,metaKey:c.metaKey,button:c.button,buttons:c.buttons,relatedTarget:c.relatedTarget||null});else g=document.createEvent("MouseEvents"),g.initMouseEvent(e,!0,!0,window,c.detail,f.x,f.y,f.x,f.y,c.ctrlKey,c.altKey,c.shiftKey,c.metaKey,c.button,c.relatedTarget||null);else"function"===typeof window.CustomEvent?g=new CustomEvent(e,{bubbles:!0,cancelable:!0,detail:{}}):(g=document.createEvent("CustomEvent"),
g.initCustomEvent(e,!0,!0,{}));g.$material=!0;g.pointer=f;g.srcEvent=c;f.target.dispatchEvent(g)}var d="undefined"!==typeof window.jQuery&&angular.element===window.jQuery;GestureHandler.prototype={options:{},dispatchEvent:d?a:b,onSetup:angular.noop,onCleanup:angular.noop,onStart:angular.noop,onMove:angular.noop,onEnd:angular.noop,onCancel:angular.noop,start:function(c,e){if(!this.state.isRunning){var f=this.getNearestParent(c.target),g=f&&f.$mdGesture[this.name]||{};this.state={isRunning:!0,options:angular.extend({},
...
function attachToDocument(a,b,d){function c(n){var v=!n.clientX&&!n.clientY;v||n.$material||n.isIonicTap||lastLabelClickPos&&lastLabelClickPos.x===n.x&&lastLabelClickPos.y===n.y||"mousedown"===n.type&&(canFocus(n.target)||canFocus(document.activeElement))||(n.preventDefault(),n.stopPropagation())}function e(n){var v;(v=d.isIos?angular.isDefined(n.webkitForce)&&0===n.webkitForce:0===n.clientX&&0===n.clientY)||n.$material||n.isIonicTap||lastLabelClickPos&&lastLabelClickPos.x===n.x&&lastLabelClickPos.y===
n.y?(lastLabelClickPos=null,"label"===n.target.tagName.toLowerCase()&&(lastLabelClickPos={x:n.x,y:n.y})):(n.preventDefault(),n.stopPropagation(),lastLabelClickPos=null)}function f(n,v){var m;for(m in HANDLERS){var q=HANDLERS[m];q instanceof b&&("start"===n&&q.cancel(),q[n](v,pointer))}}function g(n){if(!pointer){var v=+Date.now();lastPointer&&!typesMatch(n,lastPointer)&&1500>v-lastPointer.endTime||(pointer=makeStartPointer(n),f("start",n))}}function h(n){pointer&&typesMatch(n,pointer)&&(updatePointerState(n,
pointer),f("move",n))}function l(n){pointer&&typesMatch(n,pointer)&&(updatePointerState(n,pointer),pointer.endTime=+Date.now(),"pointercancel"!==n.type&&f("end",n),lastPointer=pointer,pointer=null)}disableAllGestures||(!isInitialized&&a.isHijackingClicks&&(document.addEventListener("click",e,!0),document.addEventListener("mouseup",c,!0),document.addEventListener("mousedown",c,!0),document.addEventListener("focus",c,!0),isInitialized=!0),angular.element(document).on("mousedown touchstart pointerdown",
...
function updatePointerState(a,b){var d=getEventPoint(a);a=b.x=d.pageX;d=b.y=d.pageY;b.distanceX=a-b.startX;b.distanceY=d-b.startY;b.distance=Math.sqrt(b.distanceX*b.distanceX+b.distanceY*b.distanceY);b.directionX=0<b.distanceX?"right":0>b.distanceX?"left":"";b.directionY=0<b.distanceY?"down":0>b.distanceY?"up":"";b.duration=+Date.now()-b.startTime;b.velocityX=b.distanceX/b.duration;b.velocityY=b.distanceY/b.duration}
function getEventPoint(a){a=a.originalEvent||a;return a.touches&&a.touches[0]||a.changedTouches&&a.changedTouches[0]||a}function canFocus(a){return!!a&&"-1"!==a.getAttribute("tabindex")&&!a.hasAttribute("disabled")&&(a.hasAttribute("tabindex")||a.hasAttribute("href")||a.isContentEditable||-1!=="INPUT SELECT BUTTON TEXTAREA VIDEO AUDIO".split(" ").indexOf(a.nodeName))}MdInteractionService.$inject=["$timeout","$mdUtil","$rootScope"];
...
function InterimElementProvider(){function a(d){function c(m){n.optionsFactory=m.options;n.methods=(m.methods||[]).concat(h);return v}function e(m,q){l[m]=q;return v}function f(m,q){q=q||{};q.methods=q.methods||[];q.options=q.options||function(){return{}};if(/^cancel|hide|show$/.test(m))throw Error("Preset '"+m+"' in "+d+" is reserved!");if(-1<q.methods.indexOf("_options"))throw Error("Method '_options' in "+d+" is reserved!");n.presets[m]={methods:q.methods.concat(h),optionsFactory:q.options,argOption:q.argOption};
return v}function g(m,q){function r(A){A=A||{};A._options&&(A=A._options);return k.show(angular.extend({},H,A))}function x(A){return k.destroy(A)}function y(A,w){var B={};B[d]=p;return q.invoke(A||function(){return w},{},B)}var k=m(),p={hide:k.hide,cancel:k.cancel,show:r,destroy:x};var t=n.methods||[];var H=y(n.optionsFactory,{});angular.forEach(l,function(A,w){p[w]=A});angular.forEach(n.presets,function(A,w){function B(D){this._options=angular.extend({},u,D)}var u=y(A.optionsFactory,{}),z=(A.methods||
[]).concat(t);angular.extend(u,{$type:w});angular.forEach(z,function(D){B.prototype[D]=function(G){this._options[D]=G;return this}});A.argOption&&(z="show"+w.charAt(0).toUpperCase()+w.slice(1),p[z]=function(D){D=p[w](D);return p.show(D)});p[w]=function(D){return arguments.length&&A.argOption&&!angular.isObject(D)&&!angular.isArray(D)?(new B)[A.argOption](D):new B(D)}});return p}g.$inject=["$$interimElement","$injector"];var h=["onHide","onShow","onRemove"],l={},n={presets:{}},v={setDefaults:c,addPreset:f,
addMethod:e,$get:g};v.addPreset("build",{methods:"controller controllerAs resolve multiple template templateUrl themable transformTemplate parent contentElement".split(" ")});return v}function b(d,c,e,f,g,h,l,n,v,m,q){return function(){function r(u){u=u||{};var z=new t(u||{}),D=u.multiple?c.resolve():c.all(A);u.multiple||(D=D.then(function(){var N=w.concat(B.map(H.cancel));return c.all(N)}));var G=D.then(function(){return z.show().then(function(){B.push(z)}).catch(function(N){return N}).finally(function(){A.splice(A.indexOf(G),
1)})});A.push(G);z.deferred.promise.catch(function(N){N instanceof Error&&q(N);return N});return z.deferred.promise}function x(u,z){function D(G){if(!G)return c.when(u);var N=G.remove(u,!1,z||{}).catch(function(C){return C}).finally(function(){w.splice(w.indexOf(N),1)});B.splice(B.indexOf(G),1);w.push(N);return G.deferred.promise}z=z||{};return z.closeAll?c.all(B.slice().reverse().map(D)):void 0!==z.closeTo?c.all(B.slice(z.closeTo).map(D)):D(B[B.length-1])}function y(u,z){var D=B.pop();if(!D)return c.when(u);
...
g[0].querySelector&&(fa=g[0].querySelector(":not(svg) > body")),fa||(fa=g[0]),"#comment"==fa.nodeName&&(fa=d[0].body),fa=angular.element(fa);U.parent=fa;R.themable&&v(Y);K=Y;u.cleanupElement=T.cleanup;M=F(K,u,T.controller).then(I,Q)}).catch(Q)})}function D(I,J,Q){function T(Y){S.deferred.reject(Y)}if(!K)return c.when(!1);u=angular.extend(u||{},Q||{});u.cancelAutoHide&&u.cancelAutoHide();u.element.triggerHandler("$mdInterimElementRemove");if(!0===u.$destroy)return O(u.element,u).then(function(){J&&
T(I)||S.deferred.resolve(I)});c.when(M).finally(function(){O(u.element,u).then(function(){J?T(I):S.deferred.resolve(I)},T)});return S.deferred.promise}function G(I){I=I||{};I.template&&(I.template=l.processTemplate(I.template));return angular.extend({preserveScope:!1,cancelAutoHide:angular.noop,scope:I.scope||e.$new(I.isolateScope),onShow:function(J,Q,T){return h.enter(Q,T.parent)},onRemove:function(J,Q){return Q&&h.leave(Q)||c.when()}},I)}function N(I){var J=I.skipCompile?null:n.compile(I);return J||
...
f(S))})});u.provider("$$mdLayout",function(){return{$get:angular.noop,validateAttributeValue:n,validateAttributeUsage:l,disableLayouts:function(O){B.enabled=!0!==O}}}).directive("mdLayoutCss",d).directive("ngCloak",c("ng-cloak")).directive("layoutWrap",f("layout-wrap")).directive("layoutNowrap",f("layout-nowrap")).directive("layoutNoWrap",f("layout-no-wrap")).directive("layoutFill",f("layout-fill")).directive("layoutLtMd",h("layout-lt-md",!0)).directive("layoutLtLg",h("layout-lt-lg",!0)).directive("flexLtMd",
...
function b(){var u=!!document.querySelector("[md-layouts-disabled]");B.enabled=!u}function d(){B.enabled=!1;return{restrict:"A",priority:"900"}}function c(u){return["$timeout",function(z){return{restrict:"A",priority:-10,compile:function(D){if(!B.enabled)return angular.noop;D.addClass(u);return function(G,N){z(function(){N.removeClass(u)},10,!1)}}}}]}function e(u){function z(D,G,N){G=g(G,u,N);var C=N.$observe(N.$normalize(u),G);G(m(u,N,""));D.$on("$destroy",function(){C()})}return["$mdUtil","$interpolate",
"$log",function(D,G,N){r=D;x=G;y=N;return{restrict:"A",compile:function(C,F){if(B.enabled){l(u,F,C,y);n(u,m(u,F,""),v(C,u,F));var O=z}return O||angular.noop}}}]}function f(u){function z(D,G){G.addClass(u)}return["$mdUtil","$interpolate","$log",function(D,G,N){r=D;x=G;y=N;return{restrict:"A",compile:function(C,F){if(B.enabled){n(u,m(u,F,""),v(C,u,F));C.addClass(u);var O=z}return O||angular.noop}}}]}function g(u,z){var D;return function(G){G=n(z,G||"");angular.isDefined(G)&&(D&&u.removeClass(D),D=G?
z+"-"+G.trim().replace(p,"-"):z,u.addClass(D))}}function h(u){var z=u.split("-");return["$log",function(D){D.warn(u+"has been deprecated. Please use a `"+z[0]+"-gt-<xxx>` variant.");return angular.noop}]}function l(u,z,D,G){z=D[0].nodeName.toLowerCase();switch(u.replace(k,"")){case "flex":if("md-button"==z||"fieldset"==z)z="<"+z+" "+u+"></"+z+">",D="https://github.com/philipwalton/flexbugs#9-some-html-elements-cant-be-flex-containers",u="Markup '{0}' may not work as expected in IE Browsers. Consult '{1}' for details.",
G.warn(r.supplant(u,[z,D]))}}function n(u,z,D){var G;if(!(-1<(z||"").indexOf(x.startSymbol()))){switch(u.replace(k,"")){case "layout":q(z,H)||(z=H[0]);break;case "flex":q(z,t)||isNaN(z)&&(z="");break;case "flex-offset":case "flex-order":if(!z||isNaN(+z))z="0";break;case "layout-align":u={main:"start",cross:"stretch"};z=z||"";if(0===z.indexOf("-")||0===z.indexOf(" "))z="none"+z;z=z.toLowerCase().trim().replace(p,"-").split("-");z.length&&"space"===z[0]&&(z=[z[0]+"-"+z[1],z[2]]);0<z.length&&(u.main=
z[0]||u.main);1<z.length&&(u.cross=z[1]||u.cross);0>A.indexOf(u.main)&&(u.main="start");0>w.indexOf(u.cross)&&(u.cross="stretch");z=r.supplant("{main}-{cross}",u);break;case "layout-padding":case "layout-margin":case "layout-fill":case "layout-wrap":case "layout-nowrap":z=""}z!=G&&(D||angular.noop)(z)}return z?z.trim():""}function v(u,z,D){return function(G){-1<(G||"").indexOf(x.startSymbol())||(D[D.$normalize(z)]=G)}}function m(u,z,D){u=z.$normalize(u);return z[u]?z[u].trim().replace(p,"-"):D||null}
...
function ComponentRegistry(a,b){var d,c=[],e={};return d={notFoundError:function(f,g){a.error((g||"")+"No instance found for handle",f)},getInstances:function(){return c},get:function(f){if(!f||""===f)return null;var g;var h=0;for(g=c.length;h<g;h++){var l=c[h];if(l.$$mdHandle===f)return l}return null},register:function(f,g){function h(){var n=c.indexOf(f);-1!==n&&c.splice(n,1)}function l(){var n=e[g];n&&(n.forEach(function(v){v.resolve(f)}),delete e[g])}if(!g)return angular.noop;f.$$mdHandle=g;c.push(f);
l();return h},when:function(f){if(f&&""!==f){var g=b.defer(),h=d.get(f);h?g.resolve(h):(void 0===e[f]&&(e[f]=[]),e[f].push(g));return g.promise}return b.reject("Invalid `md-component-id` value.")}}}
...
(function(a){function b(D){var G=!!document.querySelector("[md-themes-disabled]");D.disableTheming(G)}function d(D,G){function N(R,U){U=U||{};r[R]=F(R,U);return I}function C(R,U){return F(R,a.extend({},r[R]||{},U))}function F(R,U){var X=B.filter(function(aa){return!U[aa]});if(X.length)throw Error("Missing colors %1 in palette %2!".replace("%1",X.join(", ")).replace("%2",R));return U}function O(R,U){if(M[R])return M[R];U=U||"default";U="string"===typeof U?M[U]:U;var X=new S(R);U&&a.forEach(U.colors,
function(aa,ha){X.colors[ha]={name:aa.name,hues:a.extend({},aa.hues)}});return M[R]=X}function S(R){function U(aa){aa=0===arguments.length?!0:!!aa;if(aa!==X.isDark){X.isDark=aa;X.foregroundPalette=X.isDark?y:x;X.foregroundShadow=X.isDark?"1px 1px 0px rgba(0,0,0,0.4), -1px -1px 0px rgba(0,0,0,0.4)":"";var ha=X.isDark?w:A,fa=X.isDark?A:w;a.forEach(ha,function(ea,ca){var da=X.colors[ca];ca=fa[ca];if(da)for(var la in da.hues)da.hues[la]===ca[la]&&(da.hues[la]=ea[la])});return X}}var X=this;X.name=R;X.colors=
{};X.dark=U;U(!1);H.forEach(function(aa){var ha=(X.isDark?w:A)[aa];X[aa+"Palette"]=function(fa,ea){var ca=X.colors[aa]={name:fa,hues:a.extend({},ha,ea)};Object.keys(ca.hues).forEach(function(da){if(!ha[da])throw Error("Invalid hue name '%1' in theme %2's %3 color %4. Available hue names: %4".replace("%1",da).replace("%2",X.name).replace("%3",fa).replace("%4",Object.keys(ha).join(", ")));});Object.keys(ca.hues).map(function(da){return ca.hues[da]}).forEach(function(da){if(-1==B.indexOf(da))throw Error("Invalid hue value '%1' in theme %2's %3 color %4. Available hue values: %5".replace("%1",
da).replace("%2",X.name).replace("%3",aa).replace("%4",fa).replace("%5",B.join(", ")));});return X};X[aa+"Color"]=function(){var fa=Array.prototype.slice.call(arguments);console.warn("$mdThemingProviderTheme."+aa+"Color() has been deprecated. Use $mdThemingProviderTheme."+aa+"Palette() instead.");return X[aa+"Palette"].apply(X,fa)}})}function K(R,U,X,aa){function ha(ca){return void 0===ca||""===ca?!0:void 0!==ea.THEMES[ca]}function fa(ca,da){function la(ma){if(ma){ha(ma)||aa.warn("Attempted to use unregistered theme '"+
ma+"'. Register it with $mdThemingProvider.theme().");var za=ca.data("$mdThemeName");za&&ca.removeClass("md-"+za+"-theme");ca.addClass("md-"+ma+"-theme");ca.data("$mdThemeName",ma);pa&&ca.data("$mdThemeController",pa)}}var pa=da.controller("mdTheme")||ca.data("$mdThemeController");da=ca.scope();la(pa&&pa.$mdTheme||("default"===Q?"":Q));if(pa){var Ga=J||pa.$shouldWatch||U.parseAttributeBoolean(ca.attr("md-theme-watch"));if(Ga||pa.isAsyncTheme){var wa=function(){Aa&&(Aa(),Aa=void 0)},Aa=pa.registerChanges(function(ma){la(ma);
Ga||wa()});if(da)da.$on("$destroy",wa);else ca.on("$destroy",wa)}}}var ea=function(ca,da){void 0===da&&(da=ca);ea.inherit(da,da)};Object.defineProperty(ea,"THEMES",{get:function(){return a.extend({},M)}});Object.defineProperty(ea,"PALETTES",{get:function(){return a.extend({},r)}});Object.defineProperty(ea,"ALWAYS_WATCH",{get:function(){return J}});ea.inherit=fa;ea.registered=ha;ea.defaultTheme=function(){return Q};ea.generateTheme=function(ca){l(M[ca],ca,u.nonce)};ea.defineTheme=function(ca,da){da=
...
setNonce:function(R){u.nonce=R},generateThemesOnDemand:function(R){u.generateOnDemand=R},setDefaultTheme:function(R){Q=R},alwaysWatchTheme:function(R){J=R},enableBrowserColor:Y,$get:K,_LIGHT_DEFAULT_HUES:A,_DARK_DEFAULT_HUES:w,_PALETTES:r,_THEMES:M,_parseRules:g,_rgba:m}}function c(D,G,N,C,F,O){return{priority:101,link:{pre:function(S,K,M){var I=[],J=G.startSymbol(),Q=G.endSymbol(),T=M.mdTheme.trim();T=T.substr(0,J.length)===J&&T.lastIndexOf(Q)===T.length-Q.length;J="::"===M.mdTheme.split(J).join("").split(Q).join("").trim().substr(0,
2);Q=function(){var X=G(M.mdTheme)(S);return N(X)(S)||X};var Y={isAsyncTheme:a.isFunction(Q())||a.isFunction(Q().then),registerChanges:function(X,aa){aa&&(X=a.bind(aa,X));I.push(X);return function(){var ha=I.indexOf(X);-1<ha&&I.splice(ha,1)}},$setTheme:function(X){D.registered(X)||O.warn("attempted to use unregistered theme '"+X+"'");Y.$mdTheme=X;for(var aa=I.length;aa--;)I[aa](X)},$shouldWatch:C.parseAttributeBoolean(K.attr("md-theme-watch"))||D.ALWAYS_WATCH||T&&!J};K.data("$mdThemeController",Y);
var R=function(X){if("string"===typeof X)return Y.$setTheme(X);F.when(a.isFunction(X)?X():X).then(function(aa){Y.$setTheme(aa)})};R(Q());var U=S.$watch(Q,function(X){X&&(R(X),Y.$shouldWatch||U())})}}}}function e(){u.disableTheming=!0;return{restrict:"A",priority:"900"}}function f(D){return D}function g(D,G,N){n(D,G);N=N.replace(/THEME_NAME/g,D.name);var C=new RegExp("\\.md-"+D.name+"-theme","g");G=/'?"?\{\{\s*([a-zA-Z]+)-(A?\d+|hue-[0-3]|shadow|default)-?(\d\.?\d*)?(contrast)?\s*\}\}'?"?/g;N=N.replace(G,
function(S,K,M,I,J){if("foreground"===K)return"shadow"==M?D.foregroundShadow:D.foregroundPalette[M]||D.foregroundPalette["1"];if(0===M.indexOf("hue")||"default"===M)M=D.colors[K].hues[M];return m((r[D.colors[K].name][M]||"")[J?"contrast":"value"],I)});var F=/('|")?{{\s*([a-zA-Z]+)-(color|contrast)-?(\d\.?\d*)?\s*}}("|')?/g,O=[];a.forEach(["default","hue-1","hue-2","hue-3"],function(S){var K=N.replace(F,function(I,J,Q,T,Y){Q=D.colors[Q];I=r[Q.name];Q=Q.hues[S];return m(I[Q]["color"===T?"value":"contrast"],
Y)});"default"!==S&&(K=K.replace(C,".md-"+D.name+"-theme.md-"+S));if("default"==D.name){var M=/((?:\s|>|\.|\w|-|:|\(|\)|\[|\]|"|'|=)*)\.md-default-theme((?:\s|>|\.|\w|-|:|\(|\)|\[|\]|"|'|=)*)/g;K=K.replace(M,function(I,J,Q){return I+", "+J+Q})}O.push(K)});return O}function h(D,G){function N(F){var O=F.contrastDefaultColor,S=F.contrastLightColors||[],K=F.contrastStrongLightColors||[],M=F.contrastDarkColors||[];"string"===typeof S&&(S=S.split(" "));"string"===typeof K&&(K=K.split(" "));"string"===typeof M&&
(M=M.split(" "));delete F.contrastDefaultColor;delete F.contrastLightColors;delete F.contrastStrongLightColors;delete F.contrastDarkColors;a.forEach(F,function(I,J){if(!a.isObject(I)){var Q=v(I);if(!Q)throw Error("Color %1, in palette %2's hue %3, is invalid. Hex or rgb(a) color expected.".replace("%1",I).replace("%2",F.name).replace("%3",J));F[J]={hex:F[J],value:Q,contrast:"light"===O?-1<M.indexOf(J)?k:-1<K.indexOf(J)?t:p:-1<S.indexOf(J)?-1<K.indexOf(J)?t:p:k}}})}var C=document.head;C=C?C.firstElementChild:
null;D=!u.disableTheming&&D.has("$MD_THEME_CSS")?D.get("$MD_THEME_CSS"):"";D+=u.registeredStyles.join("");C&&0!==D.length&&(a.forEach(r,N),D=D.split(/\}(?!(\}|'|"|;))/).filter(function(F){return F&&F.trim().length}).map(function(F){return F.trim()+"}"}),H.forEach(function(F){z[F]=""}),D.forEach(function(F){for(var O=0,S;S=H[O];O++)if(-1<F.indexOf(".md-"+S))return z[S]+=F;for(O=0;S=H[O];O++)if(-1<F.indexOf(S))return z[S]+=F;return z.primary+=F}),u.generateOnDemand||a.forEach(G.THEMES,function(F){q[F.name]||
"default"!==G.defaultTheme()&&"default"===F.name||l(F,F.name,u.nonce)}))}function l(D,G,N){var C=document.head,F=C?C.firstElementChild:null;q[G]||(H.forEach(function(O){for(O=g(D,O,z[O]);O.length;){var S=O.shift();if(S){var K=document.createElement("style");K.setAttribute("md-theme-style","");N&&K.setAttribute("nonce",N);K.appendChild(document.createTextNode(S));C.insertBefore(K,F)}}}),q[D.name]=!0)}function n(D,G){if(!r[(D.colors[G]||{}).name])throw Error("You supplied an invalid color palette for theme %1's %2 palette. Available palettes: %3".replace("%1",
D.name).replace("%2",G).replace("%3",Object.keys(r).join(", ")));}function v(D){if(a.isArray(D)&&3==D.length)return D;if(/^rgb/.test(D))return D.replace(/(^\s*rgba?\(|\)\s*$)/g,"").split(",").map(function(F,O){return 3==O?parseFloat(F,10):parseInt(F,10)});"#"==D.charAt(0)&&(D=D.substring(1));if(/^([a-fA-F0-9]{3}){1,2}$/g.test(D)){var G=D.length/3,N=D.substr(0,G),C=D.substr(G,G);D=D.substr(2*G);1===G&&(N+=N,C+=C,D+=D);return[parseInt(N,16),parseInt(C,16),parseInt(D,16)]}}function m(D,G){if(!D)return"rgb('0,0,0')";
4==D.length&&(D=a.copy(D),G?D.pop():G=D.pop());return G&&("number"==typeof G||"string"==typeof G&&G.length)?"rgba("+D.join(",")+","+G+")":"rgb("+D.join(",")+")"}b.$inject=["$mdThemingProvider"];c.$inject="$mdTheming $interpolate $parse $mdUtil $q $log".split(" ");f.$inject=["$mdTheming"];d.$inject=["$mdColorPalette","$$mdMetaProvider"];h.$inject=["$injector","$mdTheming"];a.module("material.core.theming",["material.core.theming.palette","material.core.meta"]).directive("mdTheme",c).directive("mdThemable",
...
(function(){function a(b){function d(c){return c.hasClass("md-icon-button")?{isMenuItem:c.hasClass("md-menu-item"),fitRipple:!0,center:!0}:{isMenuItem:c.hasClass("md-menu-item"),dimBackground:!0}}return{attach:function(c,e,f){f=angular.extend(d(e),f);return b.attach(c,e,f)}}}a.$inject=["$mdInkRipple"];angular.module("material.core").factory("$mdButtonInkRipple",a)})();
...
function autoCleanup(a,b){if(a.mousedown||a.lastRipple)a.mousedown=!1,a.$mdUtil.nextTick(angular.bind(a,b),!1)}InkRippleCtrl.prototype.color=function(a){function b(){var c=d.options&&d.options.colorElement?d.options.colorElement:[];return(c=c.length?c[0]:d.$element[0])?d.$window.getComputedStyle(c).color:"rgb(0,0,0)"}var d=this;angular.isDefined(a)&&(d._color=d._parseColor(a));return d._color||d._parseColor(d.inkRipple())||d._parseColor(b())};InkRippleCtrl.prototype.calculateColor=function(){return this.color()};
InkRippleCtrl.prototype._parseColor=function(a,b){b=b||1;var d=this.$mdColorUtil;if(a){if(0===a.indexOf("rgba"))return a.replace(/\d?\.?\d*\s*\)\s*$/,(.1*b).toString()+")");if(0===a.indexOf("rgb"))return d.rgbToRgba(a);if(0===a.indexOf("#"))return d.hexToRgba(a)}};
...
InkRippleCtrl.prototype.createRipple=function(a,b){if(this.isRippleAllowed()){var d=this,c=d.$mdColorUtil,e=angular.element('<div class="md-ripple"></div>'),f=this.$element.prop("clientWidth"),g=this.$element.prop("clientHeight");f=2*Math.max(Math.abs(f-a),a);g=2*Math.max(Math.abs(g-b),b);g=this.options.fitRipple?Math.max(f,g):Math.sqrt(Math.pow(f,2)+Math.pow(g,2));f=this.calculateColor();e.css({left:a+"px",top:b+"px",background:"black",width:g+"px",height:g+"px",backgroundColor:c.rgbaToRgb(f),borderColor:c.rgbaToRgb(f)});
...
function AnimateDomUtils(a,b,d,c,e){var f;return f={translate3d:function(g,h,l,n){function v(m){return e(g,{to:m||h,addClass:n.transitionOutClass,removeClass:n.transitionInClass,duration:n.duration}).start()}return e(g,{from:h,to:l,addClass:n.transitionInClass,removeClass:n.transitionOutClass,duration:n.duration}).start().then(function(){return v})},waitTransitionEnd:function(g,h){var l=3E3;return b(function(n){function v(r){r&&r.target!==g[0]||(r&&d.cancel(q),g.off(c.CSS.TRANSITIONEND,v),n())}function m(r){r=
r||window.getComputedStyle(g[0]);return"0s"==r.transitionDuration||!r.transition&&!r.transitionProperty}h=h||{};m(h.cachedTransitionStyles)&&(l=0);var q=d(v,h.timeout||l);g.on(c.CSS.TRANSITIONEND,v)})},calculateTransformValues:function(g,h){var l=h.element;h=h.bounds;if(l||h){l?(l=f.clientRect(l))||(l=(l=(l=g?g.parent():null)?l.parent():null)?f.clientRect(l):null):l=f.copyRect(h);g=f.copyRect(g[0].getBoundingClientRect());h=f.centerPointFor(g);var n=f.centerPointFor(l);return{centerX:n.x-h.x,centerY:n.y-
...
h))},toCss:function(g){function h(n,v,m){angular.forEach(v.split(" "),function(q){l[q]=m})}var l={};angular.forEach(g,function(n,v){if(!angular.isUndefined(n))if(0<="left top right bottom width height x y min-width min-height max-width max-height".indexOf(v))l[v]=n+"px";else switch(v){case "transition":h(v,c.CSS.TRANSITION,n);break;case "transform":h(v,c.CSS.TRANSFORM,n);break;case "transformOrigin":h(v,c.CSS.TRANSFORM_ORIGIN,n);break;case "font-size":l["font-size"]=n}});return l},toTransformCss:function(g,
h,l){var n={};angular.forEach(c.CSS.TRANSFORM.split(" "),function(v){n[v]=g});h&&(l=l||"all 0.4s cubic-bezier(0.25, 0.8, 0.25, 1) !important",n.transition=l);return n},copyRect:function(g,h){if(!g)return null;h=h||{};angular.forEach("left top right bottom width height".split(" "),function(l){h[l]=Math.round(g[l])});h.width=h.width||h.right-h.left;h.height=h.height||h.bottom-h.top;return h},clientRect:function(g){return(g=angular.element(g)[0].getBoundingClientRect())&&0<g.width&&0<g.height?f.copyRect(g):
null},centerPointFor:function(g){return g?{x:Math.round(g.left+g.width/2),y:Math.round(g.top+g.height/2)}:{x:0,y:0}}}}
4<=angular.version.minor?angular.module("material.core.animate",[]):function(){function a(n){return n.replace(/-[a-z]/g,function(v){return v.charAt(1).toUpperCase()})}var b=angular.forEach,d=angular.isDefined(document.documentElement.style.WebkitAppearance),c=d?"-webkit-":"",e=(d?"webkitTransitionEnd ":"")+"transitionend",f=(d?"webkitAnimationEnd ":"")+"animationend",g=["$document",function(n){return function(){return n[0].body.clientWidth+1}}],h=["$$rAF",function(n){return function(){var v=!1;n(function(){v=
!0});return function(m){v?m():n(m)}}}],l=["$q","$$rAFMutex",function(n,v){function m(q){this.setHost(q);this._doneCallbacks=[];this._runInAnimationFrame=v();this._state=0}m.prototype={setHost:function(q){this.host=q||{}},done:function(q){2===this._state?q():this._doneCallbacks.push(q)},progress:angular.noop,getPromise:function(){if(!this.promise){var q=this;this.promise=n(function(r,x){q.done(function(y){!1===y?x():r()})})}return this.promise},then:function(q,r){return this.getPromise().then(q,r)},
"catch":function(q){return this.getPromise()["catch"](q)},"finally":function(q){return this.getPromise()["finally"](q)},pause:function(){this.host.pause&&this.host.pause()},resume:function(){this.host.resume&&this.host.resume()},end:function(){this.host.end&&this.host.end();this._resolve(!0)},cancel:function(){this.host.cancel&&this.host.cancel();this._resolve(!1)},complete:function(q){var r=this;0===r._state&&(r._state=1,r._runInAnimationFrame(function(){r._resolve(q)}))},_resolve:function(q){2!==
this._state&&(b(this._doneCallbacks,function(r){r(q)}),this._doneCallbacks.length=0,this._state=2)}};m.all=function(q,r){function x(p){k=k&&p;++y===q.length&&r(k)}var y=0,k=!0;b(q,function(p){p.done(x)})};return m}];angular.module("material.core.animate",[]).factory("$$forceReflow",g).factory("$$AnimateRunner",l).factory("$$rAFMutex",h).factory("$animateCss",["$window","$$rAF","$$AnimateRunner","$$forceReflow","$$jqLite","$timeout","$animate",function(n,v,m,q,r,x,y){function k(C,F){var O=[],S=z(C),
K=S&&y.enabled(),M=!1,I=!1;K&&(F.transitionStyle&&O.push([c+"transition",F.transitionStyle]),F.keyframeStyle&&O.push([c+"animation",F.keyframeStyle]),F.delay&&O.push([c+"transition-delay",F.delay+"s"]),F.duration&&O.push([c+"transition-duration",F.duration+"s"]),M=F.keyframeStyle||F.to&&(0<F.duration||F.transitionStyle),I=!!F.addClass||!!F.removeClass,D(C,!0));var J=K&&(M||I);B(C,F);var Q=!1,T,Y;return{close:n.close,start:function(){function R(){if(!Q)return Q=!0,T&&Y&&C.off(T,Y),p(C,F),w(C,F),b(O,
function(X){S.style[a(X[0])]=""}),U.complete(!0),U}var U=new m;A(function(){D(C,!1);if(!J)return R();b(O,function(ca){var da=ca[0];ca=ca[1];S.style[a(da)]=ca});p(C,F);var X=t(C);if(0===X.duration)return R();var aa=[];F.easing&&(X.transitionDuration&&aa.push([c+"transition-timing-function",F.easing]),X.animationDuration&&aa.push([c+"animation-timing-function",F.easing]));F.delay&&X.animationDelay&&aa.push([c+"animation-delay",F.delay+"s"]);F.duration&&X.animationDuration&&aa.push([c+"animation-duration",
F.duration+"s"]);b(aa,function(ca){var da=ca[0],la=ca[1];S.style[a(da)]=la;O.push(ca)});aa=X.delay;var ha=1E3*aa,fa=X.duration;aa=1E3*fa;var ea=Date.now();T=[];X.transitionDuration&&T.push(e);X.animationDuration&&T.push(f);T=T.join(" ");Y=function(ca){ca.stopPropagation();var da=ca.originalEvent||ca;ca=da.timeStamp||Date.now();da=parseFloat(da.elapsedTime.toFixed(3));Math.max(ca-ea,0)>=ha&&da>=fa&&R()};C.on(T,Y);u(C,F);x(R,ha+1.5*aa,!1)});return U}}}function p(C,F){F.addClass&&(r.addClass(C,F.addClass),
F.addClass=null);F.removeClass&&(r.removeClass(C,F.removeClass),F.removeClass=null)}function t(C){function F(J){return d?"Webkit"+J.charAt(0).toUpperCase()+J.substr(1):J}C=z(C);var O=n.getComputedStyle(C);C=H(O[F("transitionDuration")]);var S=H(O[F("animationDuration")]),K=H(O[F("transitionDelay")]),M=H(O[F("animationDelay")]);S*=parseInt(O[F("animationIterationCount")],10)||1;O=Math.max(S,C);var I=Math.max(M,K);return{duration:O,delay:I,animationDuration:S,transitionDuration:C,animationDelay:M,transitionDelay:K}}
function H(C){var F=0;C=(C||"").split(/\s*,\s*/);b(C,function(O){"s"==O.charAt(O.length-1)&&(O=O.substring(0,O.length-1));O=parseFloat(O)||0;F=F?Math.max(O,F):O});return F}function A(C){G&&G();N.push(C);G=v(function(){G=null;for(var F=q(),O=0;O<N.length;O++)N[O](F);N.length=0})}function w(C,F){B(C,F);u(C,F)}function B(C,F){F.from&&(C.css(F.from),F.from=null)}function u(C,F){F.to&&(C.css(F.to),F.to=null)}function z(C){for(var F=0;F<C.length;F++)if(1===C[F].nodeType)return C[F]}function D(C,F){C=z(C);
...
function mdIconDirective(a,b,d){function c(e,f,g){function h(){if(!g.mdSvgIcon&&!g.mdSvgSrc){g.mdFontIcon&&(f.removeClass(l),f.addClass(g.mdFontIcon),l=g.mdFontIcon);var m=a.fontSet(g.mdFontSet);n!==m&&(f.removeClass(n),f.addClass(m),n=m)}}b(f);var l=g.mdFontIcon,n=a.fontSet(g.mdFontSet);g.mdSvgIcon||g.mdSvgSrc||(g.mdFontIcon&&f.addClass("md-font "+g.mdFontIcon),f.addClass(n));g.$observe("mdFontIcon",h);g.$observe("mdFontSet",h);f[0].getAttribute(g.$attr.mdSvgSrc);e=g.$normalize(g.$attr.mdSvgIcon||
g.$attr.mdSvgSrc||"");g.role||(d.expect(f,"role","img"),g.role="img");if("img"===g.role&&!g.ariaHidden&&!d.hasAriaLabel(f)){var v;g.alt?d.expect(f,"aria-label",g.alt):d.parentHasAriaLabel(f,2)?d.expect(f,"aria-hidden","true"):(v=g.mdFontIcon||g.mdSvgIcon||f.text())?d.expect(f,"aria-label",v):d.expect(f,"aria-hidden","true")}e&&g.$observe(e,function(m){f.empty();m&&a(m).then(function(q){f.empty();f.append(q)})})}return{restrict:"E",link:c}}MdIconService.$inject="config $templateRequest $q $log $mdUtil $sce".split(" ");
...
function createDirective(a,b){return["$mdUtil","$window",function(d,c){return{restrict:"A",multiElement:!0,link:function(e,f,g){var h=e.$on("$md-resize-enable",function(){h();var l=f[0],n=l.nodeType===c.Node.ELEMENT_NODE?c.getComputedStyle(l):{};e.$watch(g[a],function(v){!!v===b&&(d.nextTick(function(){e.$broadcast("$md-resize")}),v={cachedTransitionStyles:n},d.dom.animator.waitTransitionEnd(f,v).then(function(){e.$broadcast("$md-resize")}))})})}}}]}ngmaterial.components.showHide=angular.module("material.components.showHide");VirtualRepeatContainerController.$inject="$$rAF $mdUtil $mdConstant $parse $rootScope $window $scope $element $attrs".split(" ");VirtualRepeatController.$inject="$scope $element $attrs $browser $document $rootScope $$rAF $mdUtil".split(" ");VirtualRepeatDirective.$inject=["$parse"];
...
this.offsetter=this.scroller.querySelector(".md-virtual-repeat-offsetter");var n=angular.bind(this,this.updateSize);a(angular.bind(this,function(){n();var v=b.debounce(n,10,null,!1),m=angular.element(f);this.size||v();m.on("resize",v);g.$on("$destroy",function(){m.off("resize",v)});g.$emit("$md-resize-enable");g.$on("$md-resize",n)}))}
...
function VirtualRepeatDirective(a){return{controller:VirtualRepeatController,priority:1E3,require:["mdVirtualRepeat","^^mdVirtualRepeatContainer"],restrict:"A",terminal:!0,transclude:"element",compile:function(b,d){b=d.mdVirtualRepeat;b=b.match(/^\s*([\s\S]+?)\s+in\s+([\s\S]+?)\s*$/);var c=b[1],e=a(b[2]),f=d.mdExtraName&&a(d.mdExtraName);return function(g,h,l,n,v){n[0].link_(n[1],v,c,e,f)}}}}
...
VirtualRepeatController.prototype.virtualRepeatUpdate_=function(a,b){this.isVirtualRepeatUpdating_=!0;var d=a&&a.length||0,c=!1;if(this.items&&d<this.items.length&&0!==this.container.getScrollOffset()){this.items=a;var e=this.container.getScrollOffset();this.container.resetScroll();this.container.scrollTo(e)}d!==this.itemsLength&&(c=!0,this.itemsLength=d);this.items=a;(a!==b||c)&&this.updateIndexes_();this.parentNode=this.$element[0].parentNode;c&&this.container.setScrollSize(d*this.itemSize);Object.keys(this.blocks).forEach(function(g){g=
parseInt(g,10);(g<this.newStartIndex||g>=this.newEndIndex)&&this.poolBlock_(g)},this);this.$browser.$$checkUrlChange=angular.noop;d=[];c=[];for(a=this.newStartIndex;a<this.newEndIndex&&null==this.blocks[a];a++)b=this.getBlock_(a),this.updateBlock_(b,a),d.push(b);for(;null!=this.blocks[a];a++)this.updateBlock_(this.blocks[a],a);for(e=a-1;a<this.newEndIndex;a++)b=this.getBlock_(a),this.updateBlock_(b,a),c.push(b);d.length&&this.parentNode.insertBefore(this.domFragmentFromBlocks_(d),this.$element[0].nextSibling);
...
function MdAutocompleteCtrl(a,b,d,c,e,f,g,h,l,n,v,m){function q(){d.initOptionalProperties(a,l,{searchText:"",selectedItem:null,clearButton:!1,disableVirtualRepeat:!1});e(b);p();d.nextTick(function(){var V;for(V=b;V.length;V=V.parent()){var ba=V.attr("md-autocomplete-snap");if(angular.isDefined(ba))break}V.length?V={snap:V[0],wrap:"width"===ba.toLowerCase()?V[0]:b.find("md-autocomplete-wrap")[0]}:(V=b.find("md-autocomplete-wrap")[0],V={snap:V,wrap:V});L={main:b[0],scrollContainer:b[0].querySelector(".md-virtual-repeat-container, .md-standard-list-container"),
...
A)}}function D(){qa=!0}function G(){sa||W.hidden||L.input.focus();qa=!1;W.hidden=!U()}function N(V,ba){r();V?J(V).then(function(ia){a.searchText=ia;C(V,ba)}):ba&&a.searchText&&J(ba).then(function(ia){angular.isString(a.searchText)&&ia.toString().toLowerCase()===a.searchText.toLowerCase()&&(a.searchText="")});V!==ba&&angular.isFunction(a.itemChange)&&a.itemChange(Q(a.selectedItem))}function C(V,ba){ta.forEach(function(ia){ia(V,ba)})}function F(V){-1===ta.indexOf(V)&&ta.push(V)}function O(V){V=ta.indexOf(V);
-1!==V&&ta.splice(V,1)}function S(V,ba){W.index=a.autoselect?0:-1;V!==ba&&(r(),J(a.selectedItem).then(function(ia){V!==ia&&(a.selectedItem=null,V!==ba&&angular.isFunction(a.textChange)&&a.textChange(),fa()?Ia():(W.matches=[],T(!1),wa(!0,Ba.Count)))}))}function K(V){sa=!1;if(!qa){W.hidden=!U();var ba="ngBlur";V={$event:V};l[ba]&&a.$parent.$eval(l[ba],V||{})}}function M(V){sa=!0;Y()&&fa()&&Ia();W.hidden=!U();var ba="ngFocus";V={$event:V};l[ba]&&a.$parent.$eval(l[ba],V||{})}function I(V){switch(V.keyCode){case c.KEY_CODE.DOWN_ARROW:if(W.loading||
X())break;V.stopPropagation();V.preventDefault();W.index=Math.min(W.index+1,W.matches.length-1);d.nextTick(k);ma();break;case c.KEY_CODE.UP_ARROW:if(W.loading||X())break;V.stopPropagation();V.preventDefault();W.index=0>W.index?W.matches.length-1:Math.max(0,W.index-1);d.nextTick(k);ma();break;case c.KEY_CODE.TAB:G();if(W.hidden||W.loading||0>W.index||1>W.matches.length)break;ca(W.index);break;case c.KEY_CODE.ENTER:if(W.hidden||W.loading||0>W.index||1>W.matches.length)break;if(X())break;V.stopImmediatePropagation();
...
{};W.itemName&&(ba[W.itemName]=V);return ba}}function T(V){W.loading!==V&&(W.loading=V);W.hidden=!U()}function Y(){return W.loading&&!W.matches.length||X()||!sa?!1:!0}function R(V){return!a.escapeOptions||-1!==a.escapeOptions.toLowerCase().indexOf(V)}function U(){return W.isReadonly||!Y()?!1:fa()&&(W.matches.length?!0:!1)||oa()}function X(){return W.scope.selectedItem?!0:!1}function aa(){return W.loading&&!X()}function ha(){return J(W.matches[W.index])}function fa(){return(a.searchText||"").length>=
(angular.isNumber(a.minLength)?a.minLength:1)}function ea(V,ba,ia){Object.defineProperty(W,V,{get:function(){return ia},set:function(ka){var ra=ia;ia=ka;ba(ka,ra)}})}function ca(V){d.nextTick(function(){J(W.matches[V]).then(function(ba){var ia=L.$.input.controller("ngModel");m.announce(ba+" "+W.selectedMessage,"assertive");ia.$setViewValue(ba);ia.$render()}).finally(function(){a.selectedItem=W.matches[V];T(!1)})},!1)}function da(V){V&&V.stopPropagation();la();pa()}function la(){W.index=-1;d.nextTick(k);
W.matches=[]}function pa(){T(!0);a.searchText="";var V=document.createEvent("CustomEvent");V.initCustomEvent("change",!0,!0,{value:""});L.input.dispatchEvent(V);L.input.blur();a.searchText="";L.input.focus()}function Ga(V){function ba(Ea){Ea&&(Ea=n.when(Ea),E++,T(!0),d.nextTick(function(){Ea.then(ia).finally(function(){0===--E&&T(!1)})},!0,a))}function ia(Ea){ua[ra]=Ea;(V||"")===(a.searchText||"")&&xa(Ea)}var ka=a.$parent.$eval(va),ra=V.toLowerCase(),Ca=angular.isArray(ka),Ma=!!ka.then;Ca?ia(ka):
Ma&&ba(ka)}function wa(V,ba){var ia=V?"polite":"assertive";V=[];ba&Ba.Selected&&-1!==W.index&&V.push(ha());ba&Ba.Count&&V.push(n.resolve(Aa()));n.all(V).then(function(ka){m.announce(ka.join(" "),ia)})}function Aa(){switch(W.matches.length){case 0:return"There are no matches available.";case 1:return"There is 1 match available.";default:return"There are "+W.matches.length+" matches available."}}function ma(){if(L.li[0])if("standard"===na){var V=L.li[Math.max(0,W.index)],ba=L.scrollContainer.offsetHeight,
ia=V&&V.offsetTop||0;V=ia+V.clientHeight;var ka=L.scrollContainer.scrollTop;ia<ka?za(ia):V>ka+ba&&za(V-ba)}else ia=L.li[0].offsetHeight,ba=ia*Math.max(0,W.index),ia=ba+ia,V=L.scroller.clientHeight,ka=L.scroller.scrollTop,ba<ka?za(ba):ia>ka+V&&za(ia-V)}function za(V){"standard"===na?L.scrollContainer.scrollTop=V:L.$.scrollContainer.controller("mdVirtualRepeatContainer").scrollTo(V)}function oa(){var V=(W.scope.searchText||"").length;return W.hasNotFound&&!W.matches.length&&(!W.loading||0!==E)&&V>=
(angular.isNumber(a.minLength)?a.minLength:1)&&(sa||qa)&&!X()}function Ia(){var V=a.searchText||"",ba=V.toLowerCase();!a.noCache&&ua[ba]?xa(ua[ba]):Ga(V);W.hidden=!U()}function xa(V){W.matches=V;W.hidden=!U();W.loading&&T(!1);a.selectOnMatch&&Fa();x();wa(!0,Ba.Count)}function Fa(){var V=a.searchText,ba=W.matches,ia=ba[0];1===ba.length&&J(ia).then(function(ka){var ra=V===ka;a.matchInsensitive&&!ra&&(ra=V.toLowerCase()===ka.toLowerCase());ra&&ca(0)})}var W=this,ya=a.itemsExpr.split(/ in /i),va=ya[1],
...
v+"                  </li>"+n+"            </ul>          "+(l(e.mdMode)?"   </div>              </div>            </div>":"</md-virtual-repeat-container>")+"        </md-autocomplete-wrap>"}}}MdAutocompleteItemScopeDirective.$inject=["$compile","$mdUtil"];angular.module("material.components.autocomplete").directive("mdAutocompleteParentScope",MdAutocompleteItemScopeDirective);
function MdAutocompleteItemScopeDirective(a,b){function d(c,e,f){return function(g,h){function l(q,r){m[r]=g[q];g.$watch(q,function(x){b.nextTick(function(){m[r]=x})})}function n(){var q=!1,r=!1;g.$watch(function(){r||q||(q=!0,g.$$postDigest(function(){r||m.$digest();q=r=!1}))});m.$watch(function(){r=!0})}var v=g.$mdAutocompleteCtrl,m=v.parent.$new();v=v.itemName;l("$index","$index");l("item",v);n();f(m,function(q){h.after(q)})}}return{restrict:"AE",compile:d,terminal:!0,transclude:"element"}}
...
k.rootElementKeyupCallback),p&&p.focus())})}function m(x,y,k){k.disableBackdrop||d.leave(r);return d.leave(y).then(function(){k.disableParentScroll&&(k.restoreScroll(),delete k.restoreScroll);k.cleanupGestures&&k.cleanupGestures()})}function q(x,y){function k(){x.css(c.CSS.TRANSITION_DURATION,"0ms")}function p(A){A=A.pointer.distanceY;5>A&&(A=Math.max(-80,A/2));x.css(c.CSS.TRANSFORM,"translate3d(0,"+(80+A)+"px,0)")}function t(A){if(0<A.pointer.distanceY&&(20<A.pointer.distanceY||.5<Math.abs(A.pointer.velocityY))){var w=
x.prop("offsetHeight")-A.pointer.distanceY;A=Math.min(w/A.pointer.velocityY*.75,500);x.css(c.CSS.TRANSITION_DURATION,A+"ms");e.nextTick(g.cancel,!0)}else x.css(c.CSS.TRANSITION_DURATION,""),x.css(c.CSS.TRANSFORM,"")}var H=l.register(y,"drag",{horizontal:!1});y.on("$md.dragstart",k).on("$md.drag",p).on("$md.dragend",t);return function(){H();y.off("$md.dragstart",k);y.off("$md.drag",p);y.off("$md.dragend",t)}}var r;return{themable:!0,onShow:v,onRemove:m,disableBackdrop:!1,escapeToClose:!0,clickOutsideToClose:!0,
...
function MdButtonDirective(a,b,d,c){function e(h){return angular.isDefined(h.href)||angular.isDefined(h.ngHref)||angular.isDefined(h.ngLink)||angular.isDefined(h.uiSref)}function f(h,l){if(e(l))return'<a class="md-button" ng-transclude></a>';h="undefined"===typeof l.type?"button":l.type;return'<button class="md-button" type="'+h+'" ng-transclude></button>'}function g(h,l,n){b(l);a.attach(h,l);d.expectWithoutText(l,"aria-label");e(n)&&angular.isDefined(n.ngDisabled)&&!l.hasClass("_md-nav-button")&&
h.$watch(n.ngDisabled,function(v){l.attr("tabindex",v?-1:0)});l.on("click",function(v){!0===n.disabled&&(v.preventDefault(),v.stopImmediatePropagation())});l.hasClass("md-no-focus")||(l.on("focus",function(){c.isUserInvoked()&&"keyboard"!==c.getLastInteractionType()||l.addClass("md-focused")}),l.on("blur",function(){l.removeClass("md-focused")}))}return{restrict:"EA",replace:!0,transclude:!0,template:f,link:g}}ngmaterial.components.button=angular.module("material.components.button");mdCardDirective.$inject=["$mdTheming"];angular.module("material.components.card",["material.core"]).directive("mdCard",mdCardDirective);function mdCardDirective(a){return{restrict:"E",link:function(b,d){d.addClass("_md");a(d)}}}ngmaterial.components.card=angular.module("material.components.card");MdCheckboxDirective.$inject="inputDirective $mdAria $mdConstant $mdTheming $mdUtil $mdInteraction".split(" ");angular.module("material.components.checkbox",["material.core"]).directive("mdCheckbox",MdCheckboxDirective);
function MdCheckboxDirective(a,b,d,c,e,f){function g(h,l){function n(v,m,q,r){function x(u,z,D){q[u]&&v.$watch(q[u],function(G){D[G]&&m.attr(z,D[G])})}function y(u){var z=u.which||u.keyCode;u.preventDefault();switch(z){case d.KEY_CODE.SPACE:m.addClass("md-focused");k(u);break;case d.KEY_CODE.ENTER:(u=e.getClosest(u.target,"form"))&&(u=u.querySelector('button[type="submit"]:enabled, input[type="submit"]:enabled'))&&u.click()}}function k(u){m[0].hasAttribute("disabled")||v.skipToggle||v.$apply(function(){var z=
q.ngChecked&&q.ngClick?q.checked:!w.$viewValue;w.$setViewValue(z,u&&u.type);w.$render()})}function p(){m.toggleClass("md-checked",!!w.$viewValue&&!H)}function t(u){(H=!1!==u)&&m.attr("aria-checked","mixed");m.toggleClass("md-indeterminate",H)}var H,A=r[0],w=r[1]||e.fakeNgModel(),B=r[2];A&&(r=A.isErrorGetter||function(){return w.$invalid&&(w.$touched||B&&B.$submitted)},A.input=m,v.$watch(r,A.setInvalid));c(m);m.children().on("focus",function(){m.focus()});e.parseAttributeBoolean(q.mdIndeterminate)&&
(t(),v.$watch(q.mdIndeterminate,t));q.ngChecked&&v.$watch(v.$eval.bind(v,q.ngChecked),function(u){w.$setViewValue(u);w.$render()});x("ngDisabled","tabindex",{true:"-1",false:q.tabindex});b.expectWithText(m,"aria-label");a.link.pre(v,{on:angular.noop,0:{}},q,[w]);m.on("click",k).on("keypress",y).on("focus",function(){"keyboard"===f.getLastInteractionType()&&m.addClass("md-focused")}).on("blur",function(){m.removeClass("md-focused")});w.$render=p}l.$set("tabindex",l.tabindex||"0");l.$set("type","checkbox");
l.$set("role",l.type);return{pre:function(v,m){m.on("click",function(q){this.hasAttribute("disabled")&&q.stopImmediatePropagation()})},post:n}}a=a[0];return{restrict:"E",transclude:!0,require:["^?mdInputContainer","?ngModel","?^form"],priority:d.BEFORE_NG_ARIA,template:'<div class="md-container" md-ink-ripple md-ink-ripple-checkbox><div class="md-icon"></div></div><div ng-transclude class="md-label"></div>',compile:g}}ngmaterial.components.checkbox=angular.module("material.components.checkbox");angular.module("material.components.chips",["material.core","material.components.autocomplete"]);MdChipCtrl.$inject=["$scope","$element","$mdConstant","$timeout","$mdUtil"];angular.module("material.components.chips").controller("MdChipCtrl",MdChipCtrl);function MdChipCtrl(a,b,d,c,e){this.$scope=a;this.$element=b;this.$mdConstant=d;this.$timeout=c;this.$mdUtil=e;this.isEditing=!1;this.parentController=void 0;this.enableChipEdit=!1}
...
MdChipCtrl.prototype.getContentElement=function(){var a=angular.element(this.getChipContent().children()[0]);a&&0!==a.length||(a=angular.element(this.getChipContent().contents()[0]));return a};MdChipCtrl.prototype.getChipIndex=function(){return parseInt(this.$element.attr("index"))};
...
angular.module("material.components.chips").directive("mdChip",MdChip);function MdChip(a,b,d,c){function e(f,g,h,l){var n=l.shift();f=l.shift();h=angular.element(g[0].querySelector(".md-chip-content"));a(g);n&&(f.init(n),h.on("blur",function(){n.resetSelectedChip();n.$scope.$applyAsync()}));c(function(){n&&n.shouldFocusLastChip&&n.focusLastChipThenInput()})}return{restrict:"E",require:["^?mdChips","mdChip"],link:e,controller:"MdChipCtrl"}}MdChipRemove.$inject=["$timeout"];
...
MdChipsCtrl.prototype.removeChipAndFocusInput=function(a,b){this.removeChip(a,b);if(this.autocompleteCtrl)this.autocompleteCtrl.hidden=!0,this.$mdUtil.nextTick(this.onFocus.bind(this));else this.onFocus()};MdChipsCtrl.prototype.selectAndFocusChipSafe=function(a){if(!this.items.length||-1===a)return this.focusInput();if(a>=this.items.length)if(this.readonly)a=0;else return this.onFocus();a=Math.max(a,0);a=Math.min(a,this.items.length-1);this.selectChip(a);this.focusChip(a)};
...
MdChipsCtrl.prototype.hasFocus=function(){return this.inputHasFocus||0<=this.selectedChip};MdChipsCtrl.prototype.contentIdFor=function(a){return this.contentIds[a]};MdChips.$inject="$mdTheming $mdUtil $compile $log $timeout $$mdSvgRegistry".split(" ");angular.module("material.components.chips").directive("mdChips",MdChips);
function MdChips(a,b,d,c,e,f){function g(l,n){function v(p){if(n.ngModel)return(p=m[0].querySelector(p))&&p.outerHTML}var m=n.$mdUserTemplate;n.$mdUserTemplate=null;var q=v("md-chips>md-chip-template");l=b.prefixer().buildList("md-chip-remove").map(function(p){return"md-chips>*["+p+"]"}).join(",");var r=v(l)||h.remove,x=q||h.default,y=v("md-chips>md-autocomplete")||v("md-chips>input")||h.input,k=m.find("md-chip");m[0].querySelector("md-chip-template>*[md-chip-remove]")&&c.warn("invalid placement of md-chip-remove within md-chip-template.");
return function(p,t,H,A){b.initOptionalProperties(p,n);a(t);var w=A[0];q&&(w.enableChipEdit=!1);w.chipContentsTemplate=x;w.chipRemoveTemplate=r;w.chipInputTemplate=y;w.mdCloseIcon=f.mdClose;t.attr({tabindex:-1}).on("focus",function(){w.onFocus()}).on("click",function(){if(!w.readonly&&-1===w.selectedChip)w.onFocus()});n.ngModel&&(w.configureNgModel(t.controller("ngModel")),H.mdTransformChip&&w.useTransformChipExpression(),H.mdOnAppend&&w.useOnAppendExpression(),H.mdOnAdd&&w.useOnAddExpression(),H.mdOnRemove&&
w.useOnRemoveExpression(),H.mdOnSelect&&w.useOnSelectExpression(),y!==h.input&&p.$watch("$mdChipsCtrl.readonly",function(u){u||b.nextTick(function(){if(0===y.indexOf("<md-autocomplete")){var z=t.find("md-autocomplete");w.configureAutocomplete(z.controller("mdAutocomplete"))}w.configureUserInput(t.find("input"))})}),b.nextTick(function(){var u=t.find("input");u&&(w.configureInput(u),u.toggleClass("md-input",!0))}));if(0<k.length){var B=d(k.clone())(p.$parent);e(function(){t.find("md-chips-wrap").prepend(B)})}}}
...
inputAriaDescribedBy:"@?inputAriaDescribedby",inputAriaLabelledBy:"@?inputAriaLabelledby",inputAriaLabel:"@?",containerHint:"@?",containerEmptyHint:"@?",deleteHint:"@?"}}}ngmaterial.components.chips=angular.module("material.components.chips");(function(){function a(e,f,g){function h(r,x){try{x&&r.css(v(x))}catch(y){g.error(y.message)}}function l(r){r=q(r);return n(r)}function n(r,x){x=x||!1;var y=e.PALETTES[r.palette][r.hue];y=x?y.contrast:y.value;return f.supplant("rgba({0}, {1}, {2}, {3})",[y[0],y[1],y[2],y[3]||r.opacity])}function v(r){var x={},y=r.hasOwnProperty("color");angular.forEach(r,function(k,p){k=q(k);var t=-1<p.indexOf("background");x[p]=n(k);t&&!y&&(x.color=n(k,!0))});return x}function m(r){return angular.isDefined(e.THEMES[r.split("-")[0]])}
function q(r){r=r.split("-");var x=angular.isDefined(e.THEMES[r[0]]);x=x?r.splice(0,1)[0]:e.defaultTheme();var y=r,k=x,p=1<y.length&&-1!==c.indexOf(y[1]);var t=y[0].replace(/([a-z])([A-Z])/g,"$1-$2").toLowerCase();p&&(t=y[0]+"-"+y.splice(1,1));if(-1===c.indexOf(t)){y=e.THEMES[k].colors[t];if(!y)throw Error(f.supplant("mdColors: couldn't find '{palette}' in the palettes.",{palette:t}));t=y.name}y=r;k=e.THEMES[x].colors;if("hue"===y[1]){p=parseInt(y.splice(2,1)[0],10);if(1>p||3<p)throw Error(f.supplant("mdColors: 'hue-{hueNumber}' is not a valid hue, can be only 'hue-1', 'hue-2' and 'hue-3'",
{hueNumber:p}));y[1]="hue-"+p;if(!(y[0]in k))throw Error(f.supplant("mdColors: 'hue-x' can only be used with [{availableThemes}], but was used with '{usedTheme}'",{availableThemes:Object.keys(k).join(", "),usedTheme:y[0]}));y=k[y[0]].hues[y[1]]}else y=y[1]||k[y[0]in k?y[0]:"primary"].hues["default"];return{theme:x,palette:t,hue:y,opacity:r[2]||1}}c=c||Object.keys(e.PALETTES);return{applyThemeColors:h,getThemeColor:l,hasTheme:m}}function b(e,f,g,h){return{restrict:"A",require:["^?mdTheme"],compile:function(l,
n){function v(){var q=n.mdColors,r=-1<q.indexOf("::"),x=r?!0:d.test(n.mdColors);n.mdColors=q.replace("::","");q=angular.isDefined(n.mdColorsWatch);return r||x?!1:q?f.parseAttributeBoolean(n.mdColorsWatch):!0}var m=v();return function(q,r,x,y){var k=y[0],p={},t=function(w){"string"!==typeof w&&(w="");x.mdColors||(x.mdColors="{}");var B=h(x.mdColors)(q);k&&Object.keys(B).forEach(function(u){var z=B[u];e.hasTheme(z)||(B[u]=(w||k.$mdTheme)+"-"+z)});H(B);return B},H=function(w){if(!angular.equals(w,p)){var B=
Object.keys(p);p.background&&!B.color&&B.push("color");B.forEach(function(u){r.css(u,"")})}p=w},A=angular.noop;k&&(A=k.registerChanges(function(w){e.applyThemeColors(r,t(w))}));q.$on("$destroy",function(){A()});try{m?q.$watch(t,angular.bind(this,e.applyThemeColors,r),!0):e.applyThemeColors(r,t())}catch(w){g.error(w.message)}}}}}b.$inject=["$mdColors","$mdUtil","$log","$parse"];a.$inject=["$mdTheming","$mdUtil","$log"];var d=/^{((\s|,)*?["'a-zA-Z-]+?\s*?:\s*?('|")[a-zA-Z0-9-.]*('|"))+\s*}$/,c=null;
...
bindToController:!0,link:function(e,f,g,h){e=h[0];h=h[1];h.configureNgModel(e)}}}function b(e,f,g,h,l,n,v,m,q){n(e);this.$element=e;this.$scope=f;this.dateUtil=g;this.$mdUtil=h;this.keyCode=l.KEY_CODE;this.$$rAF=v;this.$mdDateLocale=q;this.today=this.dateUtil.createDateAtMidnight();this.ngModelCtrl=null;this.SELECTED_DATE_CLASS="md-calendar-selected-date";this.TODAY_CLASS="md-calendar-date-today";this.FOCUSED_DATE_CLASS="md-focus";this.id=d++;this.lastRenderableDate=this.firstRenderableDate=this.selectedDate=
this.displayDate=null;this.isInitialized=!1;this.scrollbarWidth=this.width=0;m.tabindex||e.attr("tabindex","-1");var r=angular.bind(this,this.handleKeyEvent);var x=e.parent().hasClass("md-datepicker-calendar")?angular.element(document.body):e;x.on("keydown",r);f.$on("$destroy",function(){x.off("keydown",r)});1===angular.version.major&&4>=angular.version.minor&&this.$onInit()}b.$inject="$element $scope $$mdDateUtil $mdUtil $mdConstant $mdTheming $$rAF $attrs $mdDateLocale".split(" ");angular.module("material.components.datepicker").directive("mdCalendar",
...
e.stopPropagation(),f.$scope.$broadcast("md-calendar-parent-action",g))}})};b.prototype.hideVerticalScrollbar=function(e){function f(){var n=g.width||340,v=g.scrollbarWidth,m=e.calendarScroller;l.style.width=n+"px";m.style.width=n+v+"px";m.style.paddingRight=v+"px"}var g=this,h=e.$element[0],l=h.querySelector(".md-calendar-scroll-mask");0<g.width?f():g.$$rAF(function(){var n=e.calendarScroller;g.scrollbarWidth=n.offsetWidth-n.clientWidth;g.width=h.querySelector("table").offsetWidth;f()})};b.prototype.getDateId=
...
"mdCalendarMonth"],controller:b,controllerAs:"monthCtrl",bindToController:!0,link:function(d,c,e,f){d=f[0];f=f[1];f.initialize(d)}}}function b(d,c,e,f,g,h){this.$element=d;this.$scope=c;this.$animate=e;this.$q=f;this.dateUtil=g;this.dateLocale=h;this.calendarScroller=d[0].querySelector(".md-virtual-repeat-scroller");this.isMonthTransitionInProgress=this.isInitialized=!1;var l=this;this.cellClickHandler=function(){var n=g.getTimestampFromNode(this);l.$scope.$apply(function(){l.calendarCtrl.setNgModelValue(n)})};
...
(function(){function a(d,c){var e=d('<md-icon md-svg-src="'+c.mdTabsArrow+'"></md-icon>')({})[0];return{require:["^^mdCalendar","^^mdCalendarMonth","mdCalendarMonthBody"],scope:{offset:"=mdMonthOffset"},controller:b,controllerAs:"mdMonthBodyCtrl",bindToController:!0,link:function(f,g,h,l){g=l[0];h=l[1];var n=l[2];n.calendarCtrl=g;n.monthCtrl=h;n.arrowIcon=e.cloneNode(!0);f.$watch(function(){return n.offset},function(v){angular.isNumber(v)&&n.generateContent()})}}}function b(d,c,e){this.$element=d;
...
e=this.dateUtil.getFirstDateOfMonth(c),f=this.getLocaleDay_(e),g=this.dateUtil.getNumberOfDaysInMonth(c);d=document.createDocumentFragment();var h=1,l=this.buildDateRow(h);d.appendChild(l);var n=this.offset===this.monthCtrl.items.length-1,v=0,m=document.createElement("td"),q=document.createElement("span"),r=this.calendarCtrl;q.textContent=this.dateLocale.monthHeaderFormatter(c);m.appendChild(q);m.classList.add("md-calendar-month-label");r.maxDate&&e>r.maxDate?m.classList.add("md-calendar-month-label-disabled"):
r.mode||(m.addEventListener("click",this.monthCtrl.headerClickHandler),m.setAttribute("data-timestamp",e.getTime()),m.setAttribute("aria-label",this.dateLocale.monthFormatter(c)),m.classList.add("md-calendar-label-clickable"),m.appendChild(this.arrowIcon.cloneNode(!0)));if(2>=f){if(m.setAttribute("colspan","7"),c=this.buildDateRow(),c.appendChild(m),d.insertBefore(c,l),n)return d}else v=3,m.setAttribute("colspan","3"),l.appendChild(m);for(;v<f;v++)l.appendChild(this.buildDateCell());for(v=1;v<=g;v++){if(7===
f){if(n)return d;f=0;h++;l=this.buildDateRow(h);d.appendChild(l)}e.setDate(v);m=this.buildDateCell(e);l.appendChild(m);f++}for(;7>l.childNodes.length;)l.appendChild(this.buildDateCell());for(;6>d.childNodes.length;){g=this.buildDateRow();for(h=0;7>h;h++)g.appendChild(this.buildDateCell());d.appendChild(g)}return d};b.prototype.getLocaleDay_=function(d){return(d.getDay()+(7-this.dateLocale.firstDayOfWeek))%7}})();
...
"mdCalendarYear"],controller:b,controllerAs:"yearCtrl",bindToController:!0,link:function(d,c,e,f){d=f[0];f=f[1];f.initialize(d)}}}function b(d,c,e,f,g,h){this.$element=d;this.$scope=c;this.$animate=e;this.$q=f;this.dateUtil=g;this.calendarScroller=d[0].querySelector(".md-virtual-repeat-scroller");this.isMonthTransitionInProgress=this.isInitialized=!1;this.$mdUtil=h;var l=this;this.cellClickHandler=function(){l.onTimestampSelected(g.getTimestampFromNode(this))}}b.$inject="$element $scope $animate $q $$mdDateUtil $mdUtil".split(" ");
angular.module("material.components.datepicker").directive("mdCalendarYear",a);b.prototype.initialize=function(d){this.items={length:this.dateUtil.getYearDistance(d.firstRenderableDate,d.lastRenderableDate)+1};this.calendarCtrl=d;this.attachScopeListeners();d.updateVirtualRepeat();d.ngModelCtrl&&d.ngModelCtrl.$render()};b.prototype.getFocusedYearIndex=function(){var d=this.calendarCtrl;return this.dateUtil.getYearDistance(d.firstRenderableDate,d.displayDate||d.selectedDate||d.today)};b.prototype.changeDate=
function(d){if(!this.isInitialized)return this.calendarCtrl.hideVerticalScrollbar(this),this.isInitialized=!0,this.$q.when();if(this.dateUtil.isValidDate(d)&&!this.isMonthTransitionInProgress){var c=this,e=this.animateDateChange(d);c.isMonthTransitionInProgress=!0;c.calendarCtrl.displayDate=d;return e.then(function(){c.isMonthTransitionInProgress=!1})}};b.prototype.animateDateChange=function(d){this.dateUtil.isValidDate(d)&&(d=this.dateUtil.getYearDistance(this.calendarCtrl.firstRenderableDate,d),
this.calendarScroller.scrollTop=88*d);return this.$q.when()};b.prototype.handleKeyEvent=function(d,c){var e=this,f=e.calendarCtrl,g=f.displayDate;if("select"===c)e.changeDate(g).then(function(){e.onTimestampSelected(g)});else{var h=null;d=e.dateUtil;switch(c){case "move-right":h=d.incrementMonths(g,1);break;case "move-left":h=d.incrementMonths(g,-1);break;case "move-row-down":h=d.incrementMonths(g,6);break;case "move-row-up":h=d.incrementMonths(g,-6)}if(h){c=f.minDate?d.getFirstDateOfMonth(f.minDate):
null;var l=f.maxDate?d.getFirstDateOfMonth(f.maxDate):null;h=d.getFirstDateOfMonth(e.dateUtil.clampDate(h,c,l));e.changeDate(h).then(function(){f.focus(h)})}}};b.prototype.attachScopeListeners=function(){var d=this;d.$scope.$on("md-calendar-parent-changed",function(c,e){d.calendarCtrl.changeSelectedDate(e?d.dateUtil.getFirstDateOfMonth(e):e);d.changeDate(e)});d.$scope.$on("md-calendar-parent-action",angular.bind(d,d.handleKeyEvent))};b.prototype.onTimestampSelected=function(d){var c=this.calendarCtrl;
c.mode?this.$mdUtil.nextTick(function(){c.setNgModelValue(d)}):c.setCurrentView("month",d)}})();
...
z){u=d(u);return e(u,z)}function h(u,z){u=c(u);return e(z,u)}function l(u,z){return k((u.getTime()+z.getTime())/2)}function n(u){var z=a(u);return Math.floor((z.getDay()+u.getDate()-1)/7)}function v(u,z){return new Date(u.getFullYear(),u.getMonth(),u.getDate()+z)}function m(u,z){z=new Date(u.getFullYear(),u.getMonth()+z,1);var D=b(z);D<u.getDate()?z.setDate(D):z.setDate(u.getDate());return z}function q(u,z){return 12*(z.getFullYear()-u.getFullYear())+(z.getMonth()-u.getMonth())}function r(u){return new Date(u.getFullYear(),
u.getMonth(),b(u))}function x(u){return u&&u.getTime&&!isNaN(u.getTime())}function y(u){x(u)&&u.setHours(0,0,0,0)}function k(u){u=angular.isUndefined(u)?new Date:new Date(u);y(u);return u}function p(u,z,D){u=k(u);z=x(z)?k(z):null;D=x(D)?k(D):null;return(!z||z<=u)&&(!D||D>=u)}function t(u,z){return m(u,12*z)}function H(u,z){return z.getFullYear()-u.getFullYear()}function A(u,z,D){var G=u;z&&u<z&&(G=new Date(z.getTime()));D&&u>D&&(G=new Date(D.getTime()));return G}function w(u){if(u&&u.hasAttribute("data-timestamp"))return Number(u.getAttribute("data-timestamp"))}
function B(u,z,D){var G=u.getMonth();u=u.getFullYear();return(!z||z.getFullYear()<u||z.getMonth()<=G)&&(!D||D.getFullYear()>u||D.getMonth()>=G)}return{getFirstDateOfMonth:a,getNumberOfDaysInMonth:b,getDateInNextMonth:d,getDateInPreviousMonth:c,isInNextMonth:g,isInPreviousMonth:h,getDateMidpoint:l,isSameMonthAndYear:e,getWeekOfMonth:n,incrementDays:v,incrementMonths:m,getLastDateOfMonth:r,isSameDay:f,getMonthDistance:q,isValidDate:x,setDateTimeToMidnight:y,createDateAtMidnight:k,isDateWithinRange:p,
incrementYears:t,getYearDistance:H,clampDate:A,getTimestampFromNode:w,isMonthWithinRange:B}});
(function(){function a(c,e,f,g){return{template:function(h,l){var n=l.mdHideIcons;l=l.ariaLabel||l.mdPlaceholder;var v="all"===n||"calendar"===n?"":'<md-button class="md-datepicker-button md-icon-button" type="button" tabindex="-1" aria-hidden="true" ng-click="ctrl.openCalendarPane($event)"><md-icon class="md-datepicker-calendar-icon" aria-label="md-calendar" md-svg-src="'+c.mdCalendar+'"></md-icon></md-button>',m="";"all"!==n&&"triangle"!==n&&(m='<md-button type="button" md-no-ink class="md-datepicker-triangle-button md-icon-button" ng-click="ctrl.openCalendarPane($event)" aria-label="{{::ctrl.locale.msgOpenCalendar}}"><div class="md-datepicker-expand-triangle"></div></md-button>',
h.addClass("_md-datepicker-has-triangle-icon"));return v+'<div class="md-datepicker-input-container" ng-class="{\'md-datepicker-focused\': ctrl.isFocused}"><input '+(l?'aria-label="'+l+'" ':"")+'class="md-datepicker-input" aria-haspopup="dialog" ng-focus="ctrl.setFocused(true)" ng-blur="ctrl.setFocused(false)"> '+m+'</div><div class="md-datepicker-calendar-pane md-whiteframe-z1" id="{{::ctrl.calendarPaneId}}"><div class="md-datepicker-input-mask"><div class="md-datepicker-input-mask-opaque"></div></div><div class="md-datepicker-calendar"><md-calendar role="dialog" aria-label="{{::ctrl.locale.msgCalendar}}" md-current-view="{{::ctrl.currentView}}" md-mode="{{::ctrl.mode}}" md-min-date="ctrl.minDate" md-max-date="ctrl.maxDate" md-date-filter="ctrl.dateFilter" ng-model="ctrl.date" ng-if="ctrl.isCalendarOpen"></md-calendar></div></div>'},
require:["ngModel","mdDatepicker","?^mdInputContainer","?^form"],scope:{minDate:"=mdMinDate",maxDate:"=mdMaxDate",placeholder:"@mdPlaceholder",currentView:"@mdCurrentView",mode:"@mdMode",dateFilter:"=mdDateFilter",isOpen:"=?mdIsOpen",debounceInterval:"=mdDebounceInterval",dateLocale:"=mdDateLocale"},controller:b,controllerAs:"ctrl",bindToController:!0,link:function(h,l,n,v){var m=v[0],q=v[1],r=v[2],x=v[3];v=e.parseAttributeBoolean(n.mdNoAsterisk);q.configureNgModel(m,r,g);if(r){var y=l[0].querySelector(".md-errors-spacer");
y&&l.after(angular.element("<div>").append(y));r.setHasPlaceholder(n.mdPlaceholder);r.input=l;r.element.addClass("_md-datepicker-floating-label").toggleClass("_md-datepicker-has-calendar-icon","calendar"!==n.mdHideIcons&&"all"!==n.mdHideIcons);r.label?v||n.$observe("required",function(p){r.label.toggleClass("md-required",!!p)}):f.expect(l,"aria-label",n.mdPlaceholder);h.$watch(r.isErrorGetter||function(){return m.$invalid&&(m.$touched||x&&x.$submitted)},r.setInvalid)}else if(x)var k=h.$watch(function(){return x.$submitted},
function(p){p&&(q.updateErrorState(),k())})}}}function b(c,e,f,g,h,l,n,v,m,q,r,x){this.$window=g;this.dateUtil=m;this.$mdConstant=h;this.$mdUtil=n;this.$$rAF=q;this.$mdDateLocale=v;this.$timeout=x;this.documentElement=angular.element(document.documentElement);this.ngModelCtrl=null;this.inputElement=e[0].querySelector("input");this.ngInputElement=angular.element(this.inputElement);this.inputContainer=e[0].querySelector(".md-datepicker-input-container");this.calendarPane=e[0].querySelector(".md-datepicker-calendar-pane");
this.calendarButton=e[0].querySelector(".md-datepicker-button");this.inputMask=angular.element(e[0].querySelector(".md-datepicker-input-mask-opaque"));this.$element=e;this.$attrs=f;this.$scope=c;this.date=null;this.isFocused=!1;this.isDisabled=void 0;this.setDisabled(e[0].disabled||angular.isString(f.disabled));this.isCalendarOpen=!1;this.openOnFocus=f.hasOwnProperty("mdOpenOnFocus");this.calendarPaneOpenedFrom=this.mdInputContainer=null;this.calendarPaneId="md-date-pane-"+n.nextUid();this.bodyClickHandler=
angular.bind(this,this.handleBodyClick);this.windowEventName=d.test(navigator.userAgent||navigator.vendor||window.opera)?"orientationchange":"resize";this.windowEventHandler=n.debounce(angular.bind(this,this.closeCalendarPane),100);this.windowBlurHandler=angular.bind(this,this.handleWindowBlur);this.ngDateFilter=r("date");this.leftMargin=20;this.topMargin=null;f.tabindex?(this.ngInputElement.attr("tabindex",f.tabindex),f.$set("tabindex",null)):f.$set("tabindex","-1");f.$set("aria-owns",this.calendarPaneId);
l(e);l(angular.element(this.calendarPane));var y=this;c.$on("$destroy",function(){y.detachCalendarPane()});f.mdIsOpen&&c.$watch("ctrl.isOpen",function(k){k?y.openCalendarPane({target:y.inputElement}):y.closeCalendarPane()});1===angular.version.major&&4>=angular.version.minor&&this.$onInit()}b.$inject="$scope $element $attrs $window $mdConstant $mdTheming $mdUtil $mdDateLocale $$mdDateUtil $$rAF $filter $timeout".split(" ");a.$inject=["$$mdSvgRegistry","$mdUtil","$mdAria","inputDirective"];angular.module("material.components.datepicker").directive("mdDatepicker",
...
this.dateFilter(c))}else this.ngModelCtrl.$setValidity("valid",null==c);e=this.inputElement.value;var f=this.locale.parseDate(e);!this.isInputValid(e,f)&&this.ngModelCtrl.$valid&&this.ngModelCtrl.$setValidity("valid",null==c);angular.element(this.inputContainer).toggleClass("md-datepicker-invalid",!this.ngModelCtrl.$valid)};b.prototype.isInputValid=function(c,e){return""===c||this.dateUtil.isValidDate(e)&&this.locale.isDateComplete(c)&&this.isDateEnabled(e)};b.prototype.clearErrorState=function(){this.inputContainer.classList.remove("md-datepicker-invalid");
...
(I.restoreScroll=l.disableScrollAround(M,I.parent));I.hasBackdrop&&(I.backdrop=l.createBackdrop(K,"md-dialog-backdrop md-opaque"),v.enter(I.backdrop,I.parent));I.hideBackdrop=function(J){I.backdrop&&(J?I.backdrop.remove():v.leave(I.backdrop));I.disableParentScroll&&(I.restoreScroll&&I.restoreScroll(),delete I.restoreScroll);I.hideBackdrop=null}}function N(K,M){var I="alert"===M.$type?"alertdialog":"dialog",J=K.find("md-dialog-content"),Q=K.attr("id"),T="dialogContent_"+(Q||l.nextUid());K.attr({role:I,
tabIndex:"-1"});0===J.length&&(J=K,Q&&(T=Q));J.attr("id",T);K.attr("aria-describedby",T);M.ariaLabel?h.expect(K,"aria-label",M.ariaLabel):h.expectAsync(K,"aria-label",function(){if(M.title)return M.title;var Y=J.text().split(/\s+/);3<Y.length&&(Y=Y.slice(0,3).concat("..."));return Y.join(" ")});e=document.createElement("div");e.classList.add("md-dialog-focus-trap");e.tabIndex=0;f=e.cloneNode(!1);I=function(){K.focus()};e.addEventListener("focus",I);f.addEventListener("focus",I);K[0].parentNode.insertBefore(e,
K[0]);K.after(f)}function C(K,M){function I(Q){a:{for(var T=[];Q.parentNode;){if(Q===document.body){Q=T;break a}for(var Y=Q.parentNode.children,R=0;R<Y.length;R++){var U;(U=Q===Y[R])||(U=["SCRIPT","STYLE"],U=-1!==U.indexOf(Y[R].nodeName)?!0:void 0);U||Y[R].hasAttribute("aria-live")||T.push(Y[R])}Q=Q.parentNode}Q=T}for(T=0;T<Q.length;T++)Q[T].setAttribute("aria-hidden",J)}var J=!0;I(K[0]);M.unlockScreenReader=function(){J=!1;I(K[0]);M.unlockScreenReader=null}}function F(K,M){var I="fixed"==q.getComputedStyle(m[0].body).position,
J=M.backdrop?q.getComputedStyle(M.backdrop[0]):null;J=J?Math.min(m[0].body.clientHeight,Math.ceil(Math.abs(parseInt(J.height,10)))):0;var Q={top:K.css("top"),height:K.css("height")};M=Math.abs(M.parent[0].getBoundingClientRect().top);K.css({top:(I?M:0)+"px",height:J?J+"px":"100%"});return function(){K.css(Q)}}function O(K,M){M.parent.append(K);M.reverseContainerStretch=F(K,M);var I=K.find("md-dialog"),J=l.dom.animator,Q=J.calculateZoomToOrigin,T={transitionInClass:"md-transition-in",transitionOutClass:"md-transition-out"},
...
options:c}).addPreset("alert",{methods:"title htmlContent textContent content ariaLabel ok theme css".split(" "),options:b}).addPreset("confirm",{methods:"title htmlContent textContent content ariaLabel ok cancel theme css".split(" "),options:b}).addPreset("prompt",{methods:"title htmlContent textContent initialValue content placeholder ariaLabel ok cancel theme css required".split(" "),options:b})}ngmaterial.components.dialog=angular.module("material.components.dialog");MdDividerDirective.$inject=["$mdTheming"];angular.module("material.components.divider",["material.core"]).directive("mdDivider",MdDividerDirective);function MdDividerDirective(a){return{restrict:"E",link:a}}ngmaterial.components.divider=angular.module("material.components.divider");(function(){function a(b){return{restrict:"E",require:["^?mdFabSpeedDial","^?mdFabToolbar"],compile:function(d){d=d.children();var c=b.prefixer().hasAttribute(d,"ng-repeat");c?d.addClass("md-fab-action-item"):d.wrap('<div class="md-fab-action-item">')}}}a.$inject=["$mdUtil"];angular.module("material.components.fabActions",["material.core"]).directive("mdFabActions",a)})();ngmaterial.components.fabActions=angular.module("material.components.fabActions");(function(){function a(b,d,c,e,f,g){function h(){var w=["click","focusin","focusout"];angular.forEach(w,function(B){d.on(B,l)});b.$on("$destroy",function(){angular.forEach(w,function(B){d.off(B,l)});q()})}function l(w){"click"==w.type&&p(w);"focusout"!=w.type||A||(A=g(function(){t.close()},100,!1));"focusin"==w.type&&A&&(g.cancel(A),A=null)}function n(){b.$watch("vm.direction",function(u,z){c.removeClass(d,"md-"+z);c.addClass(d,"md-"+u);t.currentActionIndex=-1});var w,B;b.$watch("vm.isOpen",function(u){t.currentActionIndex=
-1;w&&B||(w=d.find("md-fab-trigger"),B=d.find("md-fab-actions"));u?m():q();var z=u?"md-is-open":"",D=u?"":"md-is-open";w.attr("aria-haspopup",!0);w.attr("aria-expanded",u);B.attr("aria-hidden",!u);c.setClass(d,z,D)})}function v(){0<d[0].scrollHeight?c.addClass(d,"_md-animations-ready").then(function(){d.removeClass("md-animations-waiting")}):10>H&&(g(v,100),H+=1)}function m(){d.on("keydown",x);e.nextTick(function(){angular.element(document).on("click touchend",r)})}function q(){d.off("keydown",x);
angular.element(document).off("click touchend",r)}function r(w){if(w.target){var B=e.getClosest(w.target,"md-fab-trigger");w=e.getClosest(w.target,"md-fab-actions");B||w||t.close()}}function x(w){switch(w.which){case f.KEY_CODE.ESCAPE:return t.close(),w.preventDefault(),!1;case f.KEY_CODE.LEFT_ARROW:return"left"===t.direction?y(w,1):y(w,-1),!1;case f.KEY_CODE.UP_ARROW:return"down"===t.direction?y(w,-1):y(w,1),!1;case f.KEY_CODE.RIGHT_ARROW:return"left"===t.direction?y(w,-1):y(w,1),!1;case f.KEY_CODE.DOWN_ARROW:return"up"===
t.direction?y(w,-1):y(w,1),!1}}function y(w,B){var u=k();t.currentActionIndex+=B;t.currentActionIndex=Math.min(u.length-1,t.currentActionIndex);t.currentActionIndex=Math.max(0,t.currentActionIndex);B=angular.element(u[t.currentActionIndex]).children()[0];angular.element(B).attr("tabindex",0);B.focus();w.preventDefault();w.stopImmediatePropagation()}function k(){var w=d.find("md-fab-actions")[0].querySelectorAll(".md-fab-action-item");angular.forEach(w,function(B){angular.element(angular.element(B).children()[0]).attr("tabindex",
-1)});return w}function p(w){e.getClosest(w.target,"md-fab-trigger")&&t.toggle();e.getClosest(w.target,"md-fab-actions")&&t.close()}var t=this,H=0;t.open=function(){b.$evalAsync("vm.isOpen = true")};t.close=function(){b.$evalAsync("vm.isOpen = false");d.find("md-fab-trigger")[0].focus()};t.toggle=function(){b.$evalAsync("vm.isOpen = !vm.isOpen")};t.$onInit=function(){t.direction=t.direction||"down";t.isOpen=t.isOpen||!1;t.currentActionIndex=-1;d.addClass("md-animations-waiting");h();n();v()};1===
angular.version.major&&4>=angular.version.minor&&this.$onInit();var A}a.$inject="$scope $element $animate $mdUtil $mdConstant $timeout".split(" ");angular.module("material.components.fabShared",["material.core"]).controller("MdFabController",a)})();
(function(){function a(){function e(f,g){g.prepend('<div class="_md-css-variables"></div>')}return{restrict:"E",scope:{direction:"@?mdDirection",isOpen:"=?mdOpen"},bindToController:!0,controller:"MdFabController",controllerAs:"vm",link:e}}function b(e){function f(g){if(!g.hasClass("md-animations-waiting")||g.hasClass("_md-animations-ready")){var h=g[0],l=g.controller("mdFabSpeedDial"),n=h.querySelectorAll(".md-fab-action-item"),v=h.querySelector("md-fab-trigger");g=h.querySelector("._md-css-variables");
var m=parseInt(window.getComputedStyle(g).zIndex);angular.forEach(n,function(q,r){q=q.style;q.transform=q.webkitTransform="";q.transitionDelay="";q.opacity=1;q.zIndex=n.length-r+m});v.style.zIndex=m+n.length+1;l.isOpen||angular.forEach(n,function(q,r){var x=q.style,y=(v.clientHeight-q.clientHeight)/2,k=(v.clientWidth-q.clientWidth)/2;switch(l.direction){case "up":var p=q.scrollHeight*(r+1)+y;var t="Y";break;case "down":p=-(q.scrollHeight*(r+1)+y);t="Y";break;case "left":p=q.scrollWidth*(r+1)+k;t=
"X";break;case "right":p=-(q.scrollWidth*(r+1)+k),t="X"}q="translate"+t+"("+p+"px)";x.transform=x.webkitTransform=q})}}return{addClass:function(g,h,l){g.hasClass("md-fling")?(f(g),e(l,c,!1)):l()},removeClass:function(g,h,l){f(g);e(l,c,!1)}}}function d(e){function f(g){var h=g[0],l=g.controller("mdFabSpeedDial"),n=h.querySelectorAll(".md-fab-action-item");g=h.querySelector("._md-css-variables");var v=parseInt(window.getComputedStyle(g).zIndex);angular.forEach(n,function(m,q){m=m.style;var r=65*q;m.opacity=
l.isOpen?1:0;m.transform=m.webkitTransform=l.isOpen?"scale(1)":"scale(0)";m.transitionDelay=(l.isOpen?r:n.length-r)+"ms";m.zIndex=n.length-q+v})}return{addClass:function(g,h,l){f(g);e(l,c,!1)},removeClass:function(g,h,l){f(g);e(l,c,!1)}}}b.$inject=["$timeout"];d.$inject=["$timeout"];var c=300;angular.module("material.components.fabSpeedDial",["material.core","material.components.fabShared","material.components.fabActions"]).directive("mdFabSpeedDial",a).animation(".md-fling",b).animation(".md-scale",
...
var g=f.querySelector(".md-fab-toolbar-background"),h=f.querySelector("md-fab-trigger button"),l=f.querySelector("md-toolbar"),n=f.querySelector("md-fab-trigger button md-icon"),v=c.find("md-fab-actions").children();if(h&&g){var m=window.getComputedStyle(h).getPropertyValue("background-color");f=f.offsetWidth;var q=f/h.offsetWidth*2;g.style.backgroundColor=m;g.style.borderRadius=f+"px";e.isOpen?(l.style.pointerEvents="inherit",g.style.width=h.offsetWidth+"px",g.style.height=h.offsetHeight+"px",g.style.transform=
"scale("+q+")",g.style.transitionDelay="0ms",n&&(n.style.transitionDelay=".3s"),angular.forEach(v,function(r,x){r.style.transitionDelay=25*(v.length-x)+"ms"})):(l.style.pointerEvents="none",g.style.transform="scale(1)",g.style.top="0",c.hasClass("md-right")&&(g.style.left="0",g.style.right=null),c.hasClass("md-left")&&(g.style.right="0",g.style.left=null),g.style.transitionDelay="200ms",n&&(n.style.transitionDelay="0ms"),angular.forEach(v,function(r,x){r.style.transitionDelay=200+25*x+"ms"}))}}}return{addClass:function(c,
...
function GridListDirective(a,b,d,c,e){function f(g,h,l,n){function v(){for(var F in b.MEDIA)c(F),c.getQuery(b.MEDIA[F]).addListener(w);return c.watchResponsiveAttributes(["md-cols","md-row-height","md-gutter"],l,q)}function m(){n.layoutDelegate=angular.noop;B();for(var F in b.MEDIA)c.getQuery(b.MEDIA[F]).removeListener(w)}function q(F){null==F?n.invalidateLayout():c(F)&&n.invalidateLayout()}function r(F){var O=y(),S={tileSpans:k(O),colCount:p(),rowMode:H(),rowHeight:t(),gutter:A(c.getResponsiveAttribute(l,
...
C({unit:Y,span:I.row,gutter:R})}Q=T;return{element:J,style:Q}})}}).reflow().performance(),g.mdOnLayout({$event:{performance:F}}),u=S}function x(F,O,S,K,M){var I={};switch(K){case "fixed":I.height=C({unit:M,span:O,gutter:S});I.paddingBottom="";break;case "ratio":K=1===F?0:(F-1)/F,F=1/F*100,M=1/M*F,M=G({share:M,gutterShare:K,gutter:S}),I.height="",I.paddingBottom=C({unit:M,span:O,gutter:S})}return I}function y(){return[].filter.call(h.children(),function(F){return"MD-GRID-TILE"==F.tagName&&!F.$$mdDestroyed})}
...
switch(H()){case "fixed":return A(F);case "ratio":return F=F.split(":"),parseFloat(F[0])/parseFloat(F[1]);case "fit":return 0}}function H(){var F=c.getResponsiveAttribute(l,"md-row-height");if(!F)throw"md-grid-list: md-row-height attribute was not found";return"fit"==F?"fit":-1!==F.indexOf(":")?"ratio":"fixed"}function A(F){return/\D$/.test(F)?F:F+"px"}h.addClass("_md");h.attr("role","list");n.layoutDelegate=r;var w=angular.bind(n,n.invalidateLayout),B=v();g.$on("$destroy",m);var u,z=a.startSymbol(),
...
function GridLayoutFactory(a){function b(f,g){var h,l,n,v,m;var q=a.time(function(){l=c(f,g)});return h={layoutInfo:function(){return l},map:function(r){v=a.time(function(){var x=h.layoutInfo();n=r(x.positioning,x.rowCount)});return h},reflow:function(r){m=a.time(function(){var x=r||e;x(n.grid,n.tiles)});return h},performance:function(){return{tileCount:g.length,layoutTime:q,mapTime:v,reflowTime:m,totalTime:q+v+m}}}}function d(f,g){f.element.css(f.style);g.forEach(function(h){h.element.css(h.style)})}
function c(f,g){function h(q,r,x){for(var y=q;y<q+r;y++)m[y]=Math.max(m[y]+x,0)}function l(){for(var q=[],r=0;r<f;r++)q.push(0);return q}var n=0,v=0,m=l();return{positioning:g.map(function(q,r){var x=q;if(x.col>f)throw"md-grid-list: Tile at position "+r+" has a colspan ("+x.col+") that exceeds the column count ("+f+")";for(var y=r=0;y-r<x.col;)if(n>=f)n=0,v++,h(0,f,-1);else{r=m.indexOf(0,n);var k;if(!(k=-1===r)){a:{for(y=r+1;y<m.length;y++)if(0!==m[y])break a;y=y===m.length?y:void 0}k=-1===y}k?(n=
r=y=0,v++,h(0,f,-1)):n=y+1}h(r,x.col,x.row);n=r+x.col;x={col:r,row:v};return{spans:q,position:x}}),rowCount:v+Math.max.apply(Math,m)}}var e=d;b.animateWith=function(f){e=angular.isFunction(f)?f:d};return b}
...
function mdInputContainerDirective(a,b,d){function c(l){var n=l[0].querySelector(g),v=l[0].querySelector(h);return function(m,q){a(q);(n||v)&&d(function(){var r=q[0].querySelector("md-icon")||q[0].querySelector(".md-icon");n&&r&&q.addClass("md-icon-left");v&&r&&q.addClass("md-icon-right")})}}function e(l,n,v,m){var q=this;q.isErrorGetter=v.mdIsError&&b(v.mdIsError);q.delegateClick=function(){q.input.focus()};q.element=n;q.setFocused=function(r){n.toggleClass("md-input-focused",!!r)};q.setHasValue=
function(r){n.toggleClass("md-input-has-value",!!r)};q.setHasPlaceholder=function(r){n.toggleClass("md-input-has-placeholder",!!r)};q.setInvalid=function(r){r?m.addClass(n,"md-input-invalid"):m.removeClass(n,"md-input-invalid")};l.$watch(function(){return q.label&&q.input},function(r){r&&!q.label.attr("for")&&q.label.attr("for",q.input.attr("id"))})}e.$inject=["$scope","$element","$attrs","$animate"];var f=["INPUT","TEXTAREA","SELECT","MD-SELECT"],g=f.reduce(function(l,n){return l.concat(["md-icon ~ "+
n,".md-icon ~ "+n])},[]).join(","),h=f.reduce(function(l,n){return l.concat([n+" ~ md-icon",n+" ~ .md-icon"])},[]).join(",");return{restrict:"E",compile:c,controller:e}}function labelDirective(){return{restrict:"E",require:"^?mdInputContainer",link:function(a,b,d,c){!c||d.mdNoFloat||b.hasClass("md-container-ignore")||(c.label=b,a.$on("$destroy",function(){c.label=null}))}}}
function inputTextareaDirective(a,b,d,c,e){function f(g,h,l,n){function v(w){x.setHasValue(!k.$isEmpty(w));return w}function m(){x.label&&l.$observe("required",function(w){x.label.toggleClass("md-required",w&&!t)})}function q(){x.setHasValue(0<h.val().length||(h[0].validity||{}).badInput)}function r(){function w(){h.attr("rows",1).css("height","auto").addClass("md-no-flex");var K=O.offsetHeight;var M=O.scrollHeight-K;K+=Math.max(M,0);F||(M=h[0].style.padding||"",F=h.css("padding",0).prop("offsetHeight"),
h[0].style.padding=M);G&&F&&(K=Math.max(K,F*G));N&&F&&(M=F*N,M<K?(h.attr("md-no-autogrow",""),K=M):h.removeAttr("md-no-autogrow"));F&&h.attr("rows",Math.round(K/F));h.css("height",K+"px").removeClass("md-no-flex")}function B(K){a.nextTick(w);return K}function u(){if(D&&(D=!1,angular.element(b).off("resize",w),C&&C(),h.attr("md-no-autogrow","").off("input",w),y)){var K=k.$formatters.indexOf(B);-1<K&&k.$formatters.splice(K,1)}}function z(){function K(X){X.preventDefault();T=!0;Y=parseFloat(h.css("height"))||
...
function(){var K=!1;return function(){var M=0===O.offsetHeight;!1===M&&!0===K&&w();K=M}}();g.$watch(function(){a.nextTick(S,!1);return!0})}}}var x=n[0],y=!!n[1],k=n[1]||a.fakeNgModel(),p=n[2];n=angular.isDefined(l.readonly);var t=a.parseAttributeBoolean(l.mdNoAsterisk),H=h[0].tagName.toLowerCase();if(x)if("hidden"===l.type)h.attr("aria-hidden","true");else{if(x.input){if(x.input[0].contains(h[0]))return;throw Error("<md-input-container> can only have *one* <input>, <textarea> or <md-select> child element!");
}x.input=h;m();var A=angular.element('<div class="md-errors-spacer">');h.after(A);A=angular.isString(l.placeholder)?l.placeholder.trim():"";x.label||A.length||d.expect(h,"aria-label");h.addClass("md-input");h.attr("id")||h.attr("id","input_"+a.nextUid());"input"===H&&"number"===l.type&&l.min&&l.max&&!l.step?h.attr("step","any"):"textarea"===H&&r();y||q();H=x.isErrorGetter||function(){return k.$invalid&&(k.$touched||p&&p.$submitted)};g.$watch(H,x.setInvalid);l.ngValue&&l.$observe("value",q);k.$parsers.push(v);
k.$formatters.push(v);h.on("input",q);if(!n)h.on("focus",function(){a.nextTick(function(){x.setFocused(!0)})}).on("blur",function(){a.nextTick(function(){x.setFocused(!1);q()})});g.$on("$destroy",function(){x.setFocused(!1);x.setHasValue(!1);x.input=null})}}return{restrict:"E",require:["^?mdInputContainer","?ngModel","?^form"],link:f}}
function mdMaxlengthDirective(a,b){function d(c,e,f,g){function h(k){k=x&&!y&&angular.isString(k)?k.trim():k;if(void 0===k||null===k)k="";return String(k).length}function l(){q&&q.parent()&&q.text(h(e.val())+" / "+n)}var n=parseInt(f.mdMaxlength);isNaN(n)&&(n=-1);var v=g[0],m=g[1],q,r,x=angular.isDefined(f.ngTrim)?b.parseAttributeBoolean(f.ngTrim):!0,y="password"===f.type;c.$watch(f.mdMaxlength,function(k){n=k});v.$validators["md-maxlength"]=function(k,p){if(!angular.isNumber(n)||0>n)return!0;l();
k=e.val()||p;if(void 0===k||null===k)k="";k=x&&!y&&angular.isString(k)?k.trim():k;return String(k).length<=n};v.$isEmpty=function(k){return 0===h(k)};b.nextTick(function(){r=angular.element(m.element[0].querySelector(".md-errors-spacer"));q=angular.element('<div class="md-char-counter">');r.append(q);f.$observe("ngTrim",function(k){x=angular.isDefined(k)?b.parseAttributeBoolean(k):!0});c.$watch(f.mdMaxlength,function(k){angular.isNumber(k)&&0<k?(q.parent().length||a.enter(q,r),l()):a.leave(q)})})}
return{restrict:"A",require:["ngModel","^mdInputContainer"],link:d}}
function placeholderDirective(a){function b(d,c,e,f){if(f){var g=f.element.find("label"),h=f.element.attr("md-no-float");g&&g.length||""===h||d.$eval(h)?f.setHasPlaceholder(!0):"MD-SELECT"!==c[0].nodeName&&(c=angular.element('<label ng-click="delegateClick()" tabindex="-1" aria-hidden="true">'+e.placeholder+"</label>"),e.$set("placeholder",null),f.element.addClass("md-icon-float").prepend(c),a(c)(d))}}return{restrict:"A",require:"^^?mdInputContainer",priority:200,link:{pre:b}}}
function mdSelectOnFocusDirective(a,b){function d(c,e){function f(){h=!0;b(function(){a[0].activeElement===e[0]&&e[0].select();h=!1},1,!1)}function g(l){h&&l.preventDefault()}if("INPUT"===e[0].nodeName||"TEXTAREA"===e[0].nodeName){var h=!1;e.on("focus",f).on("mouseup",g);c.$on("$destroy",function(){e.off("focus",f).off("mouseup",g)})}}return{restrict:"A",link:d}}var visibilityDirectives=["ngIf","ngShow","ngHide","ngSwitchWhen","ngSwitchDefault"];
function ngMessagesDirective(){function a(d,c,e,f){f&&(c.toggleClass("md-input-messages-animation",!0),c.toggleClass("md-auto-hide",!0),("false"==e.mdAutoHide||b(e))&&c.toggleClass("md-auto-hide",!1))}function b(d){return visibilityDirectives.some(function(c){return d[c]})}return{restrict:"EA",link:a,require:"^^?mdInputContainer"}}
...
function mdInputInvalidMessagesAnimation(a,b,d){saveSharedServices(a,b,d);return{addClass:function(c,e,f){showInputMessages(c,f)}}}function ngMessagesAnimation(a,b,d){saveSharedServices(a,b,d);return{enter:function(c,e){showInputMessages(c,e)},leave:function(c,e){hideInputMessages(c,e)},addClass:function(c,e,f){"ng-hide"==e?hideInputMessages(c,f):f()},removeClass:function(c,e,f){"ng-hide"==e?showInputMessages(c,f):f()}}}
function ngMessageAnimation(a,b,d,c){saveSharedServices(a,b,d,c);return{enter:function(e,f){e=showMessage(e);e.start().done(f)},leave:function(e,f){e=hideMessage(e);e.start().done(f)}}}function showInputMessages(a,b){var d=[],c;a=getMessagesElement(a);var e=a.children();0==a.length||0==e.length?b():(angular.forEach(e,function(f){c=showMessage(angular.element(f));d.push(c.start())}),$$AnimateRunner.all(d,b))}
function hideInputMessages(a,b){var d=[],c;a=getMessagesElement(a);var e=a.children();0==a.length||0==e.length?b():(angular.forEach(e,function(f){c=hideMessage(angular.element(f));d.push(c.start())}),$$AnimateRunner.all(d,b))}
...
function hideMessage(a){var b=a[0].offsetHeight,d=window.getComputedStyle(a[0]);return 0===parseInt(d.opacity)?$animateCss(a,{}):$animateCss(a,{event:"leave",structural:!0,from:{opacity:1,"margin-top":0},to:{opacity:0,"margin-top":-b+"px"},duration:.3})}
...
A.attr("md-position-mode")||A.attr("md-position-mode",B+" target");A=A.children().eq(0);q(A[0])||A.attr("ng-click","$mdMenu.open($event)");A.attr("aria-label")||A.attr("aria-label","Open List Menu")}function n(A){"div"==A?(k=angular.element('<div class="md-no-style md-list-item-inner">'),k.append(f.contents()),f.addClass("md-proxy-focus")):(k=angular.element('<div class="md-button md-no-style">   <div class="md-list-item-inner"></div></div>'),A=angular.element('<md-button class="md-no-style"></md-button>'),
m(f[0],A[0]),A.attr("aria-label")||A.attr("aria-label",a.getText(f)),f.hasClass("md-no-focus")&&A.addClass("md-no-focus"),k.prepend(A),k.children().eq(1).append(f.contents()),f.addClass("_md-button-wrap"));f[0].setAttribute("tabindex","-1");f.append(k)}function v(){var A=angular.element('<div class="md-secondary-container">');angular.forEach(x,function(w){var B=A,u;if(u=w)u=w.nodeName.toUpperCase(),u="MD-BUTTON"==u||"BUTTON"==u,u=!u;u&&w.hasAttribute("ng-click")&&(a.expect(w,"aria-label"),u=angular.element('<md-button class="md-secondary md-icon-button">'),
m(w,u[0],["ng-if","ng-hide","ng-show"]),w.setAttribute("tabindex","-1"),u.append(w),w=u[0]);w&&(!q(w)||!g.ngClick&&-1!=e.indexOf(w.nodeName.toLowerCase()))&&angular.element(w).removeClass("md-secondary");f.addClass("md-with-secondary");B.append(w)});k.append(A)}function m(A,w,B){var u=d.prefixer("ng-if ng-click ng-dblclick aria-label ng-disabled ui-sref href ng-href rel target ng-attr-ui-sref ui-sref-opts download".split(" "));B&&(u=u.concat(d.prefixer(B)));angular.forEach(u,function(z){A.hasAttribute(z)&&
(w.setAttribute(z,A.getAttribute(z)),A.removeAttribute(z))})}function q(A){A=A.attributes;for(var w=0;w<A.length;w++)if("ngClick"===g.$normalize(A[w].name))return!0;return!1}function r(A,w,B,u){function z(){N&&N.children&&!F&&!O&&angular.forEach(e,function(K){angular.forEach(N.querySelectorAll(K+":not(.md-secondary)"),function(M){G.push(M)})})}function D(K){var M=["md-slider"];if(!K.path)return-1!==M.indexOf(K.target.tagName.toLowerCase());for(var I=K.path.indexOf(w.children()[0]),J=0;J<I;J++)if(-1!==
M.indexOf(K.path[J].tagName.toLowerCase()))return!0}w.addClass("_md");var G=[],N=w[0].firstElementChild,C=(B=w.hasClass("_md-button-wrap"))?N.firstElementChild:N,F=C&&q(C),O=w.hasClass("md-no-proxy");z();if(1==G.length||F)w.addClass("md-clickable"),F||u.attachRipple(A,angular.element(w[0].querySelector(".md-no-style")));G.length&&angular.forEach(G,function(K){K=angular.element(K);A.mouseActive=!1;K.on("mousedown",function(){A.mouseActive=!0;c(function(){A.mouseActive=!1},100)}).on("focus",function(){!1===
A.mouseActive&&w.addClass("md-focused");K.on("blur",function I(){w.removeClass("md-focused");K.off("blur",I)})})});var S=function(K){if("INPUT"!=K.target.nodeName&&"TEXTAREA"!=K.target.nodeName&&!K.target.isContentEditable){var M=K.which||K.keyCode;M==b.KEY_CODE.SPACE&&C&&(C.click(),K.preventDefault(),K.stopPropagation())}};F||G.length||C&&C.addEventListener("keypress",S);w.off("click");w.off("keypress");if(1==G.length&&C)w.children().eq(0).on("click",function(K){if(!D(K)){var M=d.getClosest(K.target,
"BUTTON");!M&&C.contains(K.target)&&angular.forEach(G,function(I){K.target===I||I.contains(K.target)||("MD-MENU"===I.nodeName&&(I=I.children[0]),angular.element(I).triggerHandler("click"))})}});A.$on("$destroy",function(){C&&C.removeEventListener("keypress",S)})}var x=f[0].querySelectorAll(".md-secondary"),y,k=f;f[0].setAttribute("role","listitem");if(g.ngClick||g.ngDblclick||g.ngHref||g.href||g.uiSref||g.ngAttrUiSref)n("button");else if(!f.hasClass("md-no-proxy")){for(var p=0,t;t=e[p];++p)if(y=f[0].querySelector(t)){var H=
!0;break}H?n("div"):f.addClass("md-no-proxy")}v();h();H&&"MD-MENU"===y.nodeName&&l();return r}}}function MdListController(a,b,d){function c(e,f){var g={};d.attach(e,f,g)}a=this;a.attachRipple=c}ngmaterial.components.list=angular.module("material.components.list");angular.module("material.components.menu",["material.core","material.components.backdrop"]);MenuController.$inject="$mdMenu $attrs $element $scope $mdUtil $timeout $rootScope $q $log".split(" ");angular.module("material.components.menu").controller("mdMenuCtrl",MenuController);
function MenuController(a,b,d,c,e,f,g,h,l){var n=e.prefixer(),v,m=this,q;this.nestLevel=parseInt(b.mdNestLevel,10)||0;this.init=function(k,p){p=p||{};v=k;q=d[0].querySelector(n.buildSelector(["ng-click","ng-mouseenter"]));q.setAttribute("aria-expanded","false");this.isInMenuBar=p.isInMenuBar;this.nestedMenus=e.nodesToArray(v[0].querySelectorAll(".md-nested-menu"));v.on("$mdInterimElementRemove",function(){m.isOpen=!1;e.nextTick(function(){m.onIsOpenChanged(m.isOpen)})});e.nextTick(function(){m.onIsOpenChanged(m.isOpen)});
k="menu_container_"+e.nextUid();v.attr("id",k);angular.element(q).attr({"aria-owns":k,"aria-haspopup":"true"});c.$on("$destroy",angular.bind(this,function(){this.disableHoverListener();a.destroy()}));v.on("$destroy",function(){a.destroy()})};var r,x,y=[];this.enableHoverListener=function(){y.push(g.$on("$mdMenuOpen",function(k,p){v[0].contains(p[0])&&(m.currentlyOpenMenu=p.controller("mdMenu"),m.isAlreadyOpening=!1,m.currentlyOpenMenu.registerContainerProxy(m.triggerContainerProxy.bind(m)))}));y.push(g.$on("$mdMenuClose",
function(k,p){v[0].contains(p[0])&&(m.currentlyOpenMenu=void 0)}));x=angular.element(e.nodesToArray(v[0].children[0].children));x.on("mouseenter",m.handleMenuItemHover);x.on("mouseleave",m.handleMenuItemMouseLeave)};this.disableHoverListener=function(){for(;y.length;)y.shift()();x&&x.off("mouseenter",m.handleMenuItemHover);x&&x.off("mouseleave",m.handleMenuItemMouseLeave)};this.handleMenuItemHover=function(k){if(!m.isAlreadyOpening){var p=k.target.querySelector("md-menu")||e.getClosest(k.target,"MD-MENU");
r=f(function(){p&&(p=angular.element(p).controller("mdMenu"));if(m.currentlyOpenMenu&&m.currentlyOpenMenu!=p){var t=m.nestLevel+1;m.currentlyOpenMenu.close(!0,{closeTo:t});m.isAlreadyOpening=!!p;p&&p.open()}else p&&!p.isOpen&&p.open&&(m.isAlreadyOpening=!!p,p&&p.open())},p?100:250);(k=k.currentTarget.querySelector(".md-button:not([disabled])"))&&k.focus()}};this.handleMenuItemMouseLeave=function(){r&&(f.cancel(r),r=void 0)};this.open=function(k){k&&k.stopPropagation();k&&k.preventDefault();m.isOpen||
(m.enableHoverListener(),m.isOpen=!0,e.nextTick(function(){m.onIsOpenChanged(m.isOpen)}),q=q||(k?k.target:d[0]),q.setAttribute("aria-expanded","true"),c.$emit("$mdMenuOpen",d),a.show({scope:c,mdMenuCtrl:m,nestLevel:m.nestLevel,element:v,target:q,preserveElement:!0,parent:"body"}).finally(function(){q.setAttribute("aria-expanded","false");m.disableHoverListener()}))};this.onIsOpenChanged=function(k){k?(v.attr("aria-hidden","false"),d[0].classList.add("md-open"),angular.forEach(m.nestedMenus,function(p){p.classList.remove("md-open")})):
(v.attr("aria-hidden","true"),d[0].classList.remove("md-open"));c.$mdMenuIsOpen=m.isOpen};this.focusMenuContainer=function(){var k=v[0].querySelector(n.buildSelector(["md-menu-focus-target","md-autofocus"]));k||(k=v[0].querySelector(".md-button:not([disabled])"));k.focus()};this.registerContainerProxy=function(k){this.containerProxy=k};this.triggerContainerProxy=function(k){this.containerProxy&&this.containerProxy(k)};this.destroy=function(){return m.isOpen?a.destroy():h.when(!1)};this.close=function(k,
p){if(m.isOpen){m.isOpen=!1;e.nextTick(function(){m.onIsOpenChanged(m.isOpen)});var t=angular.extend({},p,{skipFocus:k});c.$emit("$mdMenuClose",d,t);a.hide(null,p);k||(k=m.restoreFocusTo||d.find("button")[0],k instanceof angular.element&&(k=k[0]),k&&k.focus())}};this.positionMode=function(){var k=(b.mdPositionMode||"target").split(" ");1===k.length&&k.push(k[0]);return{left:k[0],top:k[1]}};this.offsets=function(){var k=(b.mdOffset||"0 0").split(" ").map(parseFloat);if(2===k.length)return{left:k[0],
top:k[1]};if(1===k.length)return{top:k[0],left:k[0]};throw Error("Invalid offsets specified. Please follow format <x, y> or <n>");};c.$mdMenu={open:this.open,close:this.close};c.$mdOpenMenu=angular.bind(this,function(){l.warn("mdMenu: The $mdOpenMenu method is deprecated. Please use `$mdMenu.open`.");return this.open.apply(this,arguments)})}MenuDirective.$inject=["$mdUtil"];angular.module("material.components.menu").directive("mdMenu",MenuDirective);
function MenuDirective(a){function b(c){c.addClass("md-menu");var e=c.children()[0],f=a.prefixer();f.hasAttribute(e,"ng-click")||(e=e.querySelector(f.buildSelector(["ng-click","ng-mouseenter"]))||e);f="MD-BUTTON"===e.nodeName||"BUTTON"===e.nodeName;e&&f&&!e.hasAttribute("type")&&e.setAttribute("type","button");if(!e)throw Error("Invalid HTML for md-menu: Expected the menu to have a trigger element.");if(2!==c.children().length)throw Error("Invalid HTML for md-menu: Expected two children elements. The second element must have a `md-menu-content` element.");
...
function MenuProvider(a){function b(c,e,f,g,h,l,n,v,m,q){function r(A,w,B){if(B.nestLevel)return angular.noop;B.disableParentScroll&&!c.getClosest(B.target,"MD-DIALOG")?B.restoreScroll=c.disableScrollAround(B.element,B.parent):B.disableParentScroll=!1;B.hasBackdrop&&(B.backdrop=c.createBackdrop(A,"md-menu-backdrop md-click-catcher"),m.enter(B.backdrop,g[0].body));return function(){B.backdrop&&B.backdrop.remove();B.disableParentScroll&&B.restoreScroll()}}function x(A,w,B){function u(){w.removeClass("md-active");
var z=w,D=B;D.preserveElement?d(z).style.display="none":d(z).parentNode===d(D.parent)&&d(D.parent).removeChild(d(z));B.alreadyOpen=!1}B.cleanupInteraction();B.cleanupBackdrop();B.cleanupResizing();B.hideBackdrop();w.removeClass("md-clickable");return!0===B.$destroy?u():v(w,{addClass:"md-leave"}).start().then(u)}function y(A,w,B){function u(){B.parent.append(w);w[0].style.display="";return l(function(C){var F=p(w,B);w.removeClass("md-leave");v(w,{addClass:"md-active",from:H.toCss(F),to:H.toCss({transform:""})}).start().then(C)})}
function z(){var C=function(F,O){return n.throttle(function(){if(!B.isRemoved){var S=p(F,O);F.css(H.toCss(S))}})}(w,B);h.addEventListener("resize",C);h.addEventListener("orientationchange",C);return function(){h.removeEventListener("resize",C);h.removeEventListener("orientationchange",C)}}function D(){if(!B.backdrop)return angular.noop;B.backdrop.on("click",G);return function(){B.backdrop.off("click",G)}}function G(C){C.preventDefault();C.stopPropagation();A.$apply(function(){B.mdMenuCtrl.close(!0,
...
J=!0;break;case f.KEY_CODE.RIGHT_ARROW:(J=c.getClosest(I.target,"MD-MENU"))&&J!=B.parent[0]?I.target.click():B.mdMenuCtrl.triggerContainerProxy(I),J=!0}J&&(I.preventDefault(),I.stopImmediatePropagation())}function F(I){function J(){A.$apply(function(){B.mdMenuCtrl.close(!0,{closeAll:!0})})}function Q(Y,R){if(!Y)return!1;for(var U=0,X;X=R[U];++U)if(t.hasAttribute(Y,X))return!0;return!1}I=I.target;do{if(I==B.menuContentEl[0])break;if((Q(I,["ng-click","ng-href","ui-sref"])||"BUTTON"==I.nodeName||"MD-BUTTON"==
I.nodeName)&&!Q(I,["md-prevent-menu-close"])){var T=c.getClosest(I,"MD-MENU");I.hasAttribute("disabled")||T&&T!=B.parent[0]||J();break}}while(I=I.parentNode)}if(!B.menuContentEl[0])return angular.noop;B.menuContentEl.on("keydown",C);B.menuContentEl[0].addEventListener("click",F,!0);var O=B.menuContentEl[0].querySelector(t.buildSelector(["md-menu-focus-target","md-autofocus"]));if(!O)for(var S=B.menuContentEl[0].children.length,K=0;K<S;K++){var M=B.menuContentEl[0].children[K];if(O=M.querySelector(".md-button:not([disabled])"))break;
...
B.target):q.warn("$mdMenu: Menu elements should always contain a `md-menu-content` element,otherwise interactivity features will not work properly.",w);B.cleanupResizing=z();B.hideBackdrop=r(A,w,B);return u().then(function(C){B.alreadyOpen=!0;B.cleanupInteraction=N();B.cleanupBackdrop=D();w.addClass("md-clickable");return C})}function k(A,w,B,u){A=c.getClosest(A.target,"MD-MENU-ITEM");w=c.nodesToArray(w[0].children);A=w.indexOf(A);for(A+=u;0<=A&&A<w.length;A+=u){var z=w[A].querySelector(".md-button");
z&&-1!=z.getAttribute("tabindex")?(z.focus(),z=g[0].activeElement==z):z=void 0;if(z)break}return z}function p(A,w){function B(Q){Q.top=Math.max(Math.min(Q.top,S.bottom-z.offsetHeight),S.top);Q.left=Math.max(Math.min(Q.left,S.right-z.offsetWidth),S.left)}function u(){for(var Q=0;Q<D.children.length;++Q)if("none"!=h.getComputedStyle(D.children[Q]).display)return D.children[Q]}var z=A[0],D=A[0].firstElementChild,G=D.getBoundingClientRect(),N=g[0].body,C=N.getBoundingClientRect(),F=h.getComputedStyle(D),
O=w.target[0].querySelector(t.buildSelector("md-menu-origin"))||w.target[0];N=O.getBoundingClientRect();var S={left:C.left+8,top:Math.max(C.top,0)+8,bottom:Math.max(C.bottom,Math.max(C.top,0)+C.height)-8,right:C.right-8},K={top:0,left:0,right:0,bottom:0},M={top:0,left:0,right:0,bottom:0},I=w.mdMenuCtrl.positionMode();if("target"===I.top||"target"===I.left||"target-right"===I.left)if(C=u())C=C.firstElementChild||C,C=C.querySelector(t.buildSelector("md-menu-align-target"))||C,K=C.getBoundingClientRect(),
...
function MenuBarController(a,b,d,c,e,f,g,h){this.$element=d;this.$attrs=c;this.$mdConstant=e;this.$mdUtil=g;this.$document=f;this.$scope=a;this.$rootScope=b;this.$timeout=h;var l=this;angular.forEach(BOUND_MENU_METHODS,function(n){l[n]=angular.bind(l,l[n])})}
MenuBarController.prototype.init=function(){var a=this.$element,b=this.$mdUtil,d=this.$scope,c=this,e=[];a.on("keydown",this.handleKeyDown);this.parentToolbar=b.getClosest(a,"MD-TOOLBAR");e.push(this.$rootScope.$on("$mdMenuOpen",function(f,g){-1!=c.getMenus().indexOf(g[0])&&(a[0].classList.add("md-open"),g[0].classList.add("md-open"),c.currentlyOpenMenu=g.controller("mdMenu"),c.currentlyOpenMenu.registerContainerProxy(c.handleKeyDown),c.enableOpenOnHover())}));e.push(this.$rootScope.$on("$mdMenuClose",
function(f,g,h){f=c.getMenus();-1!=f.indexOf(g[0])&&(a[0].classList.remove("md-open"),g[0].classList.remove("md-open"));if(a[0].contains(g[0])){for(g=g[0];g&&-1==f.indexOf(g);)g=b.getClosest(g,"MD-MENU",!0);g&&(h.skipFocus||g.querySelector("button:not([disabled])").focus(),c.currentlyOpenMenu=void 0,c.disableOpenOnHover(),c.setKeyboardMode(!0))}}));d.$on("$destroy",function(){for(c.disableOpenOnHover();e.length;)e.shift()()});this.setKeyboardMode(!0)};
...
e=!0}e&&(a&&a.preventDefault&&a.preventDefault(),a&&a.stopImmediatePropagation&&a.stopImmediatePropagation())};MenuBarController.prototype.focusMenu=function(a){var b=this.getMenus(),d=this.getFocusedMenuIndex();-1==d&&(d=this.getOpenMenuIndex());var c=!1;if(-1==d)d=0,c=!0;else if(0>a&&0<d||0<a&&d<b.length-a)d+=a,c=!0;if(c)return b[d].querySelector("button").focus(),b[d]};MenuBarController.prototype.openFocusedMenu=function(){var a=this.getFocusedMenu();a&&angular.element(a).controller("mdMenu").open()};
MenuBarController.prototype.getMenus=function(){var a=this.$element;return this.$mdUtil.nodesToArray(a[0].children).filter(function(b){return"MD-MENU"==b.nodeName})};MenuBarController.prototype.getFocusedMenu=function(){return this.getMenus()[this.getFocusedMenuIndex()]};MenuBarController.prototype.getFocusedMenuIndex=function(){var a=this.$mdUtil;a=a.getClosest(this.$document[0].activeElement,"MD-MENU");return a?a=this.getMenus().indexOf(a):-1};
...
function MenuBarDirective(a,b){return{restrict:"E",require:"mdMenuBar",controller:"MenuBarController",compile:function(d,c){c.ariaRole||d[0].setAttribute("role","menubar");angular.forEach(d[0].children,function(e){"MD-MENU"==e.nodeName&&(e.hasAttribute("md-position-mode")||(e.setAttribute("md-position-mode","left bottom"),e.querySelector("button, a, md-button").setAttribute("role","menuitem")),e=a.nodesToArray(e.querySelectorAll("md-menu-content")),angular.forEach(e,function(f){f.classList.add("md-menu-bar-menu");
...
MenuItemController.prototype.initClickListeners=function(){function a(n){if(n)h.off("click",l);else h.on("click",l)}var b=this,d=this.ngModel,c=this.$scope,e=this.$attrs,f=this.mode;this.handleClick=angular.bind(this,this.handleClick);var g=this.iconEl,h=angular.element(this.buttonEl),l=this.handleClick;e.$observe("disabled",a);a(e.disabled);d.$render=function(){b.clearNgAria();if("radio"==f){var n=e.ngValue?c.$eval(e.ngValue):e.value;n=d.$modelValue==n}else n=d.$modelValue;n?(g.style.display="",
h.attr("aria-checked","true")):(g.style.display="none",h.attr("aria-checked","false"))};c.$$postDigest(d.$render)};MenuItemController.prototype.handleClick=function(){var a=this.mode,b=this.ngModel,d=this.$attrs,c;"checkbox"==a?c=!b.$modelValue:"radio"==a&&(c=d.ngValue?this.$scope.$eval(d.ngValue):d.value);b.$setViewValue(c);b.$render()};MenuItemDirective.$inject=["$mdUtil","$mdConstant","$$mdSvgRegistry"];angular.module("material.components.menuBar").directive("mdMenuItem",MenuItemDirective);
function MenuItemDirective(a,b,d){return{controller:"MenuItemController",require:["mdMenuItem","?ngModel"],priority:b.BEFORE_NG_ARIA,compile:function(c,e){function f(m,q,r){r=r||c;r instanceof angular.element&&(r=r[0]);r.hasAttribute(m)||r.setAttribute(m,q)}function g(m){m=a.prefixer(m);angular.forEach(m,function(q){if(c[0].hasAttribute(q)){var r=c[0].getAttribute(q);n[0].setAttribute(q,r);c[0].removeAttribute(q)}})}var h=e.type;if("checkbox"!==h&&"radio"!==h||!c.hasClass("md-in-menu-bar"))f("role",
"menuitem",c[0].querySelector("md-button, button, a"));else{var l=c[0].textContent,n=angular.element('<md-button type="button"></md-button>'),v='<md-icon md-svg-src="'+d.mdChecked+'"></md-icon>';n.html(l);n.attr("tabindex","0");angular.isDefined(e.mdPreventMenuClose)&&n.attr("md-prevent-menu-close",e.mdPreventMenuClose);c.html("");c.append(angular.element(v));c.append(n);c.addClass("md-indent").removeClass("md-in-menu-bar");f("role","checkbox"===h?"menuitemcheckbox":"menuitemradio",n);g("ng-disabled")}return function(m,
q,r,x){m=x[0];x=x[1];m.init(x)}}}}ngmaterial.components.menuBar=angular.module("material.components.menuBar");MdNavBar.$inject=["$mdAria","$mdTheming"];MdNavBarController.$inject=["$element","$scope","$timeout","$mdConstant"];MdNavItem.$inject=["$mdAria","$$rAF","$mdUtil","$window"];MdNavItemController.$inject=["$element"];angular.module("material.components.navBar",["material.core"]).controller("MdNavBarController",MdNavBarController).directive("mdNavBar",MdNavBar).controller("MdNavItemController",MdNavItemController).directive("mdNavItem",MdNavItem);
...
"aria-label",angular.noop)}}}function MdNavBarController(a,b,d,c){this._$timeout=d;this._$scope=b;this._$mdConstant=c;this._navBarEl=a[0];var e=this,f=this._$scope.$watch(function(){return e._navBarEl.querySelectorAll("._md-nav-button").length},function(g){0<g&&(e._initTabs(),f())})}
...
MdNavBarController.prototype._getTabByName=function(a){return this._findTab(function(b){return b.getName()===a})};MdNavBarController.prototype._getSelectedTab=function(){return this._findTab(function(a){return a.isSelected()})};MdNavBarController.prototype.getFocusedTab=function(){return this._findTab(function(a){return a.hasFocus()})};MdNavBarController.prototype._findTab=function(a,b){var d=this._getTabs();if(void 0===b||null===b)b=0;for(;b<d.length;b++)if(a(d[b]))return d[b];return null};
MdNavBarController.prototype._findTabReverse=function(a,b){var d=this._getTabs();if(void 0===b||null===b)b=d.length-1;for(;0<=b;b--)if(a(d[b]))return d[b];return null};MdNavBarController.prototype.onFocus=function(){var a=this._getSelectedTab();a&&a.setFocused(!0)};MdNavBarController.prototype._moveFocus=function(a,b){a.setFocused(!1);b.setFocused(!0)};
...
this._focusLastTab()}};
function MdNavItem(a,b,d,c){return{restrict:"E",require:["mdNavItem","^mdNavBar"],controller:MdNavItemController,bindToController:!0,controllerAs:"ctrl",replace:!0,transclude:!0,template:function(e,f){e=f.mdNavClick;var g=f.mdNavHref,h=f.mdNavSref;f=f.srefOpts;var l;if(1<(e?1:0)+(g?1:0)+(h?1:0))throw Error("Please do not specify more than one of the md-nav-click, md-nav-href, or md-nav-sref attributes per nav-item directive.");if(void 0!==e&&null!==e)e='ng-click="ctrl.mdNavClick()"';else if(void 0!==
g&&null!==g)e='ng-href="{{ctrl.mdNavHref}}"';else if(void 0!==h&&null!==h)e='ui-sref="{{ctrl.mdNavSref}}"';else throw Error("Please specify at least one of the md-nav-click, md-nav-href, or md-nav-sref attributes per nav-item directive.");f=f?'ui-sref-opts="{{ctrl.srefOpts}}" ':"";e&&(l='<md-button class="_md-nav-button md-accent" ng-class="ctrl.getNgClassMap()" ng-blur="ctrl.setFocused(false)" ng-disabled="ctrl.disabled" tabindex="-1" role="tab" ng-attr-aria-label="{{ctrl.navItemAriaLabel ? ctrl.navItemAriaLabel : undefined}}" aria-selected="{{ctrl.isSelected()}}" '+
f+e+'><span ng-transclude class="_md-nav-button-text"></span></md-button>');return'<li class="md-nav-item" role="presentation">'+(l||"")+"</li>"},scope:{mdNavClick:"&?",mdNavHref:"@?",mdNavSref:"@?",srefOpts:"=?",name:"@",navItemAriaLabel:"@?"},link:function(e,f,g,h){var l,n,v,m;b(function(){n=h[0];v=h[1];m=angular.element(f[0].querySelector("._md-nav-button"));n.name||(n.name=angular.element(f[0].querySelector("._md-nav-button-text")).text().trim());m.on("keydown",function(y){v.onKeydown(y)});m.on("focus",
function(){if(!v.getFocusedTab())v.onFocus()});m.on("click",function(){v.mdSelectedNavItem=n.name;e.$apply()});n.disabled=d.parseAttributeBoolean(g.disabled,!1);if("MutationObserver"in c){var q={attributes:!0,attributeFilter:["disabled"]},r=f[0],x=function(y){d.nextTick(function(){n.disabled=d.parseAttributeBoolean(g[y[0].attributeName],!1)})};x=new MutationObserver(x);x.observe(r,q);l=x.disconnect.bind(x)}else g.$observe("disabled",function(y){n.disabled=d.parseAttributeBoolean(y,!1)});n.navItemAriaLabel||
a.expectWithText(m,"aria-label")});e.$on("destroy",function(){m.off("keydown");m.off("focus");m.off("click");l()})}}}function MdNavItemController(a){this._$element=a;this._focused=this._selected=!1}MdNavItemController.prototype.getNgClassMap=function(){return{"md-active":this._selected,"md-primary":this._selected,"md-unselected":!this._selected,"md-focused":this._focused}};MdNavItemController.prototype.getName=function(){return this.name};MdNavItemController.prototype.getButtonEl=function(){return this._$element[0].querySelector("._md-nav-button")};
...
MdPanelRef.prototype.detach=function(){if(!this.isAttached)return this._$q.when(this);var a=this,b=a.config.onDomRemoved||angular.noop,d=function(){a._removeEventListeners();a._topFocusTrap&&a._topFocusTrap.parentNode&&a._topFocusTrap.parentNode.removeChild(a._topFocusTrap);a._bottomFocusTrap&&a._bottomFocusTrap.parentNode&&a._bottomFocusTrap.parentNode.removeChild(a._bottomFocusTrap);a._restoreCache.classes&&(a.panelEl[0].className=a._restoreCache.classes);a.panelEl[0].style.cssText=a._restoreCache.styles||
"";a._compilerCleanup();a.panelContainer.remove();a.isAttached=!1;return a._$q.when(a)};this._restoreScroll&&(this._restoreScroll(),this._restoreScroll=null);return this._$q(function(c,e){c=a._done(c,a);a._$q.all([d(),a._backdropRef?a._backdropRef.detach():!0]).then(b).then(c).catch(e)})};
...
MdPanelRef.prototype.show=function(){if(!this.panelContainer)return this._$q(function(d,c){c("mdPanel: Panel does not exist yet. Call open() or attach().")});if(!this.panelContainer.hasClass("_md-panel-hidden"))return this._$q.when(this);var a=this,b=function(){a.panelContainer.removeClass("_md-panel-hidden");return a._animateOpen()};return this._$q(function(d,c){d=a._done(d,a);var e=a.config.onOpenComplete||angular.noop,f=function(){a.config.groupName&&angular.forEach(a.config.groupName,function(g){a._$mdPanel._groups[g].openPanels.push(a)})};
a._$q.all([a._backdropRef?a._backdropRef.show():a,b().then(function(){a._focusOnOpen()},c)]).then(e).then(f).then(d).catch(c)})};
...
h=l.openPanels.indexOf(a);-1<h&&l.openPanels.splice(h,1)})}},g=function(){var h=a.config.origin;h&&getElement(h).focus()};a._$q.all([a._backdropRef?a._backdropRef.hide():a,a._animateClose().then(c).then(e).then(f).then(g).catch(d)]).then(b,d)})};
...
MdPanelRef.prototype.registerInterceptor=function(a,b){var d=null;angular.isString(a)?angular.isFunction(b)||(d="Interceptor callback must be a function, instead got "+typeof b):d="Interceptor type must be a string, instead got "+typeof a;if(d)throw Error("MdPanel: "+d);a=this._interceptors[a]=this._interceptors[a]||[];-1===a.indexOf(b)&&a.push(b);return this};
...
MdPanelPosition.prototype._validateYPosition=function(a){if(null!=a){for(var b=Object.keys(MdPanelPosition.yPosition),d=[],c,e=0;c=b[e];e++)if(c=MdPanelPosition.yPosition[c],d.push(c),c===a)return;throw Error("mdPanel: Panel y position only accepts the following values:\n"+d.join(" | "));}};
MdPanelPosition.prototype._validateXPosition=function(a){if(null!=a){for(var b=Object.keys(MdPanelPosition.xPosition),d=[],c,e=0;c=b[e];e++)if(c=MdPanelPosition.xPosition[c],d.push(c),c===a)return;throw Error("mdPanel: Panel x Position only accepts the following values:\n"+d.join(" | "));}};MdPanelPosition.prototype.withOffsetX=function(a){this._translateX.push(addUnits(a));return this};MdPanelPosition.prototype.withOffsetY=function(a){this._translateY.push(addUnits(a));return this};
...
MdPanelPosition.prototype._isOnscreen=function(a){var b=parseInt(this.getLeft()),d=parseInt(this.getTop());if(this._translateX.length||this._translateY.length){var c=this._$mdConstant.CSS.TRANSFORM,e=getComputedStyle(a[0]||a)[c],f=e.indexOf("("),g=e.lastIndexOf(")");c={x:0,y:0};-1<f&&-1<g&&(e=e.substring(f+1,g).split(", ").slice(-2),c.x=parseInt(e[0]),c.y=parseInt(e[1]));b+=c.x;d+=c.y}c=b+a[0].offsetWidth;a=d+a[0].offsetHeight;return 0<=b&&0<=d&&a<=this._$window.innerHeight&&c<=this._$window.innerWidth};
...
function MdProgressCircularDirective(a,b,d,c,e){function f(m,q,r){function x(N,C,F,O,S,K){function M(ha){A.attr("stroke-dashoffset",(T-Y)*a.Math.PI*(3*(aa||100)/100-ha/100));A.attr("transform","rotate("+X+" "+T/2+" "+T/2+")")}var I=++z,J=c.now(),Q=C-N,T=l(m.mdDiameter),Y=b.strokeWidth/100*T,R=F||b.easeFn,U=O||b.duration,X=-90*(S||0),aa=K||100;C===N?M(C):D=n(function fa(){var ea=a.Math.max(0,a.Math.min(c.now()-J,U));M(R(ea,N,Q,U));I===z&&ea<U&&(D=n(fa))})}function y(){x(w,B,b.easeFnIndeterminate,b.durationIndeterminate,
u,75);u=++u%4}function k(){G||(G=e(y,b.durationIndeterminate,0,!1),y(),q.addClass("md-mode-indeterminate").removeAttr("aria-valuenow"))}function p(){G&&(e.cancel(G),G=null,q.removeClass("md-mode-indeterminate"))}var t=q[0],H=angular.element(t.querySelector("svg")),A=angular.element(t.querySelector("path")),w=b.startIndeterminate,B=b.endIndeterminate,u=0,z=0,D,G;d(q);q.toggleClass("_md-progress-circular-disabled",r.hasOwnProperty("disabled"));"indeterminate"===m.mdMode&&k();m.$on("$destroy",function(){p();
D&&v(D)});m.$watchGroup(["value","mdMode",function(){var N=t.disabled;return!0===N||!1===N?N:angular.isDefined(q.attr("disabled"))}],function(N,C){var F=N[1],O=N[2],S=C[2];O!==S&&q.toggleClass("_md-progress-circular-disabled",!!O);O?p():("determinate"!==F&&"indeterminate"!==F&&(F="indeterminate",r.$set("mdMode",F)),"indeterminate"===F?("determinate"===C[1]&&(C=l(m.mdDiameter),O=b.strokeWidth/100*C,A.attr("d",g(C,O,!0)),A.attr("stroke-dasharray",(C-O)*a.Math.PI*.75)),k()):(N=h(N[0]),F=h(C[0]),p(),
"indeterminate"===C[1]&&(C=l(m.mdDiameter),O=b.strokeWidth/100*C,A.attr("d",g(C,O,!1)),A.attr("stroke-dasharray",(C-O)*a.Math.PI)),q.attr("aria-valuenow",N),x(F,N)))});m.$watch("mdDiameter",function(N){N=l(N);var C=b.strokeWidth/100*N,F=h(m.value),O=N/2+"px",S={width:N+"px",height:N+"px"};H[0].setAttribute("viewBox","0 0 "+N+" "+N);H.css(S).css("transform-origin",O+" "+O+" "+O);q.css(S);A.attr("stroke-width",C);A.attr("stroke-linecap","square");"indeterminate"==m.mdMode?(A.attr("d",g(N,C,!0)),A.attr("stroke-dasharray",
(N-C)*a.Math.PI*.75),A.attr("stroke-dashoffset",(N-C)*a.Math.PI*2.24)):(A.attr("d",g(N,C,!1)),A.attr("stroke-dasharray",(N-C)*a.Math.PI),A.attr("stroke-dashoffset",(N-C)*a.Math.PI*3),x(F,F))})}function g(m,q,r){m/=2;var x=q/2;q=m+","+x;var y=x+","+m;m-=x;return"M"+q+"A"+m+","+m+" 0 1 1 "+y+(r?"":"A"+m+","+m+" 0 0 1 "+q)}function h(m){return a.Math.max(0,a.Math.min(m||0,100))}function l(m){var q=b.progressSize;if(m){var r=parseFloat(m);m.lastIndexOf("%")===m.length-1&&(r=r/100*q);return r}return q}
var n=a.requestAnimationFrame||a.webkitRequestAnimationFrame||angular.noop,v=a.cancelAnimationFrame||a.webkitCancelAnimationFrame||a.webkitCancelRequestAnimationFrame||angular.noop;return{restrict:"E",scope:{value:"@",mdDiameter:"@",mdMode:"@"},template:'<svg xmlns="http://www.w3.org/2000/svg"><path fill="none"/></svg>',compile:function(m,q){m.attr({"aria-valuemin":0,"aria-valuemax":100,role:"progressbar"});angular.isUndefined(q.mdMode)?(m=q.hasOwnProperty("value")?"determinate":"indeterminate",q.$set("mdMode",
m)):q.$set("mdMode",q.mdMode.trim());return f}}}angular.module("material.components.progressCircular").provider("$mdProgressCircular",MdProgressCircularProvider);
...
function MdProgressLinearDirective(a,b){function d(e){e.attr("aria-valuemin",0);e.attr("aria-valuemax",100);e.attr("role","progressbar");return c}function c(e,f,g){function h(){g.$observe("value",function(p){p=Math.max(0,Math.min(p||0,100));f.attr("aria-valuenow",p);"query"!=n()&&v(y,p)});g.$observe("mdBufferValue",function(p){v(x,Math.max(0,Math.min(p||0,100)))});g.$observe("disabled",function(p){q=!0===p||!1===p?!!p:angular.isDefined(p);f.toggleClass("_md-progress-linear-disabled",q);k.toggleClass(m,
!q)});g.$observe("mdMode",function(p){m&&k.removeClass(m);switch(p){case "query":case "buffer":case "determinate":case "indeterminate":k.addClass(m="md-mode-"+p);break;default:k.addClass(m="md-mode-indeterminate")}})}function l(){if(angular.isUndefined(g.mdMode)){var p=angular.isDefined(g.value);p=p?"determinate":"indeterminate";f.attr("md-mode",p);g.mdMode=p}}function n(){var p=(g.mdMode||"").trim();if(p)switch(p){case "determinate":case "indeterminate":case "buffer":case "query":break;default:p=
"indeterminate"}return p}function v(p,t){!q&&n()&&(t=b.supplant("translateX({0}%) scale({1},1)",[(t-100)/2,t/100]),t=r({transform:t}),angular.element(p).css(t))}a(f);var m,q=g.hasOwnProperty("disabled"),r=b.dom.animator.toCss,x=angular.element(f[0].querySelector(".md-bar1")),y=angular.element(f[0].querySelector(".md-bar2")),k=angular.element(f[0].querySelector(".md-container"));f.attr("md-mode",n()).toggleClass("_md-progress-linear-disabled",q);l();h()}return{restrict:"E",template:'<div class="md-container"><div class="md-dashed"></div><div class="md-bar md-bar1"></div><div class="md-bar md-bar2"></div></div>',
...
function mdRadioGroupDirective(a,b,d,c){function e(l,n,v,m){function q(){n.hasClass("md-focused")||n.addClass("md-focused")}function r(y){var k=y.which||y.keyCode;if(k==b.KEY_CODE.ENTER||y.currentTarget==y.target)switch(k){case b.KEY_CODE.LEFT_ARROW:case b.KEY_CODE.UP_ARROW:y.preventDefault();x.selectPrevious();q();break;case b.KEY_CODE.RIGHT_ARROW:case b.KEY_CODE.DOWN_ARROW:y.preventDefault();x.selectNext();q();break;case b.KEY_CODE.ENTER:y=angular.element(a.getClosest(n[0],"form")),0<y.length&&
y.triggerHandler("submit")}}n.addClass("_md");d(n);var x=m[0];v=m[1]||a.fakeNgModel();x.init(v);l.mouseActive=!1;n.attr({role:"radiogroup",tabIndex:n.attr("tabindex")||"0"}).on("keydown",r).on("mousedown",function(){l.mouseActive=!0;c(function(){l.mouseActive=!1},100)}).on("focus",function(){!1===l.mouseActive&&x.$element.addClass("md-focused")}).on("blur",function(){x.$element.removeClass("md-focused")})}function f(l){this._radioButtonRenderFns=[];this.$element=l}function g(){return{init:function(l){this._ngModelCtrl=
l;this._ngModelCtrl.$render=angular.bind(this,this.render)},add:function(l){this._radioButtonRenderFns.push(l)},remove:function(l){l=this._radioButtonRenderFns.indexOf(l);-1!==l&&this._radioButtonRenderFns.splice(l,1)},render:function(){this._radioButtonRenderFns.forEach(function(l){l()})},setViewValue:function(l,n){this._ngModelCtrl.$setViewValue(l,n);this.render()},getViewValue:function(){return this._ngModelCtrl.$viewValue},selectNext:function(){return h(this.$element,1)},selectPrevious:function(){return h(this.$element,
-1)},setActiveDescendant:function(l){this.$element.attr("aria-activedescendant",l)},isDisabled:function(){return this.$element[0].hasAttribute("disabled")}}}function h(l,n){var v=a.iterator(l[0].querySelectorAll("md-radio-button"),!0);if(v.count()){var m=function(q){return!angular.element(q).attr("disabled")};l=l[0].querySelector("md-radio-button.md-checked");n=v[0>n?"previous":"next"](l,m)||v.first();angular.element(n).triggerHandler("click")}}f.prototype=g();return{restrict:"E",controller:["$element",
f],require:["mdRadioGroup","?ngModel"],link:{pre:e}}}
function mdRadioButtonDirective(a,b,d){function c(e,f,g,h){function l(){if(!h)throw"RadioButton: No RadioGroupController could be found.";h.add(v);g.$observe("value",v);f.on("click",n).on("$destroy",function(){h.remove(v)})}function n(r){f[0].hasAttribute("disabled")||h.isDisabled()||e.$apply(function(){h.setViewValue(g.value,r&&r.type)})}function v(){var r=h.getViewValue()==g.value;r!==q&&("md-radio-group"!==f[0].parentNode.nodeName.toLowerCase()&&f.parent().toggleClass("md-checked",r),r&&h.setActiveDescendant(f.attr("id")),
q=r,f.attr("aria-checked",r).toggleClass("md-checked",r))}function m(r){r.attr({id:g.id||"radio_"+b.nextUid(),role:"radio","aria-checked":"false"});a.expectWithText(r,"aria-label")}var q;d(f);m(f,e);g.ngValue?b.nextTick(l,!1):l()}return{restrict:"E",require:"^mdRadioGroup",transclude:!0,template:'<div class="md-container" md-ink-ripple md-ink-ripple-checkbox><div class="md-off"></div><div class="md-on"></div></div><div ng-transclude class="md-label"></div>',link:c}}
...
function SelectDirective(a,b,d,c,e,f,g){function h(l,n){var v=angular.element("<md-select-value><span></span></md-select-value>");v.append('<span class="md-select-icon" aria-hidden="true"></span>');v.addClass("md-select-value");v[0].hasAttribute("id")||v.attr("id","select_value_label_"+b.nextUid());var m=l.find("md-content");m.length||l.append(angular.element("<md-content>").append(l.contents()));m.attr("role","presentation");n.mdOnOpen&&(l.find("md-content").prepend(angular.element('<div> <md-progress-circular md-mode="indeterminate" ng-if="$$loadingAsyncDone === false" md-diameter="25px"></md-progress-circular></div>')),
l.find("md-option").attr("ng-show","$$loadingAsyncDone"));if(n.name){var q=angular.element('<select class="md-visually-hidden"></select>');q.attr({name:n.name,"aria-hidden":"true",tabindex:"-1"});m=l.find("md-option");angular.forEach(m,function(y){var k=angular.element("<option>"+y.innerHTML+"</option>");y.hasAttribute("ng-value")?k.attr("ng-value",y.getAttribute("ng-value")):y.hasAttribute("value")&&k.attr("value",y.getAttribute("value"));q.append(k)});q.append('<option ng-value="'+n.ngModel+'" selected></option>');
l.parent().append(q)}var r=b.parseAttributeBoolean(n.multiple);m=r?"multiple":"";var x='<div class="md-select-menu-container" aria-hidden="true" role="presentation"><md-select-menu role="presentation" {0}>{1}</md-select-menu></div>';x=b.supplant(x,[m,l.html()]);l.empty().append(v);l.append(x);n.tabindex||n.$set("tabindex",0);return function(y,k,p,t){function H(){J&&(T=T||J.find("md-select-menu").controller("mdSelectMenu"),F.setLabelText(T.selectedLabels()))}function A(){if(N){var U=T.selectedLabels({mode:"aria"});
k.attr("aria-label",U.length?N+": "+U:N)}}function w(){b.nextTick(function(){C&&C.setHasValue(0<T.selectedLabels().length||(k[0].validity||{}).badInput)})}function B(){J=angular.element(k[0].querySelector(".md-select-menu-container"));Q=y;if(p.mdContainerClass){var U=J[0].getAttribute("class")+" "+p.mdContainerClass;J[0].setAttribute("class",U)}T=J.find("md-select-menu").controller("mdSelectMenu");T.init(O,p.ngModel);k.on("$destroy",function(){J.remove()})}function u(U){d.isNavigationKey(U)?(U.preventDefault(),
...
I=function(){C&&C.setFocused(!0)},k.on("focus",I),k.on("blur",t));F.triggerClose=function(){f(p.mdOnClose)(y)};y.$$postDigest(function(){var U=k.attr("aria-label")||k.attr("placeholder");!U&&C&&C.label&&(U=C.label.text());N=U;e.expect(k,"aria-label",U);H();A()});y.$watch(function(){return T.selectedLabels()},H);var R;p.$observe("ngMultiple",function(U){R&&R();var X=f(U);R=y.$watch(function(){return X(y)},function(aa,ha){if(void 0!==aa||void 0!==ha)aa?k.attr("multiple","multiple"):k.removeAttr("multiple"),
k.attr("aria-multiselectable",aa?"true":"false"),J&&(T.setMultiple(aa),Y=O.$render,O.$render=function(){Y();H();A();w()},O.$render())})});p.$observe("disabled",function(U){angular.isString(U)&&(U=!0);if(void 0===G||G!==U)if(G=U)k.attr({"aria-disabled":"true"}).removeAttr("tabindex").off("click",z).off("keydown",u);else k.attr({tabindex:p.tabindex,"aria-disabled":"false"}).on("click",z).on("keydown",u)});p.hasOwnProperty("disabled")||p.hasOwnProperty("ngDisabled")||(k.attr({"aria-disabled":"false"}),
...
function SelectMenuDirective(a,b,d,c){function e(g,h,l,n){function v(r){13!=r.keyCode&&32!=r.keyCode||m(r)}function m(r){var x=b.getClosest(r.target,"md-option"),y=x&&angular.element(x).data("$mdOptionController");if(x&&y){if(x.hasAttribute("disabled"))return r.stopImmediatePropagation(),!1;var k=q.hashGetter(y.value),p=angular.isDefined(q.selected[k]);g.$apply(function(){q.isMultiple?p?q.deselect(k):q.select(k,y.value):p||(q.deselect(Object.keys(q.selected)[0]),q.select(k,y.value));q.refreshViewValue()})}}
var q=n[0];h.addClass("_md");c(h);h.on("click",m);h.on("keypress",v)}function f(g,h,l){function n(){var p=m.ngModel.$modelValue||m.ngModel.$viewValue||[];if(angular.isArray(p)){var t=Object.keys(m.selected),H=p.map(m.hashGetter);t=t.filter(function(A){return-1===H.indexOf(A)});t.forEach(m.deselect);H.forEach(function(A,w){m.select(A,p[w])})}}function v(){var p=m.ngModel.$viewValue||m.ngModel.$modelValue;Object.keys(m.selected).forEach(m.deselect);m.select(m.hashGetter(p),p)}var m=this;m.isMultiple=
angular.isDefined(h.multiple);m.selected={};m.options={};g.$watchCollection(function(){return m.options},function(){m.ngModel.$render()});var q;m.setMultiple=function(p){function t(B,u){return angular.isArray(B||u||[])}var H=m.ngModel;m.isMultiple=p;q&&q();if(m.isMultiple){var A=!1,w=function(B){A?n(B):b.nextTick(function(){n(B);A=!0})};H.$validators["md-multiple"]=t;H.$render=w;g.$watchCollection(m.modelBinding,function(B){t(B)&&w(B)});H.$isEmpty=function(B){return!B||0===B.length}}else delete H.$validators["md-multiple"],
H.$render=v};var r="",x,y,k;m.optNodeForKeyboardSearch=function(p){x&&clearTimeout(x);x=setTimeout(function(){x=void 0;r="";y=k=void 0},300);r+=p.key;p=new RegExp("^"+r,"i");y||(y=l.find("md-option"),k=Array(y.length),angular.forEach(y,function(H,A){k[A]=H.textContent.trim()}));for(var t=0;t<k.length;++t)if(p.test(k[t]))return y[t]};m.init=function(p,t){m.ngModel=p;m.modelBinding=t;m.ngModel.$isEmpty=function(w){return!m.options[m.hashGetter(w)]};if(p=b.getModelOption(p,"trackBy")){var H={},A=a(p);
m.hashGetter=function(w,B){H.$value=w;return A(B||g,H)}}else m.hashGetter=function(w){return angular.isObject(w)?"object_"+(w.$$mdSelectId||(w.$$mdSelectId=++selectNextId)):w};m.setMultiple(m.isMultiple)};m.selectedLabels=function(p){p=p||{};p=p.mode||"html";var t=b.nodesToArray(l[0].querySelectorAll("md-option[selected]"));if(t.length){var H;"html"==p?H=function(A){if(A.hasAttribute("md-option-empty"))return"";var w=A.innerHTML,B=A.querySelector(".md-ripple-container");B&&(w=w.replace(B.outerHTML,
""));(A=A.querySelector(".md-container"))&&(w=w.replace(A.outerHTML,""));return w}:"aria"==p&&(H=function(A){return A.hasAttribute("aria-label")?A.getAttribute("aria-label"):A.textContent});return b.uniq(t.map(H)).join(", ")}return""};m.select=function(p,t){var H=m.options[p];H&&H.setSelected(!0);m.selected[p]=t};m.deselect=function(p){var t=m.options[p];t&&t.setSelected(!1);delete m.selected[p]};m.addOption=function(p,t){if(angular.isDefined(m.options[p]))throw Error('Duplicate md-option values are not allowed in a select. Duplicate value "'+
t.value+'" found.');m.options[p]=t;angular.isDefined(m.selected[p])&&(m.select(p,t.value),angular.isDefined(m.ngModel.$$rawModelValue)&&m.hashGetter(m.ngModel.$$rawModelValue)===p&&m.ngModel.$validate(),m.refreshViewValue())};m.removeOption=function(p){delete m.options[p]};m.refreshViewValue=function(){var p=[],t;for(H in m.selected)(t=m.options[H])?p.push(t.value):p.push(m.selected[H]);t=b.getModelOption(m.ngModel,"trackBy");p=m.isMultiple?p:p[0];var H=m.ngModel.$modelValue;(t?angular.equals(H,p):
H+""===p)||(m.ngModel.$setViewValue(p),m.ngModel.$render())}}f.$inject=["$scope","$attrs","$element"];return{restrict:"E",require:["mdSelectMenu"],scope:!1,controller:f,link:{pre:e}}}
function OptionDirective(a,b,d){function c(g,h){g.append(angular.element('<div class="md-text">').append(g.contents()));g.attr("tabindex",h.tabindex||"0");var l=h.value;h=h.ngValue;(l=l||h)||g.attr("md-option-empty","");return e}function e(g,h,l,n){function v(x,y,k){if(r.hashGetter){k=r.hashGetter(y,g);var p=r.hashGetter(x,g);q.hashKey=p;q.value=x;r.removeOption(k,q);r.addOption(p,q)}else k||g.$$postDigest(function(){v(x,y,!0)})}function m(){var x={role:"option","aria-selected":"false"};h[0].hasAttribute("id")||
(x.id="select_option_"+b.nextUid());h.attr(x)}var q=n[0],r=n[1];d(h);r.isMultiple&&(h.addClass("md-checkbox-enabled"),h.prepend(CHECKBOX_SELECTION_INDICATOR.clone()));angular.isDefined(l.ngValue)?g.$watch(l.ngValue,v):angular.isDefined(l.value)?v(l.value):g.$watch(function(){return h.text().trim()},v);l.$observe("disabled",function(x){x?h.attr("tabindex","-1"):h.attr("tabindex","0")});g.$$postDigest(function(){l.$observe("selected",function(x){angular.isDefined(x)&&("string"==typeof x&&(x=!0),x?(r.isMultiple||
r.deselect(Object.keys(r.selected)[0]),r.select(q.hashKey,q.value)):r.deselect(q.hashKey),r.refreshViewValue())})});a.attach(g,h);m();g.$on("$destroy",function(){r.removeOption(q.hashKey,q)})}function f(g){this.selected=!1;this.setSelected=function(h){h&&!this.selected?g.attr({selected:"selected","aria-selected":"true"}):!h&&this.selected&&(g.removeAttr("selected"),g.attr("aria-selected","false"));this.selected=h}}f.$inject=["$element"];return{restrict:"E",require:["mdOption","^^mdSelectMenu"],controller:f,
compile:c}}function OptgroupDirective(){function a(b,d){if(!b.parent().find("md-select-header").length){var c=b.find("label");c.length||(c=angular.element("<label>"),b.prepend(c));c.addClass("md-container-ignore");c.attr("aria-hidden","true");d.label&&c.text(d.label)}}return{restrict:"E",compile:a}}function SelectHeaderDirective(){return{restrict:"E"}}
function SelectProvider(a){function b(d,c,e,f,g,h,l,n,v){function m(k,p,t){function H(){w();p.removeClass("md-active").attr("aria-hidden","true").css({display:"none",top:"",right:"",bottom:"",left:"","font-size":"","min-width":""});p.parent().find("md-select-value").removeAttr("aria-hidden");var B=t.selectCtrl;if(B){var u=t.selectEl.controller("mdSelectMenu");B.setLabelText(u?u.selectedLabels():"");B.triggerClose()}!t.$destroy&&t.restoreFocus&&t.target.focus()}var A=null,w=k.$on("$destroy",function(){A.end()});
t=t||{};t.cleanupInteraction();t.cleanupResizing();t.hideBackdrop();!0===t.$destroy?k=H():(A=l(p,{addClass:"md-leave"}),k=A.start(),k=k.then(H));return k}function q(k,p,t){function H(N,C,F){F.parent!==C.parent()&&C.parent().attr("aria-owns",C.attr("id"));C.parent().find("md-select-value").attr("aria-hidden","true");F.parent.append(C);return g(function(O,S){try{l(C,{removeClass:"md-leave",duration:0}).start().then(A).then(O)}catch(K){S(K)}})}function A(){return g(function(N){if(t.isRemoved)return g.reject(!1);
...
(M=S.controller("mdSelectMenu").optNodeForKeyboardSearch(M),t.focusedNode=M||t.focusedNode,M&&M.focus())}}function F(M){var I=e.nodesToArray(t.optionNodes),J=I.indexOf(t.focusedNode);do{-1===J?J=0:"next"===M&&J<I.length-1?J++:"prev"===M&&0<J&&J--;var Q=I[J];Q.hasAttribute("disabled")&&(Q=void 0)}while(!Q&&J<I.length-1&&0<J);Q&&Q.focus();t.focusedNode=Q}function O(M){function I(){var Q=!1;if(M&&0<M.currentTarget.children.length){var T=M.currentTarget.children[0],Y=T.scrollHeight>T.clientHeight;Y&&
0<T.children.length&&(Y=M.pageX-M.currentTarget.getBoundingClientRect().left,Y>T.querySelector("md-option").offsetWidth&&(Q=!0))}return Q}if(!(M&&"click"==M.type&&M.currentTarget!=S[0]||I())){var J=e.getClosest(M.target,"md-option");J&&J.hasAttribute&&!J.hasAttribute("disabled")&&(M.preventDefault(),M.stopPropagation(),K.isMultiple||(t.restoreFocus=!0,e.nextTick(function(){d.hide(K.ngModel.$viewValue)},!0)))}}if(!t.isRemoved){var S=t.selectEl,K=S.controller("mdSelectMenu")||{};p.addClass("md-clickable");
...
themable:!0,onShow:q,onRemove:m,hasBackdrop:!0,disableParentScroll:!0}}b.$inject="$mdSelect $mdConstant $mdUtil $window $q $$rAF $animateCss $animate $document".split(" ");return a("$mdSelect").setDefaults({methods:["target"],options:b})}function shouldHandleKey(a,b){var d=String.fromCharCode(a.keyCode),c=31>=a.keyCode;return d&&d.length&&!c&&!b.isMetaKey(a)&&!b.isFnLockKey(a)&&!b.hasModifierKey(a)}ngmaterial.components.select=angular.module("material.components.select");SidenavService.$inject=["$mdComponentRegistry","$mdUtil","$q","$log"];SidenavDirective.$inject="$mdMedia $mdUtil $mdConstant $mdTheming $mdInteraction $animate $compile $parse $log $q $document $window $$rAF".split(" ");SidenavController.$inject=["$scope","$attrs","$mdComponentRegistry","$q","$interpolate"];
...
function SliderContainerDirective(){return{controller:function(){},compile:function(a){var b=a.find("md-slider");if(b){var d=b.attr("md-vertical");void 0!==d&&a.attr("md-vertical","");b.attr("flex")||b.attr("flex","");return function(c,e,f,g){function h(v){e.children().attr("disabled",v);e.find("input").attr("disabled",v)}e.addClass("_md");var l=angular.noop;f.disabled?h(!0):f.ngDisabled&&(l=c.$watch(f.ngDisabled,function(v){h(v)}));c.$on("$destroy",function(){l()});var n;g.fitInputWidthToTextLength=
function(v){var m=e[0].querySelector("md-input-container");if(m){var q=getComputedStyle(m),r=parseInt(q.minWidth),x=parseInt(q.paddingLeft)+parseInt(q.paddingRight);n=n||parseInt(q.maxWidth);v=Math.max(n,r+x+r/2*v);m.style.maxWidth=v+"px"}}}}}}}
function SliderDirective(a,b,d,c,e,f,g,h,l,n){function v(q,r){var x=angular.element(q[0].getElementsByClassName("md-slider-wrapper")),y=r.tabindex||0;x.attr("tabindex",y);(r.disabled||r.ngDisabled)&&x.attr("tabindex",-1);x.attr("role","slider");d.expect(q,"aria-label");return m}function m(q,r,x,y){function k(){u();S()}function p(E){W=parseFloat(E);ea.$viewValue=K(ea.$modelValue,W,ya);ma.attr("aria-valuemin",E);k()}function t(E){ya=parseFloat(E);ea.$viewValue=K(ea.$modelValue,W,ya);ma.attr("aria-valuemax",
E);k()}function H(E){va=parseFloat(E)}function A(E){L=K(parseInt(E),0,6)}function w(){r.attr("aria-disabled",!!da())}function B(){if(Ia&&!da()&&!angular.isUndefined(va)){if(0>=va)throw l.error("Slider step value must be greater than zero when in discrete mode"),Error("Slider step value must be greater than zero when in discrete mode");var E=Math.floor((ya-W)/va);ua||(ua=angular.element("<canvas>").css("position","absolute"),Aa.append(ua),qa=ua[0].getContext("2d"));var P=z();!P||P.height||P.width||
...
case P.PAGE_DOWN:E.preventDefault();Z=-va*stepPageSize;break;case P.PAGE_UP:E.preventDefault();Z=va*stepPageSize;break;case P.HOME:E.preventDefault();E.stopPropagation();G(W);break;case P.END:E.preventDefault(),E.stopPropagation(),G(ya)}if(Z){Z=xa?-Z:Z;if(E.metaKey||E.ctrlKey||E.altKey)Z*=modifierMultiplier;E.preventDefault();E.stopPropagation();G(ea.$viewValue+Z)}}}function G(E){q.$evalAsync(function(){O(E)})}function N(){B();q.mouseActive=!0;ma.removeClass("md-focused");n(function(){q.mouseActive=
!1},100)}function C(){!1===q.mouseActive&&ma.addClass("md-focused")}function F(){ma.removeClass("md-focused");r.removeClass("md-active");if(ua&&qa){var E=z();qa.clearRect(0,0,E.width,E.height)}}function O(E){ea.$setViewValue(K(M(E)))}function S(){isNaN(ea.$viewValue)&&(ea.$viewValue=ea.$modelValue);ea.$viewValue=K(ea.$viewValue);var E=fa(ea.$viewValue);q.modelValue=ea.$viewValue;ma.attr("aria-valuenow",ea.$viewValue);I(E);la.text(ea.$viewValue)}function K(E,P,Z){if(angular.isNumber(E))return P=angular.isNumber(P)?
P:W,Z=angular.isNumber(Z)?Z:ya,Math.max(P,Math.min(Z,E))}function M(E){if(angular.isNumber(E)){var P=Math.round((E-W)/va)*va+W;P=Math.round(P*Math.pow(10,L))/Math.pow(10,L);ca&&ca.fitInputWidthToTextLength&&c.debounce(function(){ca.fitInputWidthToTextLength(P.toString().length)},100)();return P}}function I(E){E=Math.max(0,Math.min(E||0,1));var P=100*E+"%",Z=xa?100*(1-E)+"%":P;oa?pa.css("bottom",P):c.bidiProperty(pa,"left","right",P);wa.css(oa?"height":"width",Z);r.toggleClass(xa?"md-max":"md-min",
0===E);r.toggleClass(xa?"md-min":"md-max",1===E)}function J(E){if(!da()){r.addClass("md-active");r[0].focus();u();E=ha(aa(oa?E.pointer.y:E.pointer.x));var P=K(M(E));q.$apply(function(){O(P);I(fa(P))})}}function Q(E){if(!da()){r.removeClass("md-dragging");E=ha(aa(oa?E.pointer.y:E.pointer.x));var P=K(M(E));q.$apply(function(){O(P);S()})}}function T(E){da()||(sa=!0,E.stopPropagation(),r.addClass("md-dragging"),U(E))}function Y(E){sa&&(E.stopPropagation(),U(E))}function R(E){sa&&(E.stopPropagation(),
...
function MdSticky(a,b,d,c){function e(h){function l(t,H){H.addClass("md-sticky-clone");var A={element:t,clone:H};p.items.push(A);d.nextTick(function(){y.prepend(A.clone)});k();return function(){p.items.forEach(function(w,B){w.element[0]===t[0]&&(p.items.splice(B,1),w.clone.remove())});k()}}function n(){p.items.forEach(v);p.items=p.items.sort(function(w,B){return w.top<B.top?-1:1});for(var t,H=y.prop("scrollTop"),A=p.items.length-1;0<=A;A--)if(H>p.items[A].top){t=p.items[A];break}q(t)}function v(t){var H=
t.element[0];t.top=0;t.left=0;for(t.right=0;H&&H!==y[0];)t.top+=H.offsetTop,t.left+=H.offsetLeft,H.offsetParent&&(t.right+=H.offsetParent.offsetWidth-H.offsetWidth-H.offsetLeft),H=H.offsetParent;t.height=t.element.prop("offsetHeight");H=d.floatingScrollbars()?"0":void 0;d.bidi(t.clone,"margin-left",t.left,H);d.bidi(t.clone,"margin-right",H,t.right)}function m(){var t=y.prop("scrollTop"),H=t>(m.prevScrollTop||0);m.prevScrollTop=t;if(0===t)q(null);else{if(H){if(p.next&&p.next.top<=t){q(p.next);return}if(p.current&&
...
H){t&&t.state!==H&&(t.state&&(t.clone.attr("sticky-prev-state",t.state),t.element.attr("sticky-prev-state",t.state)),t.clone.attr("sticky-state",H),t.element.attr("sticky-state",H),t.state=H)}function x(t,H){t&&(null===H||void 0===H?t.translateY&&(t.translateY=null,t.clone.css(a.CSS.TRANSFORM,"")):(t.translateY=H,d.bidi(t.clone,a.CSS.TRANSFORM,"translate3d("+t.left+"px,"+H+"px,0)","translateY("+H+"px)")))}var y=h.$element,k=b.throttle(n);f(y);y.on("$scrollstart",k);y.on("$scroll",m);var p;return p=
{prev:null,current:null,next:null,items:[],add:l,refreshElements:n}}function f(h){function l(){200<+d.now()-v?(n=!1,h.triggerHandler("$scrollend")):(h.triggerHandler("$scroll"),b.throttle(l))}var n,v;h.on("scroll touchmove",function(){n||(n=!0,b.throttle(l),h.triggerHandler("$scrollstart"));h.triggerHandler("$scroll");v=+d.now()})}var g=d.checkStickySupport();return function(h,l,n){var v=l.controller("mdContent");if(v)if(g)l.css({position:g,top:0,"z-index":2});else{var m=v.$element.data("$$sticky");
m||(m=e(v),v.$element.data("$$sticky",m));n=n||c(l.clone())(h);l=m.add(l,n);h.$on("$destroy",l)}}}ngmaterial.components.sticky=angular.module("material.components.sticky");MdSubheaderDirective.$inject=["$mdSticky","$compile","$mdTheming","$mdUtil","$mdAria"];angular.module("material.components.subheader",["material.core","material.components.sticky"]).directive("mdSubheader",MdSubheaderDirective);
function MdSubheaderDirective(a,b,d,c,e){return{restrict:"E",replace:!0,transclude:!0,template:'<div class="md-subheader _md">  <div class="md-subheader-inner">    <div class="md-subheader-content"></div>  </div></div>',link:function(f,g,h,l,n){function v(q){return angular.element(q[0].querySelector(".md-subheader-content"))}d(g);g.addClass("_md");c.prefixer().removeAttribute(g,"ng-repeat");var m=g[0].outerHTML;h.$set("role","heading");e.expect(g,"aria-level","2");n(f,function(q){v(g).append(q)});
g.hasClass("md-no-sticky")||n(f,function(q){var r=b('<div class="md-subheader-wrapper" aria-hidden="true">'+m+"</div>")(f);c.nextTick(function(){v(r).append(q)});a(f,g,r)})}}}ngmaterial.components.subheader=angular.module("material.components.subheader");angular.module("material.components.swipe",["material.core"]).directive("mdSwipeLeft",getDirective("SwipeLeft")).directive("mdSwipeRight",getDirective("SwipeRight")).directive("mdSwipeUp",getDirective("SwipeUp")).directive("mdSwipeDown",getDirective("SwipeDown"));
function getDirective(a){function b(e){function f(g,h,l){var n=e(l[d]);h.on(c,function(v){var m=v.currentTarget;g.$applyAsync(function(){n(g,{$event:v,$target:{current:m}})})})}return{restrict:"A",link:f}}b.$inject=["$parse"];var d="md"+a,c="$md."+a.toLowerCase();return b}ngmaterial.components.swipe=angular.module("material.components.swipe");MdSwitch.$inject="mdCheckboxDirective $mdUtil $mdConstant $parse $$rAF $mdGesture $timeout".split(" ");angular.module("material.components.switch",["material.core","material.components.checkbox"]).directive("mdSwitch",MdSwitch);
function MdSwitch(a,b,d,c,e,f,g){function h(n,v){var m=l.compile(n,v).post;n.addClass("md-dragging");return function(q,r,x,y){function k(G){w&&w(q)||(G.stopPropagation(),r.addClass("md-dragging"),D={width:B.prop("offsetWidth")})}function p(G){D&&(G.stopPropagation(),G.srcEvent&&G.srcEvent.preventDefault(),G=G.pointer.distanceX/D.width,G=A.$viewValue?1+G:G,G=Math.max(0,Math.min(1,G)),B.css(d.CSS.TRANSFORM,"translate3d("+100*G+"%,0,0)"),D.translate=G)}function t(G){D&&(G.stopPropagation(),r.removeClass("md-dragging"),
B.css(d.CSS.TRANSFORM,""),(G=A.$viewValue?.5>D.translate:.5<D.translate)&&H(!A.$viewValue),D=null,q.skipToggle=!0,g(function(){q.skipToggle=!1},1))}function H(G){q.$apply(function(){A.$setViewValue(G);A.$render()})}var A=y[1]||b.fakeNgModel(),w=null;null!=x.disabled?w=function(){return!0}:x.ngDisabled&&(w=c(x.ngDisabled));var B=angular.element(r[0].querySelector(".md-thumb-container")),u=angular.element(r[0].querySelector(".md-container")),z=angular.element(r[0].querySelector(".md-label"));e(function(){r.removeClass("md-dragging")});
m(q,r,x,y);w&&q.$watch(w,function(G){r.attr("tabindex",G?-1:0)});x.$observe("mdInvert",function(G){(G=b.parseAttributeBoolean(G))?r.prepend(z):r.prepend(u);r.toggleClass("md-inverted",G)});f.register(u,"drag");u.on("$md.dragstart",k).on("$md.drag",p).on("$md.dragend",t);var D}}var l=a[0];return{restrict:"E",priority:d.BEFORE_NG_ARIA,transclude:!0,template:'<div class="md-container"><div class="md-bar"></div><div class="md-thumb-container"><div class="md-thumb" md-ink-ripple md-ink-ripple-checkbox></div></div></div><div ng-transclude class="md-label"></div>',
...
function MdTab(){function a(d,c,e,f){if(f){e=f.getTabElementIndex(c);var g=b(c,"md-tab-body").remove(),h=b(c,"md-tab-label").remove(),l=f.insertTab({scope:d,parent:d.$parent,index:e,element:c,template:g.html(),label:h.html()},e);d.select=d.select||angular.noop;d.deselect=d.deselect||angular.noop;d.$watch("active",function(n){n&&f.select(l.getIndex(),!0)});d.$watch("disabled",function(){f.refreshIndex()});d.$watch(function(){return f.getTabElementIndex(c)},function(n){l.index=n;f.updateTabOrder()});
d.$on("$destroy",function(){f.removeTab(l)})}}function b(d,c){d=d[0].children;for(var e=0,f=d.length;e<f;e++){var g=d[e];if(g.tagName===c.toUpperCase())return angular.element(g)}return angular.element()}return{require:"^?mdTabs",terminal:!0,compile:function(d,c){var e=b(d,"md-tab-label"),f=b(d,"md-tab-body");0===e.length&&(e=angular.element("<md-tab-label></md-tab-label>"),c.label?e.text(c.label):e.append(d.contents()),0===f.length&&(c=d.contents().detach(),f=angular.element("<md-tab-body></md-tab-body>"),
...
function MdTabsController(a,b,d,c,e,f,g,h,l,n,v,m,q){function r(){k("stretchTabs",H);ca("focusIndex",D,L.selectedIndex||0);ca("offsetLeft",z,0);ca("hasContent",u,!1);ca("maxTabWidth",w,pa());ca("shouldPaginate",B,!1);p("noInkBar",J);p("dynamicHeight",Q);p("noPagination");p("swipeContent");p("noDisconnect");p("autoselect");p("noSelectClick");p("centerTabs",A,!1);p("enableDisconnect");L.scope=a;L.parent=a.$parent;L.tabs=[];L.lastSelectedIndex=null;L.hasFocus=!1;L.styleTabItemFocus=!1;L.shouldCenterTabs=
L.centerTabs&&!L.shouldPaginate;L.tabContentPrefix="tab-content-";L.navigationHint="Use the left and right arrow keys to navigate between tabs";x()}function x(){L.selectedIndex=L.selectedIndex||0;y();a.$watch("$mdTabsCtrl.selectedIndex",G);angular.element(d).on("resize",I);a.$on("$destroy",t);n(b);f.nextTick(function(){xa();ma();Fa();L.tabs[L.selectedIndex]&&L.tabs[L.selectedIndex].scope.select();sa=!0;da()})}function y(){var E=h.$mdTabsTemplate,P=angular.element(b[0].querySelector("md-tab-data"));
P.html(E);l(P.contents())(L.parent);delete h.$mdTabsTemplate}function k(E,P){var Z=h.$normalize("md-"+E);P&&ca(E,P);h.$observe(Z,function(ja){L[E]=ja})}function p(E,P){function Z(na){L[E]="false"!==na}var ja=h.$normalize("md-"+E);P&&ca(E,P);h.hasOwnProperty(ja)&&Z(h[ja]);h.$observe(ja,Z)}function t(){ta=!0;angular.element(d).off("resize",I)}function H(){var E=R();angular.element(E.wrapper).toggleClass("md-stretch-tabs",ha());Fa()}function A(){L.shouldCenterTabs=L.centerTabs&&!L.shouldPaginate}function w(E,
...
var P=0>E;f.msie&&(P?R().paging.style.width="999999px":R().paging.style.width=void 0);return P}function ea(E){if(-1===E)return-1;var P=Math.max(L.tabs.length-E,E),Z,ja;for(Z=0;Z<=P;Z++)if((ja=L.tabs[E+Z])&&!0!==ja.scope.disabled||(ja=L.tabs[E-Z])&&!0!==ja.scope.disabled)return ja.getIndex();return E}function ca(E,P,Z){Object.defineProperty(L,E,{get:function(){return Z},set:function(ja){var na=Z;Z=ja;P&&P(ja,na)}})}function da(){L.maxTabWidth=pa();L.shouldPaginate=fa()}function la(E){var P=0;angular.forEach(E,
...
L.tabs.length;L.tabs[P]&&(L[Z]=P)}function Aa(){L.styleTabItemFocus="keyboard"===v.getLastInteractionType();var E=R().tabs[L.focusIndex];E&&E.focus()}function ma(E){var P=R();angular.isNumber(E)||(E=L.focusIndex);if(P.tabs[E]&&!L.shouldCenterTabs){var Z=P.tabs[E],ja=Z.offsetLeft;Z=Z.offsetWidth+ja;0===E?L.offsetLeft=0:f.isRtl(h)?(ja=la(Array.prototype.slice.call(P.tabs,0,E)),E=la(Array.prototype.slice.call(P.tabs,0,E+1)),L.offsetLeft=Math.min(L.offsetLeft,W(ja)),L.offsetLeft=Math.max(L.offsetLeft,
...
function MdTabsTemplate(a,b){function d(c,e,f,g){function h(){c.$watch("connected",function(v){!1===v?g.enableDisconnect&&b.disconnectScope(n):l()});c.$on("$destroy",l)}function l(){g.enableDisconnect&&b.reconnectScope(n)}if(g){var n=g.enableDisconnect?c.compileScope.$new():c.compileScope;e.html(c.template);a(e.contents())(n);return b.nextTick(h)}}return{restrict:"A",link:d,scope:{template:"=mdTabsTemplate",connected:"=?mdConnectedIf",compileScope:"=mdScope"},require:"^?mdTabs"}}
...
function(){l.content=e});this.resolve=function(){f.hide("ok")}}}function c(f,g,h,l,n){function v(x,y,k){e=k.textContent||k.content;var p=!l("gt-sm");y=h.extractElementByName(y,"md-toast",!0);k.element=y;k.onSwipe=function(t){t=t.type.replace("$md.","");var H=t.replace("swipe","");"down"===H&&-1!==k.position.indexOf("top")&&!p||"up"===H&&(-1!==k.position.indexOf("bottom")||p)||("left"===H||"right"===H)&&p||(y.addClass("md-"+t),h.nextTick(g.cancel))};k.openClass=q(k.position);y.addClass(k.toastClass);
k.parent.addClass(k.openClass);h.hasComputedStyle(k.parent,"position","static")&&k.parent.css("position","relative");r(x.toast&&x.toast.actionKey?x.toast.actionKey:void 0);y.on("$md.swipeleft $md.swiperight $md.swipeup $md.swipedown",k.onSwipe);y.addClass(p?"md-bottom":k.position.split(" ").map(function(t){return"md-"+t}).join(" "));k.parent&&k.parent.addClass("md-toast-animating");return f.enter(y,k.parent).then(function(){k.parent&&k.parent.removeClass("md-toast-animating")})}function m(x,y,k){x.toast&&
x.toast.actionKey&&n.off("keydown");y.off("$md.swipeleft $md.swiperight $md.swipeup $md.swipedown",k.onSwipe);k.parent&&k.parent.addClass("md-toast-animating");k.openClass&&k.parent.removeClass(k.openClass);return(!0===k.$destroy?y.remove():f.leave(y)).then(function(){k.parent&&k.parent.removeClass("md-toast-animating");h.hasComputedStyle(k.parent,"position","static")&&k.parent.css("position","")})}function q(x){return l("gt-xs")?"md-toast-open-"+(-1<x.indexOf("top")?"top":"bottom"):"md-toast-open-bottom"}
function r(x){var y=function(k){"Escape"===k.key&&g.hide(!1);x&&k.key===x&&k.ctrlKey&&g.hide("ok")};n.on("keydown",y)}return{onShow:v,onRemove:m,toastClass:"",position:"bottom left",themable:!0,hideDelay:3E3,autoWrap:!0,transformTemplate:function(x,y){if(y=y.autoWrap&&x&&!/md-toast-content/g.test(x)){y=document.createElement("md-template");y.innerHTML=x;for(x=0;x<y.children.length;x++)if("MD-TOAST"===y.children[x].nodeName){var k=angular.element('<div class="md-toast-content">');k.append(angular.element(y.children[x].childNodes));
...
function mdToolbarDirective(a,b,d,c,e){var f=angular.bind(null,d.supplant,"translate3d(0,{0}px,0)");return{template:"",restrict:"E",link:function(g,h,l){function n(){function v(u){var z=h.parent().find("md-content");!k&&z.length&&m(null,z);u=g.$eval(u);!1===u?p():p=r()}function m(u,z){z&&h.parent()[0]===z.parent()[0]&&(k&&k.off("scroll",w),k=z,p=r())}function q(u){u=u?u.target.scrollTop:H;B();t=Math.min(y/A,Math.max(0,t+u-H));h.css(b.CSS.TRANSFORM,f([-t*A]));k.css(b.CSS.TRANSFORM,f([(y-t)*A]));H=
...
5E3);g.$on("$mdContentLoaded",m);l.$observe("mdScrollShrink",v);l.ngShow&&g.$watch(l.ngShow,x);l.ngHide&&g.$watch(l.ngHide,x);g.$on("$destroy",p)}h.addClass("_md");c(h);d.nextTick(function(){h.addClass("_md-toolbar-transitions")},!1);angular.isDefined(l.mdScrollShrink)&&n()}}}ngmaterial.components.toolbar=angular.module("material.components.toolbar");MdTooltipDirective.$inject="$timeout $window $$rAF $document $interpolate $mdUtil $mdPanel $$mdTooltipRegistry".split(" ");angular.module("material.components.tooltip",["material.core","material.components.panel"]).directive("mdTooltip",MdTooltipDirective).service("$$mdTooltipRegistry",MdTooltipRegistry);
function MdTooltipDirective(a,b,d,c,e,f,g,h){function l(v,m,q){function r(){v.mdZIndex=v.mdZIndex||100;v.mdDelay=v.mdDelay||0;n[v.mdDirection]||(v.mdDirection="bottom")}function x(K){K=K||e(m.text().trim())(v.$parent);if(!B.attr("aria-label")&&!B.attr("aria-labelledby")||B.attr("md-labeled-by-tooltip"))B.attr("aria-label",K),B.attr("md-labeled-by-tooltip")||B.attr("md-labeled-by-tooltip",w)}function y(){r();C&&C.panelEl&&C.panelEl.removeClass(D);D="md-origin-"+v.mdDirection;G=n[v.mdDirection];N=g.newPanelPosition().relativeTo(B).addPanelPosition(G.x,
G.y);C&&C.panelEl&&(C.panelEl.addClass(D),C.updatePosition(N))}function k(){function K(U){U.some(function(X){return"disabled"===X.attributeName&&B[0].disabled});return!1}function M(){t(!1)}function I(){S=document.activeElement===B[0]}function J(U){if("focus"===U.type&&S)S=!1;else if(!v.mdVisible&&(B.on("blur touchcancel mouseleave",Q),t(!0),"touchstart"===U.type))B.one("touchend",function(){f.nextTick(function(){c.one("touchend",Q)},!1)})}function Q(){if((F=v.hasOwnProperty("mdAutohide")?v.mdAutohide:
...
R.observe(B[0],{attributes:!0})}S=!1;h.register("scroll",M,!0);h.register("blur",I);h.register("resize",u);v.$on("$destroy",Y);B.on("mousedown",T);B.on("focus touchstart mouseenter",J)}function p(){function K(){v.$destroy()}if(m[0]&&"MutationObserver"in b){var M=new MutationObserver(function(I){I.forEach(function(J){"md-visible"!==J.attributeName||v.visibleWatcher||(v.visibleWatcher=v.$watch("mdVisible",H))})});M.observe(m[0],{attributes:!0});q.hasOwnProperty("mdVisible")&&(v.visibleWatcher=v.$watch("mdVisible",
H))}else v.visibleWatcher=v.$watch("mdVisible",H);v.$watch("mdDirection",y);m.one("$destroy",K);B.one("$destroy",K);v.$on("$destroy",function(){t(!1);C&&C.destroy();M&&M.disconnect();m.remove()});-1<m.text().indexOf(e.startSymbol())&&v.$watch(function(){return m.text().trim()},x)}function t(K){t.queued&&t.value===!!K||!t.queued&&v.mdVisible===!!K||(t.value=!!K,t.queued||(K?(t.queued=!0,O=a(function(){v.mdVisible=t.value;t.queued=!1;O=null;v.visibleWatcher||H(v.mdVisible)},v.mdDelay)):f.nextTick(function(){v.mdVisible=
!1;v.visibleWatcher||H(!1)})))}function H(K){K?A():C&&C.close()}function A(){if(!m[0].textContent.trim())throw Error("Text for the tooltip has not been provided. Please include text within the mdTooltip element.");if(!C){var K=angular.element(document.body),M=g.newPanelAnimation().openFrom(B).closeTo(B).withAnimation({open:"md-show",close:"md-hide"});K={id:w,attachTo:K,contentElement:m,propagateContainerEvents:!0,panelClass:"md-tooltip",animation:M,position:N,zIndex:v.mdZIndex,focusOnOpen:!1,onDomAdded:function(){C.panelEl.addClass(D)}};
C=g.create(K)}C.open().then(function(){C.panelEl.attr("role","tooltip")})}var w="md-tooltip-"+f.nextUid(),B=f.getParentWithPointerEvents(m),u=d.throttle(y),z=!1,D,G,N,C,F,O,S=null;r();x();m.detach();y();k();p()}var n={top:{x:g.xPosition.CENTER,y:g.yPosition.ABOVE},right:{x:g.xPosition.OFFSET_END,y:g.yPosition.CENTER},bottom:{x:g.xPosition.CENTER,y:g.yPosition.BELOW},left:{x:g.xPosition.OFFSET_START,y:g.yPosition.CENTER}};return{restrict:"E",priority:210,scope:{mdZIndex:"=?mdZIndex",mdDelay:"=?mdDelay",
mdVisible:"=?mdVisible",mdAutohide:"=?mdAutohide",mdDirection:"@?mdDirection"},link:l}}
function MdTooltipRegistry(){function a(f){c[f.type]&&c[f.type].forEach(function(g){g.call(this,f)},this)}function b(f,g,h){var l=c[f]=c[f]||[];l.length||(h?window.addEventListener(f,a,!0):e.on(f,a));-1===l.indexOf(g)&&l.push(g)}function d(f,g,h){var l=c[f];g=l?l.indexOf(g):-1;-1<g&&(l.splice(g,1),0===l.length&&(h?window.removeEventListener(f,a,!0):e.off(f,a)))}var c={},e=angular.element(window);return{register:b,deregister:d}}ngmaterial.components.tooltip=angular.module("material.components.tooltip");MdWhiteframeDirective.$inject=["$log"];angular.module("material.components.whiteframe",["material.core"]).directive("mdWhiteframe",MdWhiteframeDirective);function MdWhiteframeDirective(a){function b(d,c,e){var f="";e.$observe("mdWhiteframe",function(g){g=parseInt(g,10)||4;-1!=g&&(24<g||1>g)&&(a.warn("md-whiteframe attribute value is invalid. It should be a number between 1 and 24",c[0]),g=4);g=-1==g?"":"md-whiteframe-"+g+"dp";e.$updateClass(g,f);f=g})}return{link:b}}
